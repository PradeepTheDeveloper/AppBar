...
import 'package:pradeep_the_developer/integrations/utils/colors.dart';
import 'package:pradeep_the_developer/integrations/utils/common.dart';
import 'package:pradeep_the_developer/main/utils/AppWidget.dart';
import 'package:pradeep_the_developer/integrations/utils/constants.dart';
import 'package:pradeep_the_developer/integrations/utils/styles.dart';
import 'package:pradeep_the_developer/main.dart';
import 'package:pradeep_the_developer/main/utils/AppColors.dart';
import 'package:pradeep_the_developer/main/utils/AppWidget.dart' as aw;
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: text("Date Selection Picker:",
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Padding(
                        ...
                        child: text(
                            mSelectedDate.isEmpty
                                ? "Select your date"
                                : mSelectedDate,
                            textColor: mSelectedDate.isEmpty
              ...
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: text("Your Location Picker:",
                    textColor: appColorPrimary,
                    fontFamily: fontMedium,
                    fontSize: textSizeLargeMedium),
              ),
              Container(
                ...
                padding: EdgeInsets.fromLTRB(16, 16, 16, 16),
                child: text(
                    mSelectedAddress.isEmpty
                        ? "Your Address"
                        : mSelectedAddress,
                    textColor: mSelectedAddress.isEmpty
                        ? appStore.textSecondaryColor
                        : appStore.textPrimaryColor,
                    maxLine: 5),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                    ...
                    child: textPrimary('Pick Your Current Location',
                        aFontFamily: fontMedium)),
              ),
              SizedBox(height: 20),
              Divider(
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Text(mSelectedColor,
                              style: primaryTextStyle(color: pickerColor))
                        ],
                      ),
                      SizedBox(
                        height: 20,
