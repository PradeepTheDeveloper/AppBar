      ...
      children: [
        Container(
          ...
          decoration: boxDecorationDefault(
              borderRadius: radius(40), color: context.cardColor),
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.asset(
                      'images/widgets/materialWidgets/mwInformationDisplayWidgets/cards/joker.jpg',
                      height: 130)
              ...
              Column(
                ...
                children: [
                  Text('Joker Put on a Happy Face ',
                      style: boldTextStyle(size: 18, weight: FontWeight.w500)),
                  8.height,
                  Text('CGV Cinemas',
                      style: primaryTextStyle(color: Colors.blue, size: 14)),
                  8.height,
                  Text('Thus 05 Nov - 13 : 00',
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text('2.45 ETH',
                    style: secondaryTextStyle(color: Colors.green, size: 10)),
              ...
              Stack(
                children: List.generate(
                  ...
                  (index) => Container(
                    ...
                    child: CircleAvatar(
                        backgroundImage: AssetImage(images[index]), radius: 20),
                  ),
                ),
              ),
              Text('3 in Stack',
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          width: context.width(),
          decoration: boxDecorationDefault(
              borderRadius: radius(32), color: Color(0xFFFF9973)),
            ...
            children: [
              ...
              Text('Rp 14.600.000',
                  style: primaryTextStyle(
                      size: 20, color: Colors.white, weight: FontWeight.w500)),
            ],
          ),
        ),
        Positioned(
          ...
          bottom: 20,
          child: Image.asset(
              'images/widgets/materialWidgets/mwInformationDisplayWidgets/cards/ruby.png',
              height: 140),
        ),
        Positioned(
          bottom: -20,
          ...
          child: Container(
            ...
            decoration: boxDecorationDefault(
                borderRadius: radius(16), color: context.cardColor),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Image.asset(
                      'images/widgets/materialWidgets/mwInformationDisplayWidgets/cards/visa.png',
                      width: 50)
                ],
              )
            ],
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              32.height,
              Text('Hot Noodles',
                  style: boldTextStyle(color: Colors.red, size: 26)),
              4.height,
              Text('Ingredients',
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style:
                      boldTextStyle(size: 20, color: appStore.textPrimaryColor),
                ),
              ),
              10.height,
              Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: Icon(Icons.bookmark,
                        color: appStore.iconColor, size: 28),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child:
                        Icon(Icons.share, color: appStore.iconColor, size: 28),
                  ),
                ],
              ),
            ],
