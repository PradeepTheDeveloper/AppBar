...
import 'package:pradeep_the_developer/widgets/materialWidgets/mwDialogAlertPanelWidgets/MWExpansionPannelWidgets/component/MWExpansionPanel5ComponentWidget.dart';

class MWExpansionPanelScreen5 extends StatefulWidget {
  const MWExpansionPanelScreen5({Key? key}) : super(key: key);

  @override
  _MWExpansionPanelScreen5State createState() =>
      _MWExpansionPanelScreen5State();
}
