...
class MWUserAccountDrawerHeaderScreen1 extends StatefulWidget {
  ...
  @override
  _MWUserAccountDrawerHeaderScreen1State createState() =>
      _MWUserAccountDrawerHeaderScreen1State();
}

class _MWUserAccountDrawerHeaderScreen1State
    extends State<MWUserAccountDrawerHeaderScreen1> {
          ...
          child: Column(
            children: [
              UserAccountsDrawerHeader(
                ...
                accountEmail: Text('leedesigner@gmail.com',
