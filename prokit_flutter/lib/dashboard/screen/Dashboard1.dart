      ...
      child: Row(
        children: <Widget>[
          ClipRRect(
            ...
            child: commonCachedNetworkImage(model.img,
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Text(model.info,
                  style:
                      primaryTextStyle(color: db1_textColorSecondary, size: 14),
                  maxLines: 1),
              Row(
                children: <Widget>[
                  Text(model.duration,
                      style: secondaryTextStyle(
                          color: db1_textColorSecondary, size: 14),
                      maxLines: 1),
        ...
        children: <Widget>[
          ClipRRect(
            ...
            child: Image.asset(model.img,
                fit: BoxFit.fill, height: width * 0.2, width: width * 0.2),
          ),
          SizedBox(height: 4),
