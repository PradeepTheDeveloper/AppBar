...
import 'package:pradeep_the_developer/themes/theme2/utils/T2Colors.dart';
import 'package:pradeep_the_developer/themes/theme2/utils/T2Images.dart';
import 'package:pradeep_the_developer/themes/theme2/utils/T2Strings.dart';
import 'package:pradeep_the_developer/themes/theme2/utils/T2Widgets.dart';
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          maxLines: 2,
                          style: boldTextStyle(
                              size: 22, color: appStore.textPrimaryColor),
                        ),
                      ),
                    )
                  ],
