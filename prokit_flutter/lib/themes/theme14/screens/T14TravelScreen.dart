  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        actions: [
          IconButton(icon: Icon(Icons.star_border, size: 22), onPressed: () {})
        ],
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(t14_txt_Explore,
                    style: boldTextStyle(size: 18, color: t14_colorBlue))
                .paddingOnly(left: 16, right: 16, bottom: 8),
            Text(t14_txt_Explore_SubTitle, style: secondaryTextStyle(size: 14))
                .paddingOnly(left: 16),
            8.height,
            Container(
              height: 270,
