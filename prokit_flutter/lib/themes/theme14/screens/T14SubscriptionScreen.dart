                    ...
                    child: Column(
                      children: [
                        ...
                        Text(data.price.toString(),
                            style:
                                boldTextStyle(color: t14_colorBlue, size: 22)),
                        8.height,
                        Text(t14_txt_PointsBalance,
                            style: boldTextStyle(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {},
                            child: Text(t14_txt_BuyAccount,
                                style: primaryTextStyle(color: t14_colorBlue)),
                          ),
                        ),
                        Text(t14_txt_ReadMore,
                            style: primaryTextStyle(color: gray, size: 12)),
                        16.height,
                      ],
                    ),
                  )
