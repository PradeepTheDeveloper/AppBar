    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text('Where', style: boldTextStyle(color: t14_colorBlue, size: 16))
                .paddingAll(16),
            Text('Will you go today', style: secondaryTextStyle(size: 14))
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: t14_GreyColor.withOpacity(0.5)),
                                child: Text('3.8',
                                    textAlign: TextAlign.center,
                                    style: primaryTextStyle(
                                        color: t14_colorWhite, size: 16)),
                              ),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ClipRRect(
                              ...
                              child: commonCachedNetworkImage(data.userImg!,
