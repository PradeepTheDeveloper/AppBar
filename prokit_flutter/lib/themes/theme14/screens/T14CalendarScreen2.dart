...
import 'package:pradeep_the_developer/integrations/screens/flutterCalender/CleanCalendar.dart';
              ...
              Container(
                child: Calendar(
                  ...
                  dayOfWeekStyle: TextStyle(
                      color: black, fontWeight: FontWeight.w800, fontSize: 11),
                ),
              ),
              _buildEventList()
            ],
            ...
            child: Row(
              children: [
                Icon(Entypo.dot_single,
                    color: i == index ? t14_colorBlue : Colors.transparent,
                    size: 25),
                Text(_selectedEvents[index]['Time'].toString(),
                    style:
                        primaryTextStyle(color: t14_SuccessTxtColor, size: 12)),
                16.width,
                Container(
                  ...
                  decoration: boxDecorationWithRoundedCorners(
                    ...
                    backgroundColor:
                        i == index ? t14_call_BgColor : t14_calendar3_BgColor,
                  ),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Text(_selectedEvents[index]['name'].toString(),
                          style: boldTextStyle(
                              color: i == index ? white : black, size: 14)),
                      16.width,
                      Text(
                        _selectedEvents[index]['ScheduleTime'].toString(),
                        style: primaryTextStyle(
                            color: i == index ? white : t14_SuccessTxtColor,
                            size: 12),
                      ),
                    ],
                  ),
