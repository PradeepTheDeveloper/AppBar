...
import 'package:pradeep_the_developer/fullApps/hairSalon/utils/BHConstants.dart';
import 'package:pradeep_the_developer/themes/theme14/model/T14Model.dart';
import 'package:pradeep_the_developer/themes/theme14/utils/T14Colors.dart';
import 'package:pradeep_the_developer/themes/theme14/utils/T14Images.dart';
import 'package:pradeep_the_developer/themes/theme14/utils/T14Strings.dart';
...
List<SubscriptionModel> getSubscriptionList() {
  ...
  subscriptionList.add(
    SubscriptionModel(
        ...
        img: t14_KingIcon,
        price: 15000,
        backgroundColor: t14_colorPink,
        bannerColor: t14_colorCream),
  );
  subscriptionList.add(
    SubscriptionModel(
        name: 'Gold',
        img: t14_KingIcon,
        price: 10000,
        backgroundColor: t14_colorLightBlue,
        bannerColor: t14_colorSkyBlue),
  );
  subscriptionList.add(
    SubscriptionModel(
        name: 'platinum',
        img: t14_KingIcon,
        price: 60000,
        backgroundColor: t14_colorLightGreen,
        bannerColor: t14_colorBlue),
  );
...
List<SubscriptionModel> getTopTravelList() {
  ...
  topTravelList
      .add(SubscriptionModel(name: 'Great Wall of China', img: t14_travel1));
  topTravelList
      .add(SubscriptionModel(name: 'Angkor Wat, Cambodia', img: t14_travel2));
  topTravelList.add(SubscriptionModel(name: 'Kyiv ,Ukraine', img: t14_travel3));
  topTravelList
      .add(SubscriptionModel(name: 'Keoladeo National Park', img: t14_travel4));
  topTravelList.add(SubscriptionModel(name: 'Easter Island', img: t14_travel5));
  topTravelList
      .add(SubscriptionModel(name: 'Machu Picchu, Peru', img: t14_travel6));
  topTravelList.add(SubscriptionModel(name: 'Petra, Jordan', img: t14_travel7));
  topTravelList
      .add(SubscriptionModel(name: 'Stonehenge, England', img: t14_travel8));
...
List<SubscriptionModel> getTravelStoryDetailList() {
  ...
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel1, name: 'David Steward', userImg: t14_profile1));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel3, name: 'Burton Armstron', userImg: t14_profile3));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel5, name: 'Edwards Roberts', userImg: t14_profile1));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel7, name: 'David Steward', userImg: t14_profile2));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel9, name: 'Jenkins Lawrence', userImg: t14_profile4));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel2, name: 'Lawrence Jones', userImg: t14_profile1));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel4, name: 'Graham Murphy', userImg: t14_profile3));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel6, name: 'Burton Armstrong', userImg: t14_profile1));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel8, name: 'Cole Walsh', userImg: t14_profile2));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel10, name: 'Carter Yates', userImg: t14_profile1));
...
List<SubscriptionModel> getMostPopularList() {
  ...
  mostPopular.add(
    SubscriptionModel(
        country: 'England', img: t14_travel1, name: 'Great Wall of Chin'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Cambodia', img: t14_travel2, name: 'Angkor Wat, Cambodia'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Ukraine', img: t14_travel3, name: 'Kyiv ,Ukraine'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'USA', img: t14_travel4, name: 'Keoladeo National Park'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Island', img: t14_travel5, name: 'Easter Island'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Peru', img: t14_travel6, name: 'Machu Picchu, Peru'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Jordan', img: t14_travel7, name: 'Petra, Jordan'),
  );
  mostPopular.add(
    SubscriptionModel(
        country: 'Tokyo', img: t14_travel8, name: 'Stonehenge, England'),
  );
...
List<SubscriptionModel> getTravel3StoryDetailList() {
  ...
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel2,
      name: 'David Steward',
      userImg: t14_profile1,
      country: 'England'));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel4,
      name: 'Burton Armstrong',
      userImg: t14_profile2,
      country: 'Cambodia'));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel6,
      name: 'Carter Yates',
      userImg: t14_profile3,
      country: 'Ukraine'));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel8,
      name: 'Cole Walsh',
      userImg: t14_profile4,
      country: 'USA'));
  travelStoryDetailList.add(SubscriptionModel(
      img: t14_travel10,
      name: 'Davies Taylor',
...
List<CheckBoxTextModel> getCheckBoxTxtList() {
  ...
  checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Unlock Over 30 education video'));
...
List<CheckBoxTextModel> getSubscription4CheckBoxTxtList() {
  ...
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Sentiment analyze and score'));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Highlights report'));
...
List<ChoosePlanModel> getSubscription4ChoosePlanList() {
  ...
  subscription4choosePlanList
      .add(ChoosePlanModel(title: 'Monthly', subTitle: '4,99\$ /month'));
  subscription4choosePlanList
      .add(ChoosePlanModel(title: 'Annual', subTitle: '2,99\$ /month'));
  subscription4choosePlanList
      .add(ChoosePlanModel(title: 'Free Trial', subTitle: '7 free days '));
...
List<ChoosePlanModel> getSubscription7DiscountList() {
  List<ChoosePlanModel> subscription5choosePlanList = [];
  subscription5choosePlanList
      .add(ChoosePlanModel(title: 'Higher yields', subTitle: 'up to 6%'));
  subscription5choosePlanList
      .add(ChoosePlanModel(title: 'More Case Backs', subTitle: 'up to 2%'));
...
List<MessageListModel> getUserList() {
  ...
  userList.add(
      MessageListModel(img: t14_profile1, name: 'Fletcher', isActive: true));
  userList.add(
      MessageListModel(img: t14_profile2, name: 'Jenkins', isActive: false));
  userList
      .add(MessageListModel(img: t14_profile3, name: 'David', isActive: true));
  userList.add(
      MessageListModel(img: t14_profile4, name: 'Graham', isActive: false));
  userList.add(
      MessageListModel(img: t14_profile1, name: 'Edwards', isActive: true));
  userList
      .add(MessageListModel(img: t14_profile1, name: 'Burton', isActive: true));
  userList.add(
      MessageListModel(img: t14_profile3, name: 'Fletcher', isActive: false));
  userList.add(
      MessageListModel(img: t14_profile1, name: 'Edwards', isActive: true));
  return userList;
}
...
List<MessageListModel> getTransactionList() {
  ...
  transactionList.add(MessageListModel(
      img: '22.07',
      name: 'Remittance',
      message: '+\$20,000.00',
      isActive: true));
  ...
  transactionList.add(MessageListModel(
      ...
      isActive: true));
  transactionList.add(MessageListModel(
      img: '65.12', name: 'payroll', message: '+\$203,000.00', isActive: true));
  transactionList.add(MessageListModel(
      img: '45.04',
...
List<MessageListModel> getMonthViseTransactionList() {
  ...
  monthViseTransactionList.add(MessageListModel(
      img: 'January',
      name: '23 transaction',
      message: '+\$20,000.00',
      isActive: false));
...
List<MessageListModel> getAtmCardList() {
  ...
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '2155', isActive: true));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '6578', isActive: false));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '7812', isActive: true));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '1456', isActive: true));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '9823', isActive: false));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '1023', isActive: true));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '0325', isActive: false));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '7700', isActive: true));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '0799', isActive: true));
  atmCardList
      .add(MessageListModel(img: t14_visa, name: '1289', isActive: false));
...
List<CheckBoxTextModel> getFinance1CheckBoxTxtList() {
  List<CheckBoxTextModel> subscription4checkBoxTxtList = [];
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Fletcher Jenkins', img: t14_profile1));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'David Steward', img: t14_profile2));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Graham Murphy', img: t14_profile3));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Burton Armstrong', img: t14_profile4));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Edwards Roberts', img: t14_profile1));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Jenkins Lawrence', img: t14_profile1));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Graham Murphy', img: t14_profile3));
  subscription4checkBoxTxtList
      .add(CheckBoxTextModel(name: 'Fletcher Jenkins', img: t14_profile1));
...
List<MessageListModel> getMessageCountList() {
  ...
  messageCountList.add(
    MessageListModel(
        img: t14_profile3,
        name: 'Graham Murphy',
        message: 'I enjoy with whole heart',
        lastSeen: "6",
        isActive: true),
  );
...
List<SpendingModel> getSpendingList() {
  ...
  spendingList.add(SpendingModel(
      ...
      icon: Entypo.dots_three_horizontal,
      name: 'Other',
      rate: '\$40'));
