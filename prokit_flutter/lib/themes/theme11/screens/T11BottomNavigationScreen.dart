...
class T11BottomNavigationScreen extends StatefulWidget {
  ...
  @override
  T11BottomNavigationScreenState createState() =>
      T11BottomNavigationScreenState();
}
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
              icon: Icon(MaterialCommunityIcons.music), label: ''),
          BottomNavigationBarItem(
              icon: Icon(MaterialCommunityIcons.playlist_music), label: ''),
          BottomNavigationBarItem(
              icon: Icon(MaterialCommunityIcons.account), label: ''),
        ],
