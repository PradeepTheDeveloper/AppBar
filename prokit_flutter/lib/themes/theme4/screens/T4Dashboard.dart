...
import 'package:pradeep_the_developer/themes/theme4/models/T4Models.dart';
import 'package:pradeep_the_developer/themes/theme4/utils/T4Colors.dart';
import 'package:pradeep_the_developer/themes/theme4/utils/T4Constant.dart';
import 'package:pradeep_the_developer/themes/theme4/utils/T4DataGenerator.dart';
import 'package:pradeep_the_developer/themes/theme4/utils/T4Images.dart';
import 'package:pradeep_the_developer/themes/theme4/utils/T4Widgets.dart';
import 'package:pradeep_the_developer/themes/theme4/utils/widgets/T4BottomNavigationBar.dart';
    ...
    return Scaffold(
                            ...
                            itemBuilder: (context, index) {
                              return Container(
                                ...
                                decoration: boxDecoration(
                                    radius: 4,
                                    bgColor: mCategories[index].color),
      ...
      bottomNavigationBar: Container(
        ...
        child: T4BottomNavigationBar(
          ...
          backgroundColor: context.scaffoldBackgroundColor,
          unselectedIconTheme:
              IconThemeData(color: appStore.iconSecondaryColor, size: 24),
