          ...
          children: <Widget>[
            Container(
              ...
              decoration: boxDecoration(
                  showShadow: true, bgColor: context.scaffoldBackgroundColor),
              child: Column(
                children: <Widget>[
                  Container(
                    decoration: boxDecoration(
                  ...
                  toolBarTitle("\$122.50", textColor: appStore.textPrimaryColor)
                      .paddingTop(spacing_standard_new),
                  text("Desko Electricity",
                          textColor: appStore.textPrimaryColor,
                          fontFamily: fontMedium)
                      .paddingTop(spacing_standard),
                  text("Last Payment Date: 24 May 2020",
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  formField(context, "Your Subcriber Id",
                      ...
                      .paddingTop(spacing_standard),
                  text("Bill No", textColor: appStore.textPrimaryColor)
                      .paddingTop(spacing_standard),
                  formField(context, "Enter the bill number",
                          prefixIcon: Icons.device_unknown)
                      .paddingTop(spacing_standard),
                  text("Amount", textColor: appStore.textPrimaryColor)
                      .paddingTop(spacing_standard),
