...
class T13BottomNavigationScreen extends StatefulWidget {
  ...
  @override
  T13BottomNavigationScreenState createState() =>
      T13BottomNavigationScreenState();
}
...
class T13BottomNavigationScreenState extends State<T13BottomNavigationScreen> {
            ...
            child: Column(
              children: <Widget>[
                SvgPicture.asset(
                  ...
                  height: 20,
                  color:
                      isSelected == pos ? t13_colorPrimary : appStore.iconColor,
                ),
                text(name,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Stack(
        ...
        children: <Widget>[
          Container(
            ...
            height: 70,
            decoration:
                boxDecoration(showShadow: true, color: appStore.appBarColor!),
            child: Row(
      ...
      body: SafeArea(
        child: Container(
            child: Text('Screen $isSelected', style: boldTextStyle(size: 20)),
            alignment: Alignment.center),
      ),
    );
  }
