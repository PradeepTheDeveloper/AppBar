...
import 'package:pradeep_the_developer/customPaint/chatBubble/ChatBubbleMessageWidget.dart';
import 'package:pradeep_the_developer/customPaint/chatBubble/modal/ChatBubbleModal.dart';
import 'package:pradeep_the_developer/customPaint/chatBubble/utils.dart';
...
class ChatBubbleScreenState extends State<ChatBubbleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget('Chat Bubble Screen',
