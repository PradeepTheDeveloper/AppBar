...
import 'package:pradeep_the_developer/customPaint/customCard/model/CustomCardScreenModal.dart';
...
class CustomCardScreenState extends State<CustomCardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          appBarWidget('Custom card', color: context.scaffoldBackgroundColor),
      body: HorizontalList(
        spacing: 8,
        runSpacing: 8,
