...
import 'package:pradeep_the_developer/customPaint/card/CardCustomPainter.dart';
...
class CardScreenState extends State<CardScreen> {
  ...
  Widget cardAppButton(
      {required BuildContext context, String? post, String? postTitle}) {
    return AppButton(
      child: Column(
        children: [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          appBarWidget('Card Paint', color: context.scaffoldBackgroundColor),
      body: Container(
          ...
          children: [
            ...
            Positioned(
              ...
              child: Row(
                ...
                children: [
                  cardAppButton(
                      context: context, post: '45', postTitle: 'Post'),
                  8.width,
                  cardAppButton(
                      context: context, post: '100', postTitle: 'Followers'),
                  8.width,
                  cardAppButton(
                      context: context, post: '50', postTitle: 'Following'),
                ],
              ),
            ),
          ],
