...
import 'package:pradeep_the_developer/customPaint/shape/CirclePainter.dart';
import 'package:pradeep_the_developer/customPaint/shape/LinePainter.dart';
import 'package:pradeep_the_developer/customPaint/shape/RectanglePainter.dart';
import 'package:pradeep_the_developer/customPaint/shape/RoundedRectanglePainter.dart';
import 'package:pradeep_the_developer/customPaint/shape/TrianglePainter.dart';
import 'package:pradeep_the_developer/customPaint/shape/modal/PainterScreenModal.dart';
...
class ShapeScreenState extends State<ShapeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:
          appBarWidget('Custom Shape', color: context.scaffoldBackgroundColor),
      body: Container(
                ...
                items: [
                  Wrap(
                    ...
                    children: List.generate(
                      ...
                      (index) {
                        PainterScreenModal data =
                            PainterScreenModal.getData()[index];
