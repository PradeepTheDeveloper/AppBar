...
import 'package:pradeep_the_developer/defaultTheme/model/DTAddressListModel.dart';
import 'package:pradeep_the_developer/defaultTheme/model/DTChatMessageModel.dart';
import 'package:pradeep_the_developer/defaultTheme/model/DTChatModel.dart';
import 'package:pradeep_the_developer/defaultTheme/model/DTProductModel.dart';
import 'package:pradeep_the_developer/defaultTheme/model/DTReviewModel.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTAboutScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTAddressScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTCartScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTCategoryDetailScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTChatScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTContactUsScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTDashboardScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTErrorScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTFAQScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTFilterScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTForgotPwdScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTMaintenanceScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTNoDataScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTNoResultScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTOrderSummaryScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTPaymentScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTProductDetailScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTProfileScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTReviewScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTSearchScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTSignInScreen.dart';
import 'package:pradeep_the_developer/defaultTheme/screen/DTSignUpScreen.dart';
...
List<ListModel> getDrawerItems() {
  ...
  drawerItems
      .add(ListModel(name: 'Forgot Password', widget: DTForgotPwdScreen()));
  ...
  drawerItems
      .add(ListModel(name: 'Maintenance', widget: DTMaintenanceScreen()));
  drawerItems
      .add(ListModel(name: 'Grid View', widget: DTCategoryDetailScreen()));
  drawerItems.add(ListModel(
      name: 'Order Summary', widget: DTOrderSummaryScreen(getCartProducts())));
  drawerItems
      .add(ListModel(name: 'Address Manager', widget: DTAddressScreen()));
