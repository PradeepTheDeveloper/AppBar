...
import 'package:pradeep_the_developer/defaultTheme/screen/DTMessageScreen.dart';
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  FadeInImage(
                    placeholder: Image.asset('images/app/placeholder.jpg',
                            fit: BoxFit.cover)
                        .image,
                      ...
                      children: <Widget>[
                        ...
                        IconButton(
                          icon: Icon(Icons.send,
                              size: 25, color: appStore.iconColor),
                          onPressed: () async {
                            sendClick();
                          },
                        ),
