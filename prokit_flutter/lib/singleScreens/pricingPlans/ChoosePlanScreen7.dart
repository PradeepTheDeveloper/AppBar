...
class ChoosePlanScreen7State extends State<ChoosePlanScreen7> {
      ...
      PlanModal(
        ...
        optionList: [
          ...
          PlanModal(
            title: 'Tests',
            subTitle:
                'Create Custom challanges invite friends and access test reports',
            isAvailable: false,
          ),
          PlanModal(
            title: 'Doubts',
            subTitle:
                'Get unlimited doubts solved via chat with our subjects experts ',
            isAvailable: false,
          )
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget('Pricing plan 7',
        ...
        itemBuilder: (context, index) {
          ...
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
                ...
                color: planPeriodList[index].containerColor),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(data.priceLinthroughTitle.validate(),
                                    style: secondaryTextStyle(
                                        size: 20,
                                        decoration:
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                          planPeriodList[index]
                                              .optionList![i]
                                              .title
                                              .validate(),
                                          style: boldTextStyle(
                                              decoration: planPeriodList[index]
                                                      .optionList![i]
                                                      .isAvailable
                                                      .validate()
                                                  ? null
                  ...
                  Align(
                    ...
                    child: AppButton(
                      ...
                      onTap: () {
                        ...
                        snackBar(context,
                            title: "${planPeriodList[index].title}",
