...
import 'package:pradeep_the_developer/main/model/SocialIconModal.dart';
...
class SocialMediaWidgetComponent extends StatefulWidget {
  ...
  @override
  _SocialMediaWidgetComponentState createState() =>
      _SocialMediaWidgetComponentState();
}

class _SocialMediaWidgetComponentState
    extends State<SocialMediaWidgetComponent> {
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          16.width,
                          Text(element.iconTitle.validate(),
                              style: primaryTextStyle(size: 12))
                        ],
                      ),
                    ],
                  ).onTap(() {
                    launch(element.iconUrl.validate(),
                        forceWebView: true, enableJavaScript: true);
                  });
                },
              )));
