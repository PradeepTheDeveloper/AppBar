...
import 'package:pradeep_the_developer/main/component/DownloadSourceCodeDialog.dart';
...
import '../../main.dart';
import 'DeveloperKitScreenListing.dart';
import 'SettingScreen.dart';
import 'ThemeList.dart';

class DeveloperKitLauncher extends StatefulWidget {
  static String tag = '/DeveloperKitLauncher';

  @override
  DeveloperKitLauncherState createState() => DeveloperKitLauncherState();
}

class DeveloperKitLauncherState extends State<DeveloperKitLauncher>
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    category(appCat4, app_ic_phone,
                                        ...
                                        onTap: () {
                                      DeveloperKitScreenListing(
                                              snapshot.data!.widgets)
                                          .launch(context);
                                    }),
                                    category(appCat1, app_ic_phone,
                                    ...
                                    category(appCat2, app_dashboard,
                                      ...
                                      DeveloperKitScreenListing(
                                        ...
                                        appCount: snapshot
                                            .data!.dashboard!.sub_kits!.length),
