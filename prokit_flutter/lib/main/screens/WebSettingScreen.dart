...
import 'package:pradeep_the_developer/main/model/SettingListModal.dart';
...
class _WebSettingScreenState extends State<WebSettingScreen> {
  ...
  Future<void> init() async {
    ...
    settingList.add(
      SettingListModal(
          icon: 'images/app/ic_theme.png', title: 'Dark Mode', isSwitch: true),
    );
  }
              ...
              return HoverWidget(
                builder: (context, isHovering) => SettingItemWidget(
                  decoration: BoxDecoration(
                      color:
                          isHovering ? appColorPrimary.withOpacity(0.2) : null,
              ...
              return HoverWidget(
                builder: (context, isHovering) => AnimatedContainer(
                  ...
                  decoration: boxDecorationDefault(
                      color: isHovering ? appColorPrimary : context.cardColor),
                  width: 265,
                  padding: EdgeInsets.all(8),
              ...
              return HoverWidget(
                builder: (context, isHovering) => AnimatedContainer(
                  ...
                  child: SettingItemWidget(
                      ...
                      titleTextStyle: primaryTextStyle(
                          color:
                              isHovering ? appColorPrimary : context.iconColor),
                      leading: Image.asset(
                        data.icon.validate(),
                        height: 40,
                        width: 40,
