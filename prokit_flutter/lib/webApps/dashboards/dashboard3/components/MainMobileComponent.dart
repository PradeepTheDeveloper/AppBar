...
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/components/ActivityChartTabletComponent.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/components/ProfileComponent.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/components/TotalListTabletComponent.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/components/TypeListTabletComponent.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/models/ChartModel.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/models/OrderModel.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/screens/MyDrawer.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/utils/Colors.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/utils/Common.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/utils/Constants.dart';
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/utils/DataProvider.dart';
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Container(
                  margin: EdgeInsets.all(8),
                  child: ActivityChartTabletComponent()),
              8.height,
              Container(
                padding: EdgeInsets.all(8),
                margin: EdgeInsets.all(8),
                decoration: boxDecorationRoundedWithShadow(cardRadius.toInt(),
                    backgroundColor: white),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Top item of this month',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          'SEE ALL',
                          style:
                              primaryTextStyle(size: 10, color: primaryColor),
                        ).onTap(() {
