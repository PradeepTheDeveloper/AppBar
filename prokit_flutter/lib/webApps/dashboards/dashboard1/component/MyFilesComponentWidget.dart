                ...
                return AnimatedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: SvgPicture.asset(data.img.validate(),
                                color: data.color, fit: BoxFit.cover),
                          ),
                          Theme(
                      ...
                      ProgressLine(
                          color: data.color, percentage: data.percentage),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("${data.noOfFiles} Files",
                              style: Theme.of(context)
                                  .textTheme
                                  .caption!
                                  .copyWith(color: Colors.white70)),
                          Text(data.totalSize.validate(),
                              style: Theme.of(context)
                                  .textTheme
                                  .caption!
