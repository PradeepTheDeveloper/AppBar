        ...
        child: Column(
          children: [
            Container(
              ...
              child: Stack(
                children: [
                  commonCachedNetworkImage(p3ServiceImg,
                      height: context.height() + 200,
                      width: context.width(),
                      fit: BoxFit.cover),
                  Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Icon(MaterialCommunityIcons.laptop_mac,
                                    size: 30, color: portfolio3PrimaryColor),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  height: 80,
                                  color:
                                      portfolio3PrimaryColor.withOpacity(0.2),
                                  child: Icon(MaterialCommunityIcons.laptop_mac,
                                      size: 30, color: portfolio3PrimaryColor),
                                ).cornerRadiusWithClipRRect(40),
                                16.height,
