import 'package:pradeep_the_developer/webApps/portfolios/models/Portfolio1SkillModel.dart';
import 'package:pradeep_the_developer/webApps/portfolios/models/Portfolio2ServiceModel.dart';
import 'package:pradeep_the_developer/webApps/portfolios/utils/Images.dart';
...
List<Portfolio2ServiceModel> getPortfolio2Services() {
  ...
  model1.name = 'Design';
  model1.desc =
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis nam, minima iste molestiae.';
  model1.icon = '';
  list.add(model1);
...
List<Portfolio1ExperiencesModel> getServicesList() {
  ...
  model1.subTitle =
      'Donec et venenatis libero. Fusceing dapibus pulvinar tincidunt. Proin maximus ipsum ut scelerisque.';
  list.add(model1);
...
List<GuideLinesModel> getServiceList2() {
  ...
  model1.detail =
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, minima. It is a long '
...
List<GuideLinesModel> getLatestBlogList() {
  ...
  model1.detail =
      'Lorem ipsum dolor sit amet nostrum ad minus libero fugiat molestiae ullam ipsam quas unde earum!';
