...
import 'package:pradeep_the_developer/webApps/portfolios/portfolio3/Colors.dart';
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      16.height,
                      Text('Let\'s work together indeed!',
            ...
            Container(
              ...
              child: Center(
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Text('© 2020 My Website. All rights reserved | Designed by Iqonic Design',
                      ...
                      8.width,
                      Icon(Entypo.twitter_with_circle,
                              size: 28, color: Colors.white)
                          .onTap(() {
                        launch('https://www.twitter.com');
                      }),
                      8.width,
                      Icon(Entypo.instagram_with_circle,
                              size: 28, color: Colors.white)
                          .onTap(() {
                        launch('https://www.instagram.com');
                      }),
                      8.width,
                      Icon(Entypo.linkedin_with_circle,
                              size: 28, color: Colors.white)
                          .onTap(() {
                        launch('https://www.linkedin.com');
                      }),
                      8.width,
                      Icon(FontAwesome.youtube, size: 28, color: Colors.white)
                          .onTap(() {
