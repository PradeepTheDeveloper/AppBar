...
import 'package:pradeep_the_developer/fullApps/socialv/models/SVCommonModels.dart';
import 'package:pradeep_the_developer/fullApps/socialv/screens/home/screens/SVForumScreen.dart';
import 'package:pradeep_the_developer/fullApps/socialv/screens/profile/screens/SVGroupProfileScreen.dart';
import 'package:pradeep_the_developer/fullApps/socialv/utils/SVColors.dart';
    ...
    return Column(
      children: [
            ...
            Row(
              ...
              children: [
                svCommonCachedNetworkImage(
                        '$BaseUrl/images/socialv/faces/face_1.png',
                        height: 62,
                        width: 62,
                        fit: BoxFit.cover)
        ...
        SnapHelperWidget<String>(
          future:
              getPackageInfo().then((value) => value.versionName.validate()),
          onSuccess: (data) => Text(data.validate(),
