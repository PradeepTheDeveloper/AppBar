...
import 'package:pradeep_the_developer/fullApps/socialv/screens/profile/components/SVProfileHeaderComponent.dart';
import 'package:pradeep_the_developer/fullApps/socialv/screens/profile/components/SVProfilePostsComponent.dart';
                          ...
                          children: [
                            Container(
                              ...
                              child: svCommonCachedNetworkImage(
                                      '$BaseUrl/images/socialv/faces/face_2.png',
                                      height: 32,
                                      width: 32,
                                      fit: BoxFit.cover)
                            ...
                            Positioned(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: radius(100)),
                                child: svCommonCachedNetworkImage(
                                        '$BaseUrl/images/socialv/faces/face_3.png',
                                        height: 32,
                                        width: 32,
                                        fit: BoxFit.cover)
                                    .cornerRadiusWithClipRRect(100),
                            ...
                            Positioned(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: radius(100)),
                                child: svCommonCachedNetworkImage(
                                        '$BaseUrl/images/socialv/faces/face_4.png',
                                        height: 32,
                                        width: 32,
                                        fit: BoxFit.cover)
                                    .cornerRadiusWithClipRRect(100),
