...
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIAAddGroceryScreen.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                      ...
                      RichText(
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' symbol may contain allergens. Tap an ingredient for more details, and make sure to purchase an allergen-free variety.',
                              style: primaryTextStyle(color: Colors.white),
                            ),
                          ],
                        ),
          ...
          Text('Produce', style: boldTextStyle(color: miaSecondaryTextColor))
              ...
              return Row(
                ...
                children: [
                  Row(
                    children: [
                      IconButton(
                        icon: !groceriesList[index].selected.validate()
                            ? Icon(Icons.circle_outlined)
                            : Icon(Icons.check_circle),
                        onPressed: () {
                          groceriesList[index].selected =
                              !groceriesList[index].selected!;
                          setState(() {});
                        },
                      ),
                        ...
                        style: boldTextStyle(
                          color: groceriesList[index].selected!
                              ...
                              : appStore.isDarkModeOn
                                  ? Colors.white
                                  : Colors.black,
                          decoration: groceriesList[index].selected!
                  ...
                  Text(groceriesList[index].subtitle!,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          groceriesList =
              await MIAAddGroceryScreen(groceriesList: groceriesList)
                  .launch(context);
          setState(() {});
        },
