...
class _MealContainerComponentState extends State<MealContainerComponent> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(widget.header, style: boldTextStyle(size: 20))
              ...
              return SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Stack(
                        children: [
                          miaCommonCachedNetworkImage(
                                  widget.mealList[index].image,
                                  height: 150,
                                  width: 150,
                                  fit: BoxFit.cover)
                              .cornerRadiusWithClipRRect(32)
                              .onTap(() {
                            MIASingleMealScreen(element: widget.mealList[index])
                                .launch(context);
                          }),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: widget.mealList[index].added
                              ...
                              widget.mealList[index].added =
                                  !widget.mealList[index].added;
                              if (widget.mealList[index].added &&
                                  !widget.mealList[index].pro) {
                                miaStore.addMeal(
                                    header: widget.header,
                                    element: widget.mealList[index]);
                                ...
                                miaStore.removeMeal(
                                    header: widget.header,
                                    element: widget.mealList[index],
                                    name: widget.mealList[index].text);
                              }
                              setState(() {});
                            }),
                          ),
                    ...
                    8.height,
                    Text(widget.mealList[index].text,
