...
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIACollectionScreen.dart';
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIAFeedbackScreen.dart';
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIAGuideScreen.dart';
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIANotesScreen.dart';
        ...
        return Column(
          ...
          children: [
            ...
            SettingItemWidget(
              ...
              leading:
                  Icon(Icons.messenger_outline, color: miaSecondaryTextColor),
              titleTextStyle: boldTextStyle(),
              onTap: () {
                finish(context);
      ...
      builder: (context) {
        return Column(
          ...
          children: [
            12.height,
            Text('5 minutes',
                style: secondaryTextStyle(color: miaSecondaryTextColor)),
            Row(
          ...
          children: [
            ...
            SettingItemWidget(
                ...
                leading: Icon(Icons.account_circle_outlined,
                    color: miaSecondaryTextColor, size: 30),
                titleTextStyle: boldTextStyle(),
                onTap: () {
                  finish(context);
                }),
