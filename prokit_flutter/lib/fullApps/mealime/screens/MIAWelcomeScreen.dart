...
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIASignInScreen.dart';
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIAWalkThroughScreen.dart';
                ...
                children: [
                  Text('Already a member?  ',
                      style: secondaryTextStyle(
                          size: 16, color: miaSecondaryTextColor)),
                  Text('Sign In',
                          style: boldTextStyle(
                              decoration: TextDecoration.underline,
                              color: miaSecondaryColor))
                      .onTap(() {
