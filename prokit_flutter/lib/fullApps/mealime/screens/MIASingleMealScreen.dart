...
import 'package:pradeep_the_developer/fullApps/mealime/components/MealTabComponents.dart';
              ...
              SliverAppBar(
                              ...
                              children: [
                                Text('35 minutes  ',
                                    style: primaryTextStyle(
                                        color: miaSecondaryTextColor)),
                                Icon(Icons.circle,
                                    color: miaSecondaryTextColor, size: 10),
                                Text('  2 servings  ',
                                    style: primaryTextStyle(
                                        color: miaSecondaryTextColor)),
                              ],
                ...
                bottom: TabBar(
                  ...
                  indicator: BoxDecoration(
                      ...
                      borderRadius: radiusOnly(topRight: 6, topLeft: 6)),
            ...
            AppButton(
              child: Row(
                ...
                children: [
                  ...
                  4.width,
                  Text('Cooked?',
                      style: boldTextStyle(color: miaSecondaryColor)),
                ],
              ),
