...
import 'package:pradeep_the_developer/fullApps/eventApp/model/EAActivityModel.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/model/EAEventListModel.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/model/EAForYouModel.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/model/EAInboxModel.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/model/EAReviewModel.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/model/EATicketModel.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/model/EAWalkThroughModel.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/utils/EAConstants.dart';

import 'EAImages.dart';

List<EAWalkThrough> walkThroughList = [
  EAWalkThrough(
      image: event_ic_walk_through2,
      title: "EVENTS COLLECTION",
      subtitle: "Discover the best things to do this week in this city"),
  EAWalkThrough(
      image: event_ic_walk_through3,
...
List<EACityModel> hashtagList = [
  ...
  EACityModel(
      name: "food",
      subtitle: "1.5k+ events",
      image: event_ic_food,
      selectHash: false),
  EACityModel(
      name: "cinema",
      subtitle: "3.4k+ events",
      image: event_ic_cinema,
      selectHash: false),
  EACityModel(
      name: "music",
      subtitle: "800+ events",
