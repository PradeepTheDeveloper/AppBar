...
import 'package:pradeep_the_developer/fullApps/eventApp/utils/EADataProvider.dart';
...
class _EAPurchaseScreenState extends State<EAPurchaseScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return <Widget>[
            SliverAppBar(
              ...
              title:
                  Text('Purchase Detail', style: boldTextStyle(color: white)),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Column(
                            children: [
                              Text("Quiet Clubbing VIP Heated RoofTop Party",
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      6.height,
                                      Text(
                                          "605 W 48th street, Manhattan, 1008 ",
                                          style: secondaryTextStyle()),
                                    ],
                                  ).expand(),
                                ],
                ...
                itemBuilder: (context, i) {
                  return Container(
                    ...
                    decoration: boxDecorationWithRoundedCorners(
                      border: Border.all(
                          width: 1,
                          color: isSelected == i ? primaryColor1 : white),
                      backgroundColor: context.cardColor,
                    ),
                    height: 110,
                    width: 110,
                    child:
                        Image.network(cardList[i].image!, fit: BoxFit.fitWidth)
      ...
      bottomNavigationBar:
          commonButton(width: context.width(), btnText: "Get it")
              .paddingAll(18),
    );
  }
}
