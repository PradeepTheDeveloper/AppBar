...
import 'package:pradeep_the_developer/fullApps/eventApp/screens/EAEventDetailScreen.dart';
          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon:
                          Icon(Icons.close, size: 18, color: primaryColor1)
                              .onTap(() {
                ...
                16.height,
                Text('250 result For " Party" in New york',
                        style: primaryTextStyle())
                    .paddingLeft(16),
                ListView.builder(
                  shrinkWrap: true,
                    ...
                    return Column(
                      children: [
                        Stack(
                          ...
                          alignment: Alignment.bottomCenter,
                          children: [
                            commonCachedNetworkImage(forYouList[i].image!,
                                    height: 230,
                                    width: context.width(),
                                    fit: BoxFit.cover)
