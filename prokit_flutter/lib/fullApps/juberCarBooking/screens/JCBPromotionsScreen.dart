...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/components/JCBPromoComponent.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            decoration:
                BoxDecoration(color: jcbPrimaryColor, borderRadius: radius(50)),
            child: Row(
              children: [
                Container(
                  child:
                      Icon(Icons.star_border, color: jcbPrimaryColor, size: 20),
