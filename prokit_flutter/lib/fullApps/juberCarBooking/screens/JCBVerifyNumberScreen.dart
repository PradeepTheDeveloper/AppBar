...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/screens/JCBUpdateInfoScreen.dart';
            ...
            RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(
                      text: widget.phoneNo,
                      style: boldTextStyle(size: 14, color: jcbGreyColor)),
                ],
              ),
            ),
            30.height,
            ...
            RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(
                      text: 'Resend Code',
                      style: boldTextStyle(size: 14, color: jcbPrimaryColor)),
                ],
              ),
            ),
            30.height,
