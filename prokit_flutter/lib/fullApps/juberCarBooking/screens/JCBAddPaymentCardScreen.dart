...
class JCBAddPaymentCardScreen extends StatefulWidget {
  @override
  State<JCBAddPaymentCardScreen> createState() =>
      _JCBAddPaymentCardScreenState();
}
                    ...
                    Container(
                      ...
                      child: AppTextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'MM/DD/YYYY',
                          hintStyle:
                              boldTextStyle(color: jcbGreyColor, size: 14),
                        ),
                      ),
                    ),
                  ],
              ...
              onTap: () {
                if (cardNo.text != '' && expires.text != '') {
                  finish(
                      ...
                      JCBCommonModel(
                          title: cardNo.text,
                          subTitle: expires.text,
                          image:
                              'images/juberCarBooking/jcbIcons/ic_visa.png'));
                } else {
