...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/models/JCBCommonModel.dart';
import 'package:pradeep_the_developer/fullApps/juberCarBooking/screens/JCBPaymentMethodScreen.dart';
...
class _JCBPickTimeBottomSheetState extends State<JCBPickTimeBottomSheet> {
  ...
  @override
  void initState() {
    hour = List<DateTime>.generate(
        10, (i) => DateTime.now().add(Duration(hours: i)));
    minutes = List<DateTime>.generate(
        60, (i) => DateTime.now().add(Duration(minutes: i)));
    setState(() {});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          selectedIndex == 1
              ? 'Driver may arrive by $selectedHour : $selectedMinute'
              : 'Driver may arrive by 10 minutes',
        ...
        AppButton(
          ...
          child: Text('set pick-up time'.toUpperCase(),
