...
class SocialNotificationState extends State<SocialNotification> {
      ...
      children: <Widget>[
        Container(
          decoration: boxDecoration(
              showShadow: false, radius: spacing_middle, bgColor: social_blue),
          width: width * 0.12,
          height: width * 0.12,
  ...
  Widget mPopup() => PopupMenuButton(
        ...
        child: Container(
            ...
            decoration: boxDecoration(
                showShadow: false, color: social_view_color, radius: 12),
            child: Icon(
              Icons.more_vert,
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          text(social_lbl_notification_tone,
                              fontFamily: fontMedium),
                          text(social_lbl_default_ringtone,
                              textColor: social_textColorSecondary),
                          mView(),
                          text(social_lbl_vibrate, fontFamily: fontMedium),
                          text(social_lbl_default_vibration,
                              textColor: social_textColorSecondary),
                          mView(),
                          text(social_lbl_popup_notification,
                              fontFamily: fontMedium),
                          text(social_lbl_only_show_when_screen_is_on,
                              textColor: social_textColorSecondary),
                          mView(),
                          text(social_lbl_light, fontFamily: fontMedium),
                          text(social_lbl_white,
                              textColor: social_textColorSecondary),
                          mView(),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Expanded(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    text(
                                        social_lbl_use_high_priority_notifications,
                                        fontFamily: fontMedium),
                                    text(
