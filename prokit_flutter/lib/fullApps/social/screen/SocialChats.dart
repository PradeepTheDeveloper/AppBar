                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                            ...
                            children: <Widget>[
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                    text(social_lbl_enter_in_send,
                                        fontFamily: fontMedium),
                                    text(
                                        social_lbl_enter_key_will_send_your_message,
                            ...
                            children: <Widget>[
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                    text(social_lbl_media_visibility,
                                        fontFamily: fontMedium),
                                    text(
                                        social_lbl_show_preview_of_notifications_at_the_top_of_the_screen,
                                        textColor: social_textColorSecondary),
                                  ],
                                ),
                              ),
                          ...
                          text(social_lbl_medium_fonts,
                              textColor: social_textColorSecondary),
                          view,
                          text(social_lbl_app_languages,
                              fontFamily: fontMedium),
                          text(social_lbl_phone_languages_english,
                              textColor: social_textColorSecondary),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        children: <Widget>[
                          SocialOption(
                              ...
                              social_dark_yellow,
                              social_picture,
                              social_lbl_wallpaper,
                              social_lbl_select_chat_background_wallpaper),
                          SizedBox(
                          ...
                          SocialOption(
                              ...
                              social_dark_yellow,
                              social_bckup,
                              social_lbl_chat_backup,
                              social_lbl_view_backup_history_settings),
                          SizedBox(
                            height: spacing_standard_new,
                          ),
                          SocialOption(
                              ...
                              social_dark_yellow,
                              social_history,
                              social_lbl_chat_history,
                              social_lbl_share_and_download_history),
                        ],
                      ),
                    )
                  ],
