                  ...
                  child: Column(
                    children: <Widget>[
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            SocialOption(context, social_blue, social_privacy,
                                social_lbl_privacy, social_lbl_privacy_info),
                            SizedBox(height: spacing_standard_new),
                            SocialOption(context, social_blue, social_ic_lock,
                                social_lbl_security, social_lbl_security_info),
                            SizedBox(height: spacing_standard_new),
                            SocialOption(
                                context,
                                social_blue,
                                social_ic_lock,
                                social_lbl_two_step_verification,
                                social_lbl_verification_info),
                            SizedBox(height: spacing_standard_new),
                            SocialOption(
                              context,
                              social_blue,
                            ...
                            SocialOption(
                                ...
                                social_blue,
                                social_ic_help,
                                social_lbl_request_info,
                                social_lbl_request_info_),
                            SizedBox(height: spacing_standard_new),
                            SocialOption(
                              context,
                              social_blue,
