...
import 'package:pradeep_the_developer/fullApps/cloudStorage/components/CSCopyAndMoveComponents.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/components/CSDisplayDataInGridViewComponents.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/components/CSDisplayDataInListViewComponents.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/components/CSDrawerComponents.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/components/CSSearchBar.dart';
  ...
  List<Widget> actionBarWidgets() {
    ...
    if (selectedItem == 0) {
      ...
      listOfActionBarWidgets.add(
        IconButton(
            color: CSDarkBlueColor,
            icon: Icon(MaterialCommunityIcons.file_download),
            onPressed: () {}),
      );
      listOfActionBarWidgets.add(PopupMenuButton(
          ...
          onSelected: (dynamic val) async {
            ...
            if (val == 4) {
              bool isSelectedFileDeleted = await (buildDeleteSelectedFileDialog(
                  context, "Delete $selectedItem items?"));
              if (isSelectedFileDeleted) {
                getCloudboxList
                    .removeWhere((element) => element.isFileSelect == true);
                    ...
                    ? IconButton(
                        ...
                        onPressed: () => setState(() {
                          ...
                          getCloudboxList.forEach(
                              (element) => element.isFileSelect = false);
                          selectedItem = 0;
                        }),
                      )
                    : null,
                actions: isSelect
                    ...
                    : [
                        IconButton(
                          ...
                          onPressed: () => showSearch(
                            ...
                            delegate: CSSearchBar(
                                hintText: "Searching in Cloudbox",
                                listData: getCloudboxList),
                          ),
                        ),
                        IconButton(
                          color: CSDarkBlueColor,
                        ...
                        PopupMenuButton(
                          ...
                          itemBuilder: (context) =>
                              [PopupMenuItem(value: 1, child: Text("Sort"))],
                        ),
                      ],
                        ...
                        : Row(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    defaultSortingType.toString().substring(
                                        defaultSortingType
                                                .toString()
                                                .indexOf('.') +
                                            1),
                              ...
                              IconButton(
                                ...
                                icon: state == CrossFadeState.showFirst
