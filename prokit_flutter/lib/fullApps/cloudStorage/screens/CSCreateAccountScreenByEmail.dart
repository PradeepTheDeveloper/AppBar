...
import 'package:pradeep_the_developer/fullApps/cloudStorage/screens/CSWalkthroughScreen1.dart';
...
class CSCreateAccountScreenByEmailState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          appBarWidget("Create a Cloudbox Account", color: context.cardColor),
      body: Center(
        child: Column(
            ...
            Wrap(
              children: [
                RichText(
                  text: TextSpan(
                    text:
                        "Looks like there is no Cloudbox account with the email address ",
