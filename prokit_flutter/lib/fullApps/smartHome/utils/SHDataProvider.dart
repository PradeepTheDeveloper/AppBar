import 'package:pradeep_the_developer/fullApps/smartHome/component/SHAirConditionerDeviceComponent.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/component/SHAirPurifierDeviceComponenet.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/component/SHClimateDeviceComponentWidget.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/component/SHFanDeviceComponent.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/component/SHLightDeviceComponenet.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/component/SHSpeakersDeviceComponent.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/component/SHTelevisionDeviceComponenet.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/component/SHWashingMachineDeviceComponent.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/model/SHModel.dart';
...
List<SHModel> getMemberList() {
  ...
  list.add(SHModel(
      img:
          'https://www.whatsappprofiledpimages.com/wp-content/uploads/2021/02/Beautiful-Girl-Profile-Pics-Wallpaper-Download-3.jpg',
      name: 'Bessie Cooper',
      subtitle: 'Household',
...
List<SHModel> getScenesList() {
  List<SHModel> list = [];
  list.add(SHModel(
      img: 'images/shHome/sun.png',
      name: 'Morning\'',
      subtitle: '5 devices is on'));
  list.add(SHModel(
      img: 'images/shHome/night.png', name: 'Night', subtitle: '5 devices'));
  list.add(SHModel(
      img: 'images/shHome/music.png', name: 'Music', subtitle: '5 devices'));
  list.add(SHModel(
      img: 'images/shHome/movie.png', name: 'Movie', subtitle: '5 devices'));
  list.add(SHModel(
      img: 'images/shHome/leave.png', name: 'Leave', subtitle: '5 devices'));
  return list;
}
...
List<SHModel> getStatisticList() {
  ...
  list.add(
    SHModel(
        img: 'images/shHome/air_conditioner.png',
        name: 'AC',
        subtitle: '120 hours'),
  );
  list.add(
    SHModel(
        img: 'images/shHome/thermometer.png',
        name: 'Climate',
        subtitle: '50 hours'),
  );
  list.add(
