...
import 'package:pradeep_the_developer/fullApps/smartHome/screens/SHAllDevicesScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/screens/SHNewDeviceScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/screens/SHNewRoomScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/screens/SHRoomScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/utils/SHColors.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/utils/SHComman.dart';
import 'package:pradeep_the_developer/fullApps/smartHome/utils/SHDataProvider.dart';
          ...
          children: [
            Row(
              children: [
                ...
                4.width,
                Text("(${homeList.length})",
                    style: secondaryTextStyle(
                        color: white.withOpacity(0.4), size: 18)),
              ],
                    ...
                    Container(
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            Text(homeData.name.validate(),
                                style: boldTextStyle(color: white)),
                            4.height,
                            Text(
                              "${getLength(homeList[index].shDeviceModel.validate())}" +
                                  "/" +
                                  "${homeData.shDeviceModel.validate().length}",
                    ...
                    HorizontalList(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: Column(
                            children: [
                              Image.asset(data.deviceImg.validate(),
                                  fit: BoxFit.cover,
                                  height: 30,
                                  width: 30,
                                  color: white),
