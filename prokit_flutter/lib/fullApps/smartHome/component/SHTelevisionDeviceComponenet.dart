...
class SHTelevisionDeviceComponent extends StatefulWidget {
  ...
  @override
  _SHTelevisionDeviceComponentState createState() =>
      _SHTelevisionDeviceComponentState();
}

class _SHTelevisionDeviceComponentState
    extends State<SHTelevisionDeviceComponent> {
  int selectedIndex = 0;
  bool isVolume = false;
  int volumeCount = 1;
  int channelCount = 0;
