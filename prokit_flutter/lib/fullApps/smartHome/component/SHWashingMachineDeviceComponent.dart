...
class SHWashingMachineDeviceComponent extends StatefulWidget {
  ...
  @override
  _SHWashingMachineDeviceComponentState createState() =>
      _SHWashingMachineDeviceComponentState();
}

class _SHWashingMachineDeviceComponentState
    extends State<SHWashingMachineDeviceComponent> {
  double width = 200;
  double height = 100;
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      shape: BoxShape.circle, color: SHScaffoldDarkColor),
                ),
                CustomPaint(
                    ...
                    children: [
                      ...
                      Text('Pause',
                          style: primaryTextStyle(
                              color: isStart ? Colors.blue : white)),
                    ],
                  ),
                ),
                16.width,
