...
class SHSpeakerDeviceComponent extends StatefulWidget {
  @override
  _SHSpeakerDeviceComponentState createState() =>
      _SHSpeakerDeviceComponentState();
}
...
class _SHSpeakerDeviceComponentState extends State<SHSpeakerDeviceComponent> {
  ...
  Widget speakerDeviceModeSlider(
      BuildContext context, double min, double max, int index) {
    return SliderTheme(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: List.generate(
                        ...
                        (index) {
                          sliderValue =
                              speakerModeList[index].sliderValue.validate();

                          return SingleChildScrollView(
                            child: Column(
                              children: [
                                speakerDeviceModeSlider(
                                    context, min, max, index),
                                Text(
