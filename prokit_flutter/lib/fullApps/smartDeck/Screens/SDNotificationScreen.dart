...
import 'package:pradeep_the_developer/fullApps/smartDeck/ModelClass/SDNotidicationModel.dart';
    ...
    Widget mPopup() => PopupMenuButton(
          ...
          child: Container(
            ...
            child: Icon(Icons.more_vert,
                color: appStore.isDarkModeOn ? white : sdTextPrimaryColor),
          ),
        );
                ...
                leading: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: commonCacheImageWidget(
                        notification[index].images!, 35,
                        width: 10, fit: BoxFit.cover),
                  ),
                ),
                title: Text(notification[index].notificationmessage!,
                    style: boldTextStyle(),
                    maxLines: 1,
