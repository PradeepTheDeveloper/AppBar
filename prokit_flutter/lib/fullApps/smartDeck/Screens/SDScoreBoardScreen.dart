...
import 'package:pradeep_the_developer/fullApps/smartDeck/ModelClass/ScoreboardAvailableModel.dart';
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child:
                      Text('Exam', style: boldTextStyle(color: Colors.white)),
                ),
                Container(
                    ...
                    child: ListTile(
                      onTap: () {
                        SDLessonsDetScreen(
                          ...
                          backgroundImages:
                              scoreboardAvailable[index].backgroundImages,
                        ).launch(context);
                      },
                      leading: Container(
                      ...
                      title: Text(scoreboardAvailable[index].title!,
                          style: boldTextStyle(size: 16)),
                      subtitle: Container(
                        margin: EdgeInsets.only(top: 5),
                        child: Text(scoreboardAvailable[index].subtitle!,
                      ...
                      leading: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: FadeInImage(
                            fit: BoxFit.cover,
                            placeholder: AssetImage('Loading'),
                            image: Image.asset(scoreboardPassed[index].image!,
                                    height: 35, width: 20)
                                .image,
                          ),
                        ),
                      ),
                      title: Text(scoreboardPassed[index].title!,
                          style: boldTextStyle(size: 16)),
                      subtitle: Container(
                        margin: EdgeInsets.only(top: 5),
                        child: Text(scoreboardPassed[index].subtitle!,
                            style: secondaryTextStyle(size: 10)),
                      ),
                      trailing: CircleAvatar(
                        radius: 15,
                        backgroundColor: (scoreboardPassed[index].status! > 70)
