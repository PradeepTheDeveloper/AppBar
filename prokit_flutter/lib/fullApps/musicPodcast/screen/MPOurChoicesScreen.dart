...
class MPOurChoicesScreenState extends State<MPOurChoicesScreen>
          ...
          Container(
            ...
            decoration: boxDecorationWithShadow(
              ...
              decorationImage: DecorationImage(
                  image: Image.network(mpImages_13).image, fit: BoxFit.cover),
            ),
          )
        ],
      ),
        ...
        children: [
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text("Our Choices For You", style: boldTextStyle(color: white))
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            commonCacheImageWidget(data.img, 120,
