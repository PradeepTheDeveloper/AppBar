...
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPSelectSongTypeScreen.dart';
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              16.height,
              Text('Hot Recommended', style: boldTextStyle(color: Colors.white))
                  .paddingOnly(left: 16),
              8.height,
              Container(
                height: 190,
                            ...
                            child: Row(
                              children: [
                                ...
                                Icon(Icons.add_circle_outline_rounded,
                                    color: mpAppButtonColor, size: 20),
                                4.width,
                                Text(data.subtitle!,
                                    style: secondaryTextStyle(
                                        color: Colors.white.withOpacity(0.5))),
