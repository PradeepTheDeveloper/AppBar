...
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPOurChoicesScreen.dart';
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              16.height,
              commonCacheImageWidget(mpImages_4, 100,
                      width: 100, fit: BoxFit.cover)
                  .cornerRadiusWithClipRRect(50)
                  .center(),
              16.height,
              Text('Smith john', style: boldTextStyle(color: Colors.white))
                  .center(),
              32.height,
              Row(
