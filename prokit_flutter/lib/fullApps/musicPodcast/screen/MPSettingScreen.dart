...
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPEditProfileScreen.dart';
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPProfileScreen.dart';
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPTermsConditionScreen.dart';
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Column(
                children: [
                  commonCacheImageWidget(mpImages_2, 100,
            ...
            ListView.separated(
              ...
              separatorBuilder: (BuildContext context, int index) =>
                  Divider(color: Colors.white.withOpacity(0.3), indent: 20),
