...
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPAlbumsDetailScreen.dart';
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPNowPlayingScreen.dart';
      ...
      child: Scaffold(
        ...
        appBar: widget.isTab!
            ...
            : AppBar(
                ...
                title: Text("Albums",
                    style:
                        boldTextStyle(color: white.withOpacity(0.9), size: 18)),
                centerTitle: true,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('View All',
                          style: primaryTextStyle(color: mpAppButtonColor))
                      .paddingOnly(right: 8)
                      .onTap(() {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Column(
                      ...
                      children: [
                        commonCacheImageWidget(data.img, 130,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Top Albums', style: boldTextStyle(color: Colors.white))
                      .onTap(() {}),
                  Text('View All',
                          style: primaryTextStyle(color: mpAppButtonColor))
                      .paddingOnly(right: 8)
                  ...
                  (index) {
                    ...
                    return Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          commonCacheImageWidget(data.img, 170,
                                  fit: BoxFit.cover)
