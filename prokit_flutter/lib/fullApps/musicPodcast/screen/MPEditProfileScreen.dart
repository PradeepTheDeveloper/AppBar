          ...
          children: [
            ...
            Column(
              children: [
                ...
                8.height,
                editProfileWidget(
                    title: 'your Email', uName: 'smith@gmail.com'),
                8.height,
                Divider(color: Colors.white.withOpacity(0.2)),
                8.height,
                editProfileIconWidget(
                    title: 'Reset Password', icon: Icons.keyboard_arrow_right),
                8.height,
                Divider(color: Colors.white.withOpacity(0.2)),
                EditProfileSwitchWidget(
                        name: 'Notification', isSelected: isSelected)
                    .onTap(() {
                ...
                8.height,
                editProfileIconWidget(
                    title: 'Gender', icon: Icons.keyboard_arrow_down),
                8.height,
                Divider(color: Colors.white.withOpacity(0.2)),
                50.height,
                Container(
