...
InputDecoration buildInputDecoration(String name) {
  return InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(color: viewLineColor, width: 0.5)),
    ...
    child: Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            commonCacheImageWidget(mpImages_1, 50, width: 50, fit: BoxFit.cover)
            ...
            Column(
              ...
              children: [
                ...
                Text(" Bally Wonger",
                    ...
                    style: secondaryTextStyle(color: mpAppTextColor1)),
              ],
            ).expand(),
            Row(
              children: [
                Icon(Icons.chevron_left_outlined,
                        color: mpAppButtonColor, size: 25)
                    .onTap(() {
                  toasty(context, 'Previous',
                      bgColor: Colors.white, textColor: Colors.black);
                }),
                16.width,
                Icon(Icons.play_circle_outline,
                        color: mpAppButtonColor, size: 30)
                    .onTap(() {
                  toasty(context, 'Play',
                      bgColor: Colors.white, textColor: Colors.black);
                }),
