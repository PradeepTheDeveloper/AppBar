...
import 'package:pradeep_the_developer/fullApps/homeService/screens/payment_screen.dart';
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.all(2.0),
                                  child:
                                      Icon(Icons.add, color: black, size: 16),
                                ),
                              ),
                            ],
                          ),
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        ListTile(
                          ...
                          trailing: Text("₹${widget.list[0].price}",
                              textAlign: TextAlign.start,
