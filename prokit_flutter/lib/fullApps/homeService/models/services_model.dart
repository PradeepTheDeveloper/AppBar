...
import 'package:pradeep_the_developer/fullApps/homeService/models/service_provider_model.dart';
...
List<ServicesModel> getServices() {
  ...
  list.add(ServicesModel(1, "Plumbers", "Who helps you in plumbing works",
      "Plumber", getPlumbers(), plumber, Icons.plumbing,
      isSelected: true));
  list.add(ServicesModel(2, "Electricians", "Who helps you in electrical works",
      "Electrician", getElectricians(), electrician, Icons.cable_outlined));
  list.add(ServicesModel(3, "Painters", "Who helps you in painting anything",
      "Painting", getPainters(), painter, Icons.format_paint));
  list.add(ServicesModel(4, "Carpenters", "Who helps you in carpenting works",
      "Carpenter", getCarpenters(), carpenter, Icons.other_houses_sharp));
  ...
  list.add(ServicesModel(5, "Car Washers", "Who helps you in cleaning the car",
      "Car cleaning", getHomeCleaning(), painter1, Icons.car_repair_outlined));
  list.add(ServicesModel(
      6,
      "Car repairing",
      "Who helps in car repairing",
      "Car experts",
      getElectricians(),
      electrician,
