...
import 'package:pradeep_the_developer/fullApps/carea/screens/registration_screen.dart';
import 'package:pradeep_the_developer/fullApps/carea/screens/wish_list_screen.dart';
import 'package:pradeep_the_developer/fullApps/carea/screens/zoom_image_screen.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                    ...
                    child:
                        Text("BMW M5 Series", style: boldTextStyle(size: 20))),
                SizedBox(height: 15),
                Padding(
                  padding: EdgeInsets.only(left: 16),
                  child: Row(
                ...
                Text.rich(
                  TextSpan(
                    ...
                    text:
                        "Loream ipsu dolor sit amet consecteture adipiscing elit, sed"
                ...
                Padding(
                  ...
                  child: Align(
                      alignment: Alignment.topLeft,
                      child: Text("Gallery photo", style: boldTextStyle())),
                ),
                SizedBox(height: 16),
                SizedBox(
                  height: 60,
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          ZoomImageScreen(galleryImages: carList, index: index)
                              .launch(context);
                        },
                        child: Container(
                          ...
                          child: Image(
                              image: AssetImage(carList[index]),
                              height: 50,
                              width: 50),
                        ),
                      );
                ...
                ListTile(
                  ...
                  leading: Image(
                      image: AssetImage("images/carea/bmw.png"),
                      height: 50,
                      width: 50),
                  title: Text("BMW Store", style: boldTextStyle()),
                  subtitle: Text("Official Accont of BMW ✔",
                      style: secondaryTextStyle()),
