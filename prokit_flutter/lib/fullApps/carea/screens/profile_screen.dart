...
import 'package:pradeep_the_developer/fullApps/carea/commons/app_theme.dart';
...
import 'package:pradeep_the_developer/fullApps/carea/model/user_info.dart';
import 'package:pradeep_the_developer/fullApps/carea/store/profile_ob.dart';
    ...
    await showDatePicker(
      ...
      if (date != null) {
        ...
        userDateOfBirthController.text =
            "${formatDate(selectedDate.toString(), format: DATE_FORMAT_2)}";
      }
    }).catchError((e) {
      toast(e.toString());
    });
                            ...
                            child: DropdownButton(
                              ...
                              onChanged: (val) {
                                pr_ob.pickedValuseOfDropDownMenu1 =
                                    val!.toString().validate().toDouble();
                              },
                            ),
                          ),
                        ),
