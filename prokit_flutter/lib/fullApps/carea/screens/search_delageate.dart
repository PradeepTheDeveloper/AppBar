...
import 'package:pradeep_the_developer/fullApps/carea/commons/data_provider.dart';
import 'package:pradeep_the_developer/fullApps/carea/commons/images.dart';
import 'package:pradeep_the_developer/fullApps/carea/components/filter_component.dart';
import 'package:pradeep_the_developer/fullApps/carea/model/calling_model.dart';
                      ...
                      Column(
                        children: [
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      DetailScreen(image: ListOfCarImg[index]),
                                ),
                              );
                            },
                            child: Container(
                          ...
                          Align(
                                  ...
                                  child: Text(
                                      style: boldTextStyle(), "Sedan Series"))
                              .paddingOnly(left: 16),
                          SizedBox(height: 10),
                          Row(
                            children: [
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                                style: boldTextStyle(), listOfCarPrize[index]),
                          ).paddingOnly(left: 16),
                        ],
                      ),
                    ],
                      ...
                      child: Stack(
                        children: [
                          Image(
                              height: 130,
                              width: 130,
                              image: AssetImage(ListOfCarImg[index])),
                        ],
                      ),
                    ),
                  ),
