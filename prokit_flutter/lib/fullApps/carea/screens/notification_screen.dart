...
class NotificationScreen extends StatefulWidget {
  NotificationScreen({Key? key, this.isAppbarNeeded, this.appBar})
      : super(key: key);
  bool? isAppbarNeeded;
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: (widget.isAppbarNeeded == null)
            ? careaAppBarWidget(context, titleText: "Notification")
            : widget.appBar,
        body: Container(
                  ...
                  child: ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        Text("Now you can track order in real time",
                            style: secondaryTextStyle()),
                        SizedBox(height: 8),
                      ],
                    ),
