      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Image.asset(widget.data!.imageUrl.validate(),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  8.width,
                  Text(widget.data!.subTitle.validate(),
                  ...
                  Container(
                    ...
                    child: Text(widget.btnText1.validate(),
              ...
              Row(
                children: [
                  Text(widget.data!.countNumber.validate(),
                      style: boldTextStyle()),
                  16.width,
                  GestureDetector(
                    onTap: () {
                    ...
                    child: Container(
                      ...
                      child: Text(widget.btnText2.validate(),
