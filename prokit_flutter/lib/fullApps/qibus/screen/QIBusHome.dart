...
import 'package:pradeep_the_developer/fullApps/qibus/screen/QIBusNotification.dart';
    ...
    return Stack(
      children: <Widget>[
        Container(
            ...
            decoration: boxDecoration(
                radius: 8, bgColor: context.cardColor, showShadow: true),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Padding(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    height: MediaQuery.of(context).size.width * 0.25,
                    decoration: boxDecoration(
                        bgColor: qIBus_colorPrimary, radius: 10.0),
                    child: Padding(
...
class RecentSearch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: width * 0.7,
      decoration: boxDecoration(
          showShadow: true, bgColor: context.cardColor, radius: spacing_middle),
              ...
              children: [
                WidgetSpan(
                  child: Padding(
                    ...
                    child: SvgPicture.asset(qibus_ic_bus,
                        color: qIBus_colorPrimary, height: 18, width: 18),
                  ),
                ),
                TextSpan(
