                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        text(mList[index].travelName,
                                            fontFamily: fontMedium),
                                        text(mList[index].duration,
                                            fontFamily: fontMedium),
                                      ],
                                    ),
                                    text(mList[index].location,
                      ...
                      itemBuilder: (BuildContext context, int index) =>
                        ...
                        child: Container(
                          margin: EdgeInsets.only(
                              ...
                              bottom: spacing_standard_new),
                          decoration: boxDecoration(
                              radius: spacing_middle, showShadow: true),
                          padding: EdgeInsets.all(spacing_middle),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  text(mList1[index].travelName,
                                      fontFamily: fontMedium),
                                  text(mList1[index].duration,
                                      fontFamily: fontMedium),
                                ],
                              ),
