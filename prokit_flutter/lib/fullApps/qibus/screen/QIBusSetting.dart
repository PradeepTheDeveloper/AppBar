...
class QIBusSettingState extends State<QIBusSetting> {
  ...
  Widget mSetting(var heading, var subLabel, var value) {
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(spacing_standard, spacing_standard_new,
            ...
            child: SingleChildScrollView(
              child: Container(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    mSetting(QIBus_title_email_notification_settings,
                        QIBus_txt_email_notification, mEmailNotification),
                    mSetting(QIBus_lbl_contact_number_settings,
                        QIBus_lbl_number_notification, mContactNotification),
                    mSeeting1(QIBus_title_language_setting, QIBus_lbl_language,
                        language, _selectedLocation),
                    mSeeting1(QIBus_text_country, QIBus_title_country_settings,
                        country, _selectedLocation1),
                  ],
                ),
              ),
            ),
