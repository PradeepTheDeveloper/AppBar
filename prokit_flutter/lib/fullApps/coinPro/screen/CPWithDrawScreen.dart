        ...
        child: MaterialButton(
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => CPMyWalletScreen()));
          },
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.attach_money,
                      color: appStore.isDarkModeOn ? white : black, size: 16),
                ),
              ),
              SizedBox(height: 16),
              Text(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.only(
                        right: 24, left: 24, top: 30, bottom: 8),
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                              ...
                              child:
                                  Image.asset(cp_visa, width: 40, height: 40)),
