import 'package:pradeep_the_developer/fullApps/appetit/screens/ALoginScreen.dart';
import 'package:pradeep_the_developer/fullApps/appetit/screens/ARegisterScreen.dart';
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  16.height,
                  Text(
                      'Create an account and login the page and for new user register the page',
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => ARegisterScreen())),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Image.asset('images/appetit/google.png',
                            width: 70, height: 70),
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(15))),
                        child: Image.asset('images/appetit/Apple.png',
                            width: 60, height: 60),
                      ),
                    ),
                  ),
