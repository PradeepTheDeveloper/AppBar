...
class APopularRecipesComponent extends StatefulWidget {
  ...
  @override
  State<APopularRecipesComponent> createState() =>
      _APopularRecipesComponentState();
}
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: IconButton(
                  onPressed: () => setState(() {
                    categorymodal[index].isBookMark =
                        !categorymodal[index].isBookMark;
                  }),
                  icon: !categorymodal[index].isBookMark
                      ? Icon(Icons.bookmark_border_outlined,
                          color: Colors.white.withOpacity(0.70), size: 30)
                      : Icon(Icons.bookmark,
                          color: Colors.orange.withOpacity(0.70), size: 30),
                  // color: Colors.black.withOpacity(0.4),
                  splashRadius: 25,
                ),
              ),
