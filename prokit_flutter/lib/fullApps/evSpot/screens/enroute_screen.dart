...
import 'package:pradeep_the_developer/main.dart' as main;
...
class _EnrouteScreenState extends State<EnrouteScreen> {
  ...
  static final CameraPosition _kGooglePlex =
      CameraPosition(target: LatLng(51.5072, 0.1276), zoom: 14);
      ...
      markerEnroute.add(
        Marker(
          ...
          infoWindow: InfoWindow(
              title: 'This is title marker ${listLatLng.indexOf(element) + 1}'),
          icon: await BitmapDescriptor.fromAssetImage(
              ImageConfiguration(), ic_marker2),
          onTap: () {
  ...
  void loadData() async {
    markerEnroute.add(
      Marker(
        ...
        icon: await BitmapDescriptor.fromAssetImage(
            ImageConfiguration(), ic_navigation),
      ),
    );
    CameraPosition cameraPosition =
        CameraPosition(target: LatLng(51.5072, 0.1276), zoom: 15);
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 16,
            child: Material(
              color: main.appStore.isDarkModeOn
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          child: Divider(height: 0, thickness: 1, indent: 15)),
                    ],
                  ),
                  TextField(
