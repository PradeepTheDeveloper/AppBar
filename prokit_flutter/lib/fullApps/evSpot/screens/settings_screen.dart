...
import 'package:pradeep_the_developer/fullApps/evSpot/components/dotted_line.dart';
import 'package:pradeep_the_developer/main.dart';
import 'package:pradeep_the_developer/fullApps/evSpot/screens/privacy_policy_screen.dart';
import 'package:pradeep_the_developer/fullApps/evSpot/screens/sign_in_screen.dart';
import 'package:pradeep_the_developer/fullApps/evSpot/screens/terms_condition_screen.dart';
import 'package:pradeep_the_developer/fullApps/evSpot/utils/colors.dart';
import 'package:pradeep_the_developer/fullApps/evSpot/utils/constant.dart';
...
class _SettingScreenState extends State<SettingScreen> {
        ...
        child: Column(
          ...
          children: [
                    ...
                    onTap: () async {
                      languageGroupValue = await showDialog(
                        ...
                        builder: (context) => dialog(
                            ...
                            listItemValue: languageListItem,
                  ...
                  Observer(
                    builder: (context) {
                      return GestureDetector(
                        onTap: () {
                          appModeGroupValue = appStore.isDarkModeOn
                              ? "Dark Mode"
                              : "Light Mode";
                          showDialog(
                            context: context,
                            builder: (context) => dialog(
                                context: context,
                                titleDialog: 'App Mode',
                                listItemValue: appModeListItem,
                                groupValue: appModeGroupValue),
                          ).then((value) {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                    child: Text(
                                        '${appStore.isDarkModeOn ? 'Dark Mode' : 'Light Mode'}',
                                        style: primaryTextStyle())),
                                Icon(Icons.keyboard_arrow_down),
                              ],
                            ),
                  ...
                  GestureDetector(
                    onTap: () async {
                      distanceGroupValue = await showDialog(
                        ...
                        builder: (context) => dialog(
                            context: context,
                            titleDialog: 'Distance Unity',
                            listItemValue: distanceListItem,
                            groupValue: distanceGroupValue),
                      );
                      setState(() {});
                    },
                    child: Column(
            ...
            DottedLine(
                ...
                dashLength: 4,
                dashColor:
                    appStore.isDarkModeOn ? dividerBlackColor : dividerColor),
            SizedBox(height: 5),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    showDialog(
                      ...
                      builder: (context) {
                        return AlertDialog(
                          title: Text('Logout'),
                          content: Text(
                              'Do you really want to logout the account ?'),
  ...
  Widget dialog(
      ...
      String? titleDialog,
      required List<String> listItemValue,
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.only(
                          bottomLeft: Radius.circular(DEFAULT_RADIUS))),
                  child: OutlinedButton(
                    style: ButtonStyle(
                    ...
                    child: Text('DISMISS',
                        style: primaryTextStyle(color: ev_primary_color)),
                    onPressed: () {
                      Navigator.pop(context);
                    },
                  ),
