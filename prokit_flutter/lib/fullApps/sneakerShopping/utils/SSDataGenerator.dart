...
List<SneakerShoppingModel> paymentList() {
  ...
  list.add(SneakerShoppingModel(
      name: 'Payment Option', img: 'images/sneakerShopping/ic_payment.png'));
  list.add(SneakerShoppingModel(
...
List<SneakerShoppingModel> getAllData() {
  ...
  list.add(SneakerShoppingModel(
      ...
      img: '$BaseUrl/images/sneakerShopping/ic_shoes_5.png',
      amount: '\$300.00'));
  list.add(SneakerShoppingModel(
      name: 'Nike Air VaporMax Evo',
      subtitle: 'Women\'s shoes',
      img: '$BaseUrl/images/sneakerShopping/ic_shoes_1.png',
      amount: '\$200.00'));
  list.add(SneakerShoppingModel(
      name: 'Nike Air VaporMax Evo',
  ...
  list.add(SneakerShoppingModel(
      name: 'Nike Air VaporMax Evo',
      subtitle: 'men\'s shoes',
      img: '$BaseUrl/images/sneakerShopping/ic_shoes_6.png',
      amount: '\$300.00'));
  list.add(SneakerShoppingModel(
      name: 'Nike Air VaporMax Evo',
      subtitle: 'men\'s shoes',
      img: '$BaseUrl/images/sneakerShopping/ic_shoes_8.png',
      amount: '\$100.00'));
...
List<SneakerShoppingModel> getAllFavorite() {
  ...
  list.add(SneakerShoppingModel(
      name: 'Nike Air VaporMax Evo',
      subtitle: 'Women\'s shoes',
      img: '$BaseUrl/images/sneakerShopping/ic_shoes_10.png',
      amount: '\$200.00'));
  list.add(SneakerShoppingModel(
      name: 'Nike Air VaporMax Evo',
      subtitle: 'Nike Air Huarache',
      img: '$BaseUrl/images/sneakerShopping/ic_shoes_11.png',
      amount: '\$250.00'));
...
List<SneakerShoppingModel> getSearchData() {
  ...
  list.add(SneakerShoppingModel(
      ...
      subtitle: '25% OFF',
      img: '$BaseUrl/images/sneakerShopping/ic_arrivals_4.jpg'));
  list.add(SneakerShoppingModel(
      name: 'Top & T-Shirt Collection',
      subtitle: '30% OFF',
      img: '$BaseUrl/images/sneakerShopping/ic_arrivals_2.jpg'));
  list.add(SneakerShoppingModel(
      name: 'Top & T-Shirt Collection',
      subtitle: '70% OFF',
      img: '$BaseUrl/images/sneakerShopping/ic_arrivals_3.jpg'));
  list.add(SneakerShoppingModel(
      name: 'Top & T-Shirt Collection',
      subtitle: '55% OFF',
      img: '$BaseUrl/images/sneakerShopping/ic_arrivals_4.jpg'));
  list.add(SneakerShoppingModel(
      name: 'Top & T-Shirt Collection',
      subtitle: '35% OFF',
      img: '$BaseUrl/images/sneakerShopping/ic_arrivals_5.jpg'));
