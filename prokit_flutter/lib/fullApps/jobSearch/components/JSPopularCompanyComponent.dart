...
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSCompanyProfileScreens.dart';
...
class JsPopularCompanyComponent extends StatefulWidget {
  ...
  @override
  _JsPopularCompanyComponentState createState() =>
      _JsPopularCompanyComponentState();
}
      ...
      itemBuilder: (context, index) {
        ...
        return Column(
          ...
          children: [
            Row(
              children: [
                commonCachedNetworkImage(data.companyImage.validate(),
