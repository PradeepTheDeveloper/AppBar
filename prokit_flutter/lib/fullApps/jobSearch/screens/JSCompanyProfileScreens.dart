...
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSDrawerScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSFilteredResultsComponent.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/model/JSPopularCompanyModel.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSCompanyProfileScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSQuestionsScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSReviewsScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/utils/JSColors.dart';
...
class JSCompanyProfileScreens extends StatefulWidget {
  ...
  @override
  _JSCompanyProfileScreensState createState() =>
      _JSCompanyProfileScreensState();
}
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
                  ...
                  Row(
                    children: [
                      commonCachedNetworkImage(
                          widget.popularCompanyList!.companyImage.validate(),
                          height: 50,
                          width: 50,
                          fit: BoxFit.cover),
                      16.width,
                      Column(
                        ...
                        children: [
                          Text(
                              widget.popularCompanyList!.companyName.validate(),
            ...
            TabBarView(children: [
              JSCompanyProfileScreen(
                  popularCompanyList: widget.popularCompanyList),
