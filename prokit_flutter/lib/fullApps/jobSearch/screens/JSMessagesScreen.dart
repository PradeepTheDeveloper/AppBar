...
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSCompleteProfileOneScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSEnableNotificationDialog.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: jsAppBar(context,
          backWidget: true, homeAction: true, bottomSheet: false),
      body: Column(
                  ...
                  onTap: () {
                    showDialog(
                        ...
                        builder: (BuildContext context) => CupertinoAlertDialog(
                              title: Text(
                                  "${"Indeed Jobs"} Would Like to Send You Notification"),
                              content: Text(
                                  "Notification may include alerts, sound and icon badges. These can configured in Settings. "),
                              actions: [
