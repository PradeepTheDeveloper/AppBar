...
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSFilteredScreen.dart';
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                8.width,
                filteredWidget(
                    widget: Text("Remote", style: primaryTextStyle(size: 14))),
                8.width,
                Container(
                  decoration: boxDecorationWithRoundedCorners(
                    borderRadius: BorderRadius.circular(8),
                  ...
                  child: DropdownButton(
                    ...
                    items: daysItems.map((String daysItems) {
                      return DropdownMenuItem(
                        value: daysItems,
                        child:
                            Text(daysItems, style: primaryTextStyle(size: 14)),
                      );
                    }).toList(),
