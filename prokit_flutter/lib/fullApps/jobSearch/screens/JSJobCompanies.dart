...
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSPopularCompanyComponent.dart';
        ...
        child: Column(
          ...
          children: [
            Column(
              ...
              children: [
                16.height,
                Text("Find great Place to work",
                    style: boldTextStyle(size: 22)),
                8.height,
                Text("Get access to millions of company reviews",
                ...
                Text("Popular Companies",
                    style: boldTextStyle(
                        decoration: TextDecoration.underline, size: 18)),
                16.height,
