...
class MLSymptomsDiscriptionComponent extends StatefulWidget {
  ...
  @override
  MLSymptomsDiscriptionComponentState createState() =>
      MLSymptomsDiscriptionComponentState();
}

class MLSymptomsDiscriptionComponentState
    extends State<MLSymptomsDiscriptionComponent> {
  int i = 0;
