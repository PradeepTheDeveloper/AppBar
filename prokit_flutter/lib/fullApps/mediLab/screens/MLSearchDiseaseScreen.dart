...
import 'package:pradeep_the_developer/fullApps/mediLab/components/MLCommonDiseaseListComponent.dart';
...
class MLSearchDiseaseScreenState extends State<MLSearchDiseaseScreen> {
  ...
  static String _displayStringForOption(MLDiseaseData option) =>
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.search, color: mlColorBlue, size: 24)
                            .expand(flex: 1),
                        8.width,
