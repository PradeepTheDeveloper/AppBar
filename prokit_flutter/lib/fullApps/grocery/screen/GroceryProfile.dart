...
import 'package:pradeep_the_developer/fullApps/grocery/model/GroceryModel.dart';
...
import 'package:pradeep_the_developer/fullApps/grocery/utils/GroceryDataGenerator.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text("Pradeep", style: boldTextStyle()),
                      2.height,
                      Text("Pradeepthedeveloper@gmail.com",
                          style: secondaryTextStyle()),
                      2.height,
                      Text("9445316449", style: secondaryTextStyle()),
                    ],
                  )
                ],
              ),
            ...
            Container(
              decoration:
                  boxDecoration(radius: 10.0, bgColor: context.cardColor),
                    ...
                    children: [
                      Container(
                        ...
                        decoration: boxDecoration(
                            radius: 25.0, bgColor: profileList[index].color),
                        child: Image.asset(
