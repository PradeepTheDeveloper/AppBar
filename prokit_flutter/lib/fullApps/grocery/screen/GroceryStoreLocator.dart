...
import 'package:pradeep_the_developer/fullApps/grocery/model/grocery_allStores_model.dart';
...
import 'package:pradeep_the_developer/main/utils/clusteringGoogleMaps/clustering_helper.dart';
import 'package:pradeep_the_developer/main/utils/clusteringGoogleMaps/lat_lang_geohash.dart';

class GroceryStoreLocatorScreen extends StatefulWidget {
  static String tag = '/GroceryStoreLocatorScreen';

  @override
  _GroceryStoreLocatorScreenState createState() =>
      _GroceryStoreLocatorScreenState();
}
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text(listAllStores[index].storeName,
                          style: boldTextStyle()),
                      4.height,
                      Text(
                      ...
                      children: <Widget>[
                        IconButton(
                          ...
                          icon: Icon(Icons.clear,
                              size: 24, color: grocery_color_white),
                        ),
                        24.width,
                        Text(grocery_storeLocator,
