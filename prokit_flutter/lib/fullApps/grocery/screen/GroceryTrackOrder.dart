...
import 'package:pradeep_the_developer/fullApps/grocery/model/grocery_trackOrder_model.dart';
...
class GroceryTrackOrderScreen extends StatefulWidget {
  ...
  @override
  _GroceryTrackOrderScreenState createState() =>
      _GroceryTrackOrderScreenState();
}
      ...
      itemBuilder: (context, index) {
        return Container(
          decoration: boxDecoration(
              showShadow: true, radius: 10.0, bgColor: context.cardColor),
          child: Column(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child:
                        Icon(Icons.shopping_cart, color: grocery_color_white),
                  ).cornerRadiusWithClipRRect(25),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(listTrackOrder[index].orderName,
                        ...
                        Text(
                          grocery_subtotal +
                              ...
                              grocery_currency +
                              ' ' +
                              listTrackOrder[index].orderAmount,
                        ...
                        Text(
                            grocery_totalItems +
                                ': ' +
                                listTrackOrder[index].totelItem,
