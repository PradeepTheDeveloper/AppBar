...
List<MListModel> getSavingPostList() {
  ...
  list.add(MListModel(
      ...
      authName: 'Thiranjaya Munasinghe',
      img: mCatAndroid,
      time: '5 min',
      date: '16 Aug 2018'));
  list.add(MListModel(
      title: 'Netflix\'s Keeper Test\'Is the secret to a SuccessFul Workforce',
      subtitle: 'Reed Hastings',
      img: mCatHealth,
      time: '11 min',
      date: '14 Jun 2019'));
  list.add(MListModel(
      title: 'The Psychology of Building An Audience',
      authName: 'Srinivas Rao',
      img: mCatProductivity,
      time: '32 min',
      date: '5 Oct'));
  list.add(MListModel(
      title: 'Flutter Widgets-- A brief guide',
      authName: 'Prakash Donga',
      img: mCatBusiness,
      time: '3 min',
      date: '14 Jun'));
  list.add(MListModel(
      title: 'Image Picker in Flutter',
      subtitle: 'Lemmecode',
      img: mCatArt,
      time: '4 min',
      date: '26 June'));
  list.add(MListModel(
      title: '7 Things you should Never Do in the moring',
      subtitle: 'Sinem Gunel',
      img: mCatScience,
      time: '8 min',
      date: '24 Sept'));
  list.add(MListModel(
      title: 'I Don\'t Know How To Pronounce My Last Name',
      authName: 'Meghan Daum',
      img: mCatAndroid,
      time: '11 min',
      date: '15 Jul'));
  list.add(MListModel(
      title: 'How This Designer Made \$100,000 in 6 Days',
      authName: 'John Garg',
      img: mCatIosDeveloper,
      time: '54 min',
      date: '7 Oct'));
  list.add(MListModel(
      title: 'Login Page UI in Flutter',
      authName: 'Yogita Kumar',
      img: mCatFeminism,
      time: '4 min',
      date: '22 Jan'));
  list.add(MListModel(
...
List<MPeopleModel> getPeopleFlutterList() {
  ...
  list.add(MPeopleModel(
      img: mCatWorld,
      title: 'Florina Muntenescu',
      subTitle:
          'Flutter Developer intern at Aeologics I Teach enthusiast ready to explore new technology'));
  list.add(MPeopleModel(
      img: mCatPsychological,
      title: 'BelDev',
      subTitle:
          'Flutter content weekly, Articles often correspond with video postings found on youtube.'));
  list.add(MPeopleModel(
      img: mCatMentalHealth,
      title: 'Dr.Smith',
      subTitle:
          'Google Developers Expert @Flutter,Mobile Developers, Public Speaker, Technical Blogger.'));
  return list;
}
...
List<MListModel> getAudioArticlesVerticalList() {
  ...
  list.add(MListModel(
      title: 'Login Page UI in Flutter',
      subtitle: "This is the flutter ui and really great",
      authName: 'Yogita Kumar',
      img: mCatFeminism,
      time: '4 min',
      date: '22 Jan'));
  list.add(MListModel(
      title: 'Flutter Widgets-- A brief guide',
      subtitle: "In the flutter everything is widget",
      authName: 'Prakash Donga',
      img: mCatPsychological,
      time: '3 min',
      date: '14 Jun'));
...
List<MStoriesModel> getStoriesList() {
  ...
  list.add(
      MStoriesModel(title: "Hello", isDraft: true, time: "Edited 15 min ago"));
  list.add(MStoriesModel(
      title: "Flutter is used to develop mobile app",
      isDraft: true,
      time: "Edited 10 min ago"));
  list.add(MStoriesModel(
      title: "Everything is a widget",
      isPublic: true,
      time: "Edited 5 min ago"));
  list.add(MStoriesModel(
      title: "Dart is programming language",
      isPublic: true,
      time: "Edited 2 min ago"));
  list.add(MStoriesModel(
      title: "Flutter is a language", isDraft: true, time: "Edited 1 min ago"));
  return list;
}
...
List<MStoriesModel> getProfileListData() {
  List<MStoriesModel> list = [];
  list.add(MStoriesModel(
      title: "Hello", userName: "John", time: "Edited 15 min ago"));
  list.add(MStoriesModel(
      title: "Dart is programming language",
      userName: "Jugal",
      time: "Edited 2 min ago"));
