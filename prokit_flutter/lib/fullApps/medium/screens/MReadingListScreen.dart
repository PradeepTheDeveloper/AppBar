...
import 'package:pradeep_the_developer/fullApps/medium/utils/MDataProvider.dart';
import 'package:pradeep_the_developer/fullApps/medium/utils/MWidget.dart';
...
class MReadingListScreenState extends State<MReadingListScreen>
    with TickerProviderStateMixin, AfterLayoutMixin<MReadingListScreen> {
          ...
          body: TabBarView(
            children: [
              Container(
                color: mGreyColor,
                child:
                    SingleChildScrollView(child: MCommonList(list: savingList)),
              ),
              Container(
                color: mGreyColor,
                child: SingleChildScrollView(
                    child: MCommonList(list: archivedList)),
              ),
              Container(
                color: mGreyColor,
                child:
                    SingleChildScrollView(child: MCommonList(list: recentList)),
              ),
              Container(
                color: mGreyColor,
                child: SingleChildScrollView(
                    child: MCommonList(list: highlightedList)),
              ),
            ],
          ),
        ),
...
class SavingDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SimpleDialog(
      ...
      title: Text('Saving and archiving the stories',
          ...
          children: [
            Row(
              ...
              children: [
                ...
                8.width,
                Text('The bookmark icon saves stories for future or offline or reading. Tap it once to save, and tap it again to un-save.',
            ...
            Row(
              ...
              children: [
                ...
                8.width,
                Text('The archive icon keeps stories for future reference',
                        style: primaryTextStyle(color: white, size: 14))
                    .expand(),
              ],
            ),
