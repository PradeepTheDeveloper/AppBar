...
import 'package:pradeep_the_developer/fullApps/medium/screens/MEditProfileScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MFollowersListScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MFollowingScreen.dart';
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: CircleAvatar(
                          backgroundImage: NetworkImage(mCatSoftware),
                          radius: 60)
                      .center(),
              ...
              SliverPersistentHeader(
                delegate: _SliverContainerDelegate(Container(
                  decoration: BoxDecoration(
                      border: Border(top: BorderSide(color: white, width: 0.2)),
                      color: black),
                  child: Row(
