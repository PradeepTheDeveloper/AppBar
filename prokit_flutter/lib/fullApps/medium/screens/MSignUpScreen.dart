...
import 'package:pradeep_the_developer/fullApps/medium/screens/MSelectTopicScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/utils/MColors.dart';
import 'package:pradeep_the_developer/fullApps/medium/utils/MConstants.dart';
...
class MSignUpScreenState extends State<MSignUpScreen> {
  ...
  Widget build(BuildContext context) {
    Widget commonButton(
      ...
      return Container(
        decoration:
            boxDecoration(color: white, radius: 5, bgColor: Colors.transparent),
              ...
              children: [
                ...
                createRichText(list: [
                  ...
                  TextSpan(
                      ...
                      style: boldTextStyle(size: 12, color: mLimeColor)),
