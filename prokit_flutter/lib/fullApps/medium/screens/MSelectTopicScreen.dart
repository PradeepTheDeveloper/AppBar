        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Text('Select at latest three topics to personalize your story stream.',
                  ...
                  Container(
                    ...
                    selectedIndex >= 3
                        ...
                        : toasty(context, "Please select at least 3 topic.");
                  })
                ],
              ),
              8.height,
                  ...
                  return Container(
                    decoration: boxDecoration(
                        color: data.isSelected
                            ...
                            : appDividerColor,
                        bgColor:
                            data.isSelected ? mLimeColor : Colors.transparent,
                        radius: 25),
                    margin: EdgeInsets.all(4),
                    padding: EdgeInsets.only(
                        top: 12, bottom: 12, left: 16, right: 16),
                    child: Text(data.topicName!,
