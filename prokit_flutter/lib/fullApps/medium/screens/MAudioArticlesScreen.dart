        ...
        actions: [
          Container(
            ...
            child: isFollow
                ...
                : OutlinedButton(
                    child:
                        Text("Follow", style: primaryTextStyle(color: white)),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(horizontalList[index].title!,
                                        style: boldTextStyle(
                                            color: white, size: 18))
                                    .expand(),
                                Text(horizontalList[index].authName!,
                                    style: primaryTextStyle(
                                        color: white, size: 14)),
                                Text(horizontalList[index].time!,
                                    style:
                                        boldTextStyle(color: grey, size: 12)),
                              ],
                            ),
                          ).cornerRadiusWithClipRRectOnly(
...
class AudioArticlesVerticalList extends StatefulWidget {
  ...
  @override
  _AudioArticlesVerticalListState createState() =>
      _AudioArticlesVerticalListState();
}
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(data.subtitle!,
                                overflow: TextOverflow.ellipsis,
                                style: primaryTextStyle(size: 16, color: grey)),
                          ],
                        ).expand(),
                        10.width,
                    ...
                    ListTile(
                      ...
                      title: Text(data.authName!,
                          style: primaryTextStyle(size: 14, color: white)),
                      subtitle: Row(
                        children: [
                          Text("${data.date} - ${data.time} read",
                              style: boldTextStyle(size: 12, color: grey)),
                          8.width,
