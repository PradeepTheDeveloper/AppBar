...
import 'package:pradeep_the_developer/fullApps/newsBlog/utils/NBColors.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    4.width,
                    commonSHCachedNetworkImage(widget.newsDetails!.image!,
                  ...
                  itemBuilder: (context, index) {
                    return Row(
                      ...
                      children: [
                        CircleAvatar(
                          backgroundImage:
                              AssetImage(commentList[index].image!),
                          radius: 30,
                        ),
                        16.width,
                        Column(
                          ...
                          children: [
                            Text('${commentList[index].name}',
                                style: boldTextStyle()),
                            4.height,
                            Text('${commentList[index].message}',
              ...
              children: [
                AppTextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    fillColor:
                        appStore.isDarkModeOn ? black : Colors.grey.shade200,
                  ),
