...
class NBFollowingScreenState extends State<NBFollowingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: nbAppBarWidget(context,
          title: widget.isFollowing ? 'Following' : 'Followers'),
        ...
        child: Column(
          children: [
            ...
            AppTextField(
              ...
              decoration: nbInputDecoration(context,
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    leading: CircleAvatar(
                      backgroundImage:
                          AssetImage('${followersList[index].image}'),
                      radius: 30,
                    ),
                    trailing: AppButton(
                    ...
                    title: Text('${followersList[index].name}',
                        style: boldTextStyle()),
                    subtitle: Text(
                        '${followersList[index].noOfArticle} Articles',
