              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(learner_lbl_achievements,
                      style: boldTextStyle(
                          color: learner_textColorPrimary, size: 24)),
                  16.height,
                  Container(
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        Text(learner_lbl_badges,
                                style: TextStyle(
                                    fontSize: 18.0, fontFamily: fontBold))
                            .paddingAll(8),
                        Text(learner_lbl_leader_board,
                                style: TextStyle(
                                    fontSize: 18.0, fontFamily: fontBold))
                            .paddingAll(8),
                      ],
        ...
        child: Row(
          children: <Widget>[
            Container(
              ...
              child: Padding(
                  padding: EdgeInsets.all(10.0), child: Image.asset(model.img)),
            ),
            8.width,
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                ...
                Text(model.comment,
                    style:
                        secondaryTextStyle(color: learner_textColorSecondary)),
              ],
            ).expand()
          ],
        ),
          ...
          children: <Widget>[
            Container(
              ...
              child: Padding(
                  ...
                  child: Icon(Icons.lock, color: learner_white)),
            ),
            16.width,
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
