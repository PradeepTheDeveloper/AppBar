...
import 'package:pradeep_the_developer/fullApps/learner/Screens/LearnerInstructorsDetails.dart';
...
import 'package:pradeep_the_developer/fullApps/learner/utils/LearnerConstant.dart';
      ...
      children: <Widget>[
        Container(
          decoration: boxDecoration(
              showShadow: true, bgColor: context.cardColor, radius: 0),
          ...
          child: Row(
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  Icon(Icons.search, color: learner_colorPrimary, size: 20)
                      .paddingSymmetric(horizontal: 8),
                  Text(learner_hint_search,
                      style:
                          primaryTextStyle(color: learner_textColorSecondary)),
                ],
              ),
              Row(
                children: <Widget>[
                  ...
                  Icon(Icons.close, color: learner_textColorSecondary, size: 20)
                      .paddingSymmetric(horizontal: 8),
                ],
              ),
            ],
