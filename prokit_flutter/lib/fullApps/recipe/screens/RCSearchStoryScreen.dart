...
import 'package:pradeep_the_developer/fullApps/recipe/screens/RCRecipeScreen.dart';
import 'package:pradeep_the_developer/fullApps/recipe/screens/RCVideoPlayerScreen.dart';
import 'package:pradeep_the_developer/fullApps/recipe/utils/RCBottomSheet.dart';
import 'package:pradeep_the_developer/fullApps/recipe/utils/RCClipperPaths.dart';
...
class _RCSearchStoryScreenState extends State<RCSearchStoryScreen> {
  ...
  void initState() {
    ...
    collectionList.add(RCCollectionModel(
        name: 'Cookbook',
        image: '$BaseUrl/images/recipe/strawberryCupcake.jpg',
        numberOfPosts: '15',
        selected: false));
    collectionList.add(RCCollectionModel(
        name: 'Ice Cream',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        ...
        children: [
          rcCommonCachedNetworkImage('$BaseUrl/images/recipe/panCake.jpg',
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  120.height,
                  Icon(Icons.play_circle, size: 100, color: Colors.white)
                      .onTap(() {
