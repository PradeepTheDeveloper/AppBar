...
import 'package:pradeep_the_developer/fullApps/recipe/screens/RcDashBoardScraan.dart';
                      ...
                      child: Column(
                        children: [
                          ...
                          rcCommonCachedNetworkImage(
                              '$BaseUrl/images/recipe/walkThroughImages/imageFour.png',
                              height: 70),
                          10.height,
                          Text('Beef',
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          rcCommonCachedNetworkImage(
                              '$BaseUrl/images/recipe/salad.png',
                              height: 70),
                          Text(
                            'Salad',
                            style: secondaryTextStyle(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          10.height,
                          rcCommonCachedNetworkImage(
                              '$BaseUrl/images/recipe/soup.png',
                              height: 70),
                          Text(
                            'Spring',
                            style: secondaryTextStyle(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          10.height,
                          rcCommonCachedNetworkImage(
                              '$BaseUrl/images/recipe/sushi.png',
                              height: 50),
                          Text(
                            'Sushi',
                            style: secondaryTextStyle(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          10.height,
                          rcCommonCachedNetworkImage(
                              '$BaseUrl/images/recipe/pizza.png',
                              height: 50),
                          Text(
                            'Pizza',
                            style: secondaryTextStyle(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          10.height,
                          rcCommonCachedNetworkImage(
                              '$BaseUrl/images/recipe/walkThroughImages/imageFive.png',
                              height: 70),
                          Text(
                            'Noodles',
                            style: secondaryTextStyle(
