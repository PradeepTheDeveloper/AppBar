...
import 'package:pradeep_the_developer/widgets/materialWidgets/mwDialogAlertPanelWidgets/MWExpansionPannelWidgets/component/MWExpansionPanel7ComponentWidget.dart';

class MWExpansionPanelScreen7 extends StatefulWidget {
  const MWExpansionPanelScreen7({Key? key}) : super(key: key);

  @override
  _MWExpansionPanelScreen7State createState() =>
      _MWExpansionPanelScreen7State();
}
      ...
      body: Theme(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return MWExpansionPanel7ComponentWidget()
