...
class MWExpansionPanel7ComponentWidget extends StatefulWidget {
  ...
  @override
  _MWExpansionPanel7ComponentWidgetState createState() =>
      _MWExpansionPanel7ComponentWidgetState();
}

class _MWExpansionPanel7ComponentWidgetState
    extends State<MWExpansionPanel7ComponentWidget> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ClipRRect(
          borderRadius:
              isExpanded ? radiusOnly(topRight: 16, topLeft: 16) : radius(16),
          child: Image.asset(
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    16.height,
                    Text('Find the information you need',
                        style: primaryTextStyle(
                            color: Colors.white,
                            weight: FontWeight.w500,
                            size: 20)),
                    4.height,
                    Text('With little help fro  google',
            ...
            Container(
              decoration: BoxDecoration(
                ...
                boxShadow: defaultBoxShadow(
                    blurRadius: 0, spreadRadius: 0, shadowColor: Colors.black),
              ),
