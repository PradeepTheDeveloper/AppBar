...
import 'package:pradeep_the_developer/widgets/materialWidgets/mwDialogAlertPanelWidgets/MWExpansionPannelWidgets/component/MWExpansionPanel6ComponentWidget.dart';

class MWExpansionPanelScreen6 extends StatefulWidget {
  const MWExpansionPanelScreen6({Key? key}) : super(key: key);

  @override
  _MWExpansionPanelScreen6State createState() =>
      _MWExpansionPanelScreen6State();
}
