...
class MWProgressBarScreenState extends State<MWProgressBarScreen>
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              16.height,
              Divider(thickness: 1),
              Text("Linear Progress with corner",
                      style: boldTextStyle(color: appStore.textPrimaryColor))
                  .paddingOnly(left: 16, top: 16),
              Container(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration:
                      boxDecoration(bgColor: Colors.blueGrey, radius: 10),
                  padding: EdgeInsets.fromLTRB(16, 8, 16, 8),
                  child: Text("Circular Progress in Dialog 1",
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration:
                      boxDecoration(bgColor: Colors.blueGrey, radius: 10),
                  padding: EdgeInsets.fromLTRB(16, 8, 16, 8),
                  child: Text("Circular Progress in Dialog 2",
                      style: primaryTextStyle(color: Colors.white)),
                ),
              ),
            ],
