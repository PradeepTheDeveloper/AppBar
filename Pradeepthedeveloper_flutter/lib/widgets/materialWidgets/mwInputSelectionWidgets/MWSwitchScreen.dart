                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          child: FittedBox(
                              child: Text('Custom Image with Custom Color',
                            ...
                            Transform.scale(
                              ...
                              child: Switch(
                                inactiveThumbImage: Image.asset(
                                        'images/widgets/materialWidgets/mwInputSelectionWidgets/switch/moon.png')
                                    .image,
                                inactiveThumbColor: Colors.transparent,
                                inactiveTrackColor: Color(0xFF848B9B),
                                activeThumbImage: Image.asset(
                                        'images/widgets/materialWidgets/mwInputSelectionWidgets/switch/sun.png')
                                    .image,
                                hoverColor: Colors.red,
                                value: isSwitched,
                                onChanged: (value) {
