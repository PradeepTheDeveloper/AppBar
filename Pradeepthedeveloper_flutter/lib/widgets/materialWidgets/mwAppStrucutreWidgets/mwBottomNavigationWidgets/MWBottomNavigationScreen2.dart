...
class MWBottomNavigationScreen2 extends StatefulWidget {
  ...
  @override
  MWBottomNavigationScreen2State createState() =>
      MWBottomNavigationScreen2State();
}
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                bulletText(
                    'This example consists of only icons selected items changes it colors.'),
                5.height,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Image.asset(
                'images/widgets/materialWidgets/mwAppStructureWidgets/BottomNavigation/ic_home.png',
                height: 25,
                width: 25,
