...
class MWBottomNavigationScreen6 extends StatefulWidget {
  ...
  @override
  _MWBottomNavigationScreen6State createState() =>
      _MWBottomNavigationScreen6State();
}
                  ...
                  return Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            selectedIndex == index ? data.title.validate() : "",
                            style: boldTextStyle(color: data.colors, size: 14)),
                      ],
                    ),
                  ).onTap(() {
                    selectedIndex = index;
