...
import 'package:pradeep_the_developer/main/model/SampleListModel.dart';
  ...
  void initState() {
    ...
    getData.add(
      SampleListModel(
        ...
        icon: Icons.payment,
        launchWidget:
            Text("Payment View", style: boldTextStyle(size: 24)).center(),
      ),
    );
    getData.add(
      SampleListModel(
        ...
        launchWidget:
            Text("Promo View", style: boldTextStyle(size: 24)).center(),
      ),
    );
    getData.add(
      SampleListModel(
    ...
    getData.add(
      SampleListModel(
        ...
        launchWidget:
            Text("Help View", style: boldTextStyle(size: 24)).center(),
      ),
    );
    getData.add(
      SampleListModel(
        ...
        launchWidget:
            Text("About Us View", style: boldTextStyle(size: 24)).center(),
      ),
    );
    getData.add(
      SampleListModel(
        ...
        launchWidget:
            Text("Rate Us View", style: boldTextStyle(size: 24)).center(),
      ),
    );
    init();
  }
