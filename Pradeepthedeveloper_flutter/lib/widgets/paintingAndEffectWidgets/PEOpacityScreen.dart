    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Text('Opacity with different opacity value', style: boldTextStyle())
                .paddingBottom(20),
            Row(
                  ...
                  child: Opacity(
                    ...
                    child: FadeInImage(
                        ...
                        placeholder: Image.asset(
                                'images/widgets/paintingAndEffectWidgets/opacity/opactiy1.png')
                            .image,
                        image: Image.asset(
                                'images/widgets/paintingAndEffectWidgets/opacity/opactiy1.png')
                            .image),
            ...
            20.height,
            Text('Opacity with ColorFilter', style: boldTextStyle())
                .paddingBottom(20),
            Container(
              height: 200,
              width: context.width(),
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: CachedNetworkImageProvider(
                          'https://i.picsum.photos/id/772/200/300.jpg?hmac=jap7uDpPOJZv41ksTZ3pa9FnXwuaBUpnni4hYBjZtfM'))),
            ...
            20.height,
            Text('Opacity with ColorFilter saturation mode',
                    style: boldTextStyle())
                .paddingBottom(20),
            Row(
