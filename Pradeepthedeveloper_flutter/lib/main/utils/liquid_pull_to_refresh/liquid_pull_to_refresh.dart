...
import 'package:pradeep_the_developer/main/utils/liquid_pull_to_refresh/src/circular_progress.dart';
import 'package:pradeep_the_developer/main/utils/liquid_pull_to_refresh/src/clipper.dart';
    ...
    switch (_mode) {
      ...
      case _LiquidPullToRefreshMode.canceled:
        await _positionController!
            .animateTo(0.0, duration: _kIndicatorScaleDuration);
        break;
      default:
        assert(false);
    }
        ...
        AnimatedBuilder(
          ...
          builder: (BuildContext buildContext, Widget? child) {
            ...
            return Transform.translate(
              offset:
                  new Offset(0.0, _positionController!.value * height! * 1.5),
              child: child,
            );
          },
        ),
