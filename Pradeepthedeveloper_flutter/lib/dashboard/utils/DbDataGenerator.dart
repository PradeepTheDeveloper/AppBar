...
import 'package:pradeep_the_developer/dashboard/model/db1/Db1Model.dart';
import 'package:pradeep_the_developer/dashboard/model/db2/Db2Model.dart';
import 'package:pradeep_the_developer/dashboard/model/db3/Db3Model.dart';
import 'package:pradeep_the_developer/dashboard/model/db4/Db4Model.dart';
import 'package:pradeep_the_developer/dashboard/model/db5/Db5Model.dart';
...
import 'package:pradeep_the_developer/dashboard/model/db8/Db8Model.dart';
...
List<DB7Topic> getDB7TodayData() {
  List<DB7Topic> data = [];
  data.add(DB7Topic("Participation in Extracurricular Activities", db7_item4,
      "Civil Hospital", 200, 20));
  data.add(DB7Topic("Depression", db7_item5, "Orange Hospital", 200, 20));
  data.add(
      DB7Topic("illnesses", db7_item3, "Fudan University Hospital", 200, 20));
  data.add(DB7Topic("Participation in Extracurricular Activities", db7_item2,
      "Parsi Hospital", 200, 20));
  return data;
}
