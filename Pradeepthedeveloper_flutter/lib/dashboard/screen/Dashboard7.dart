...
import 'package:pradeep_the_developer/dashboard/model/db7/Db7Model.dart';
import 'package:pradeep_the_developer/dashboard/utils/Db7BottomNavigationBar.dart';
...
class Dashboard7State extends State<Dashboard7> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget mOption(
        var icon, var value, var subValue, var iconColor, var bgColor) {
      return Row(
        children: <Widget>[
          Container(
            ...
            child: SvgPicture.asset(icon,
                width: width * 0.05, height: width * 0.05, color: iconColor),
          ),
          SizedBox(width: 8),
          Column(
            ...
            children: <Widget>[
              ...
              Text(subValue,
                  style: primaryTextStyle(
                      color: db7_textColorSecondary, size: 12)),
            ],
          )
        ],
      );
      ...
      bottomNavigationBar: Container(
        ...
        child: Db7BottomNavigationBar(
          items: <Db7BottomNavigationBarItem>[
            ...
            Db7BottomNavigationBarItem(
                icon: db7_ic_user,
                title: Text("My", style: TextStyle(fontSize: 16))),
          ],
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Icon(Icons.search,
                          color: db7_textColorSecondary, size: 24),
                    ],
                  ),
                ),
                Container(
        ...
        children: <Widget>[
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(model.topicName,
                    style: primaryTextStyle(fontFamily: 'Medium')),
                Text(model.topicInfo,
                    style: primaryTextStyle(color: db7_textColorSecondary)),
                SizedBox(height: 8),
                Row(
                  children: <Widget>[
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                              text: model.topicLike.toString(),
                              style: primaryTextStyle(
                                  size: 16, color: db7_textColorSecondary)),
                          WidgetSpan(
                            child: Padding(
                                padding: EdgeInsets.only(left: 8),
                                child: SvgPicture.asset(db7_ic_like,
                                    height: 20,
                                    width: 20,
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                              text: model.topicCount.toString(),
                              style: primaryTextStyle(
                                  size: 16, color: db7_textColorSecondary)),
                          WidgetSpan(
                            child: Padding(
                                padding: EdgeInsets.only(left: 8),
                                child: SvgPicture.asset(db7_ic_document,
                                    height: 20,
                                    width: 20,
                                    color: db7_textColorSecondary)),
                          ),
          ...
          Expanded(
            ...
            child: ClipRRect(
              ...
              child: Image.asset(model.topicImg,
                  width: width * 0.2, height: width * 0.2, fit: BoxFit.fill),
            ),
          )
        ],
      ),
