...
import 'package:pradeep_the_developer/dashboard/utils/Db4BubbleBotoomBar.dart';
import 'package:pradeep_the_developer/dashboard/utils/Db4SliderWidget.dart';
              ...
              child: Row(
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      CircleAvatar(
                          backgroundImage: AssetImage(db_profile), radius: 25),
                      SizedBox(width: 16),
                      Text(db4_username,
                          style: primaryTextStyle(
                              color: white, size: 20, fontFamily: fontMedium))
                    ],
                  ),
                  SvgPicture.asset(db4_options,
                ...
                children: <Widget>[
                  ...
                  Padding(
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(db4_avl_balance,
                              style: primaryTextStyle(color: white, size: 16)),
                          Text(slider.balance,
                              style: boldTextStyle(
                                  color: white, size: 24, fontFamily: 'Bold'))
                        ],
                      ),
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text(db4_account_number,
                                  style:
                                      primaryTextStyle(color: white, size: 16)),
