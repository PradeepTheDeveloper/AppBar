...
import 'package:pradeep_the_developer/dashboard/model/db6/Db6Model.dart';
import 'package:pradeep_the_developer/dashboard/utils/Db6BottomNavigationBar.dart';
import 'package:pradeep_the_developer/dashboard/utils/DbColors.dart';
import 'package:pradeep_the_developer/dashboard/utils/DbDataGenerator.dart';
import 'package:pradeep_the_developer/dashboard/utils/DbImages.dart';
import 'package:pradeep_the_developer/dashboard/utils/DbStrings.dart';
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(text,
              style: TextStyle(
                  fontSize: 18, color: db6_black, fontFamily: fontMedium)),
        ...
        child: Db6BottomNavigationBar(
          items: <Db6BottomNavigationBarItem>[
            Db6BottomNavigationBarItem(
                icon: db6_ic_home,
                title: Text(db6_lbl_home,
                    style: TextStyle(color: db6_textColorSecondary))),
            Db6BottomNavigationBarItem(
                icon: db6_ic_pin,
                title: Text(db6_lbl_nearby,
                    style: TextStyle(color: db6_textColorSecondary))),
            Db6BottomNavigationBarItem(
                icon: db6_ic_basket,
                title: Text(db6_lbl_booking,
                    style: TextStyle(color: db6_textColorSecondary))),
            Db6BottomNavigationBarItem(
                icon: db6_ic_sale,
                title: Text(db6_lbl_Offers,
                    style: TextStyle(color: db6_textColorSecondary))),
            Db6BottomNavigationBarItem(
                icon: db6_ic_user,
                title: Text(db6_lbl_profile,
                    style: TextStyle(color: db6_textColorSecondary))),
          ],
          currentIndex: _selectedIndex,
          unselectedIconTheme:
              IconThemeData(color: db6_textColorSecondary, size: 24),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(db6_your_location,
                            style: primaryTextStyle(color: db6_white)),
                      ),
                      Padding(
        ...
        children: <Widget>[
          Container(
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: dbShadowColor, blurRadius: 10, spreadRadius: 2)
                ]),
            width: width * 0.2,
            height: width * 0.2,
          ...
          SizedBox(height: 6),
          Text(model.name,
              style: primaryTextStyle(color: db1_textColorSecondary))
        ],
      ),
    );
  }
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                            ...
                            WidgetSpan(
                              child: Padding(
                                ...
                                child: Icon(Icons.star_border,
                                    color: db6_yellow, size: 16),
                              ),
                            ),
                            TextSpan(
                                text: model.rating,
                                style: primaryTextStyle(
                                    size: 16, color: db6_textColorSecondary)),
                          ],
                        ),
                      )
                    ],
                  ...
                  Text(model.location,
                      style: primaryTextStyle(color: db6_textColorSecondary)),
                ],
              ),
            ),
          ],
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  child: Container(
                      ...
                      child: Text(db6_lbl_view_offers.toUpperCase(),
                          style: primaryTextStyle(
                              color: db6_white, fontFamily: 'Medium')),
                      decoration: BoxDecoration(
                          color: db6_colorPrimary,
