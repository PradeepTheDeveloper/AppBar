          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: boxDecoration(
                  bgColor: mSelection == index ? db8_colorPrimary : db8_white,
                  radius: 10),
              ...
              child: Column(
                ...
                children: <Widget>[
                  SvgPicture.asset(mList1[index].img,
                      width: width * 0.09,
                      height: width * 0.09,
                      color: mSelection == index
                          ? db8_white
                          : db8_textColorPrimary),
                  SizedBox(height: 4),
                  text(mList1[index].name,
                      textColor: mSelection == index
                          ? db8_white
                          : db8_textColorPrimary)
                ],
              ),
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Column(
                        children: <Widget>[
                          SvgPicture.asset(db8_ic_storm,
                              color: db8_white, width: 22, height: 22),
                      ...
                      Column(
                        children: <Widget>[
                          text(db8_lbl_19_c,
                              textColor: db8_white, fontSize: 18.0),
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Expanded(
                              child: mOption(db8_ic_plug, db8_lbl_29_5_kwh,
                                  db8_lbl_power_usage_today),
                              flex: 1),
                          SizedBox(width: 8),
                          Expanded(
                              child: mOption(db8_ic_power, db8_lbl_303_kwh,
                                  db8_lbl_power_usage_month),
                              flex: 1)
                        ],
                      ),
                    ),
