...
class ChoosePlanScreen5State extends State<ChoosePlanScreen5> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: appBarWidget('Pricing plan 5',
              ...
              child: Column(
                ...
                children: [
                          ...
                          Row(
                            children: [
                              ...
                              Icon(
                                ...
                                color: isMyPageIndex
                                    ? white
                                    : planPageViewList[index].iconColor,
                              ),
                            ],
                          ),
                          8.height,
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(planPageViewList[index].price.validate(),
                          style: boldTextStyle(
                              size: 32,
                              color: isMyPageIndex
                                  ? white
                  ...
                  Align(
                    ...
                    child: AppButton(
                      ...
                      child: TextIcon(
                        prefix: isMyPageIndex
                            ? Icon(Icons.check, color: Colors.white, size: 16)
                            : null,
                        text: isMyPageIndex ? 'Choose' : 'Choose',
                        textStyle: primaryTextStyle(
                            size: 16,
                            color: isMyPageIndex ? Colors.white : white),
                      ),
                      onTap: () {
                        setState(() {});
                        selectIndex = index;
