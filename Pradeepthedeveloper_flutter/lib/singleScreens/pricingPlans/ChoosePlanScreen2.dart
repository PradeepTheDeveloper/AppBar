                ...
                children: List.generate(subscriptionList.length, (index) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(subscriptionList[index].title.validate(),
                            style: boldTextStyle(
                                size: 24, color: value ? color : null)),
                        Text(subscriptionList[index].subTitle.validate(),
              ...
              Container(
                ...
                child: UL(
                  ...
                  children: List.generate(
                      subscriptionList[selectIndex].optionList!.length,
                      (index) {
                    return Text(
                        subscriptionList[selectIndex]
                            .optionList![index]
                            .title
                            .validate(),
