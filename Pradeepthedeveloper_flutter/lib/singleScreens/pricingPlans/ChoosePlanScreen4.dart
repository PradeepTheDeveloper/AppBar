                  ...
                  itemBuilder: (_, int index) {
                    return Container(
                      decoration: boxDecorationDefault(
                          color: planModalList[index].containerColor,
                          borderRadius: radius(defaultRadius)),
                        ...
                        children: <Widget>[
                          Container(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(planModalList[index].title.validate(),
                                    style:
                                        boldTextStyle(size: 16, color: white)),
                                4.height,
                                Text(planModalList[index].subTitle.validate(),
                                    style: primaryTextStyle(
                                        size: 14, color: Colors.white)),
                                16.height,
                                Row(
                                  children: [
                                    Text(planModalList[index].price.validate(),
                                        style: boldTextStyle(
                                            size: 16, color: white)),
                                    8.width,
                                    Text(
                      ...
                      snackBar(
                        context,
                        title:
                            "Register as ${planModalList[index].title.validate()}",
                        backgroundColor: appColorPrimary,
                        snackBarAction: SnackBarAction(
                          label: 'Buy',
                          disabledTextColor: appStore.isDarkModeOn
                              ? Colors.black
                              : Colors.white,
