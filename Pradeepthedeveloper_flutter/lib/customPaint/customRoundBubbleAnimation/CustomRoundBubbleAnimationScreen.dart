...
import 'package:pradeep_the_developer/customPaint/customRoundBubbleAnimation/CurvedCustomPaint.dart';
import 'package:pradeep_the_developer/main.dart';

class CustomRoundBubbleAnimationScreen extends StatefulWidget {
  @override
  CustomRoundBubbleAnimationScreenState createState() =>
      CustomRoundBubbleAnimationScreenState();
}

class CustomRoundBubbleAnimationScreenState
    extends State<CustomRoundBubbleAnimationScreen> {
  double width = 550;
  double height = 550;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget('Curved painter',
