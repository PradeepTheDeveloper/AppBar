...
import 'package:pradeep_the_developer/customPaint/customTemperatureWidget/ButtonTempratureWidget.dart';
import 'package:pradeep_the_developer/customPaint/customTemperatureWidget/SemiCircleWidget.dart';
import 'package:pradeep_the_developer/customPaint/customTemperatureWidget/TemperatureWidget.dart';
import 'package:pradeep_the_developer/customPaint/customTemperatureWidget/modal/view_modal.dart';
    ...
    return ChangeNotifierProvider<ViewModel>(
      ...
      child: Consumer<ViewModel>(
        builder: (context, provider, child) {
          return Scaffold(
            appBar: appBarWidget('Temperature',
                  ...
                  Row(
                    ...
                    children: [
                      ButtonTemperatureType(
                          iconData: Icons.watch_later_outlined, status: false),
                      8.width,
                      ButtonTemperatureType(
                          iconData: Icons.ac_unit, status: true),
                      8.width,
                      ButtonTemperatureType(
                          iconData: Icons.wb_sunny, status: false),
                      8.width,
                      ButtonTemperatureType(
                          iconData: Icons.tv_outlined, status: false),
                    ],
