...
import 'package:pradeep_the_developer/customPaint/clock/ClockCustomPainter.dart';
...
class _ClockCustomPaintScreenState extends State<ClockCustomPaintScreen> {
  ...
  List<Color> _hoursAndMinuteLineColor = [
    Colors.purple,
    Colors.red,
    Colors.blue,
    Colors.green,
                ...
                children: List.generate(dialColor.length, (index) {
                  ...
                  return AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        color: dialColor[index],
                        borderRadius: radius(),
                        boxShadow: defaultBoxShadow()),
                    child: isSelected
                        ? Icon(Icons.done, color: context.iconColor)
                        : Offstage(),
                  ).onTap(() {
                    selectedIndex = index;
                  });
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 16,
                children:
                    List.generate(_hoursAndMinuteLineColor.length, (index) {
                  ...
                  return AnimatedContainer(
                    ...
                    height: 40,
                    decoration: BoxDecoration(
                        color: _hoursAndMinuteLineColor[index],
                        borderRadius: radius(),
                        boxShadow: defaultBoxShadow()),
                    child: isSelected
                        ? Icon(Icons.done, color: context.iconColor)
              ...
              Row(
                children: [
                  SliderTheme(
                    data: SliderThemeData(
                      thumbColor:
                          _hoursAndMinuteLineColor[hoursAndMinuteLineIndex],
                      activeTrackColor: appColorPrimary,
                      inactiveTrackColor: context.accentColor.withOpacity(0.4),
                    ),
                    child: Slider(
  ...
  Widget body() {
    return Column(
      ...
      children: [
        16.height,
        Text('Customization', style: boldTextStyle(size: 24))
