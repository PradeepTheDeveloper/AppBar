...
import 'package:pradeep_the_developer/customPaint/customLoader/CustomLoaderPainter.dart';
...
class CustomLoaderScreenState extends State<CustomLoaderScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          appBarWidget('Custom Loader', color: context.scaffoldBackgroundColor),
      body: Container(
        child: Stack(
          children: <Widget>[
