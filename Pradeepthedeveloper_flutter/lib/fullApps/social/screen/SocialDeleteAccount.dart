      ...
      return Row(
        children: <Widget>[
          Container(
            ...
            width: 8,
            decoration:
                BoxDecoration(shape: BoxShape.circle, color: social_view_color),
          ),
          SizedBox(width: spacing_standard),
          Expanded(
            child: text(value,
                textColor: social_textColorSecondary, isLongText: false),
          )
        ],
      );
    }
                    ...
                    children: <Widget>[
                                  ...
                                  WidgetSpan(
                                    child: Padding(
                                      ...
                                      child: Icon(Icons.warning,
                                          color: social_form_google, size: 18),
                                    ),
                                  ),
                                  TextSpan(
                                      text:
                                          social_lbl_deleting_your_account_will,
                                      style: TextStyle(
                            ...
                            RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                      text:
                                          social_lbl_change_phone_number_instead,
                                      style: TextStyle(
                                          fontSize: textSizeMedium,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            text(
                                social_lbl_to_delete_your_account_confirm_your_country_code_and_enter_your_phone_number,
                                isLongText: true,
                            ...
                            Container(
                              ...
                              decoration: boxDecoration(
                                  showShadow: false, color: social_view_color),
                            ...
                            Container(
                              width: MediaQuery.of(context).size.width,
                              padding: EdgeInsets.fromLTRB(
                                  spacing_standard, 16, spacing_standard, 16),
                              decoration: boxDecoration(
                                  showShadow: false, color: social_view_color),
                              child: RichText(
                                text: TextSpan(
                      ...
                      Container(
                        ...
                        decoration: boxDecoration(
                            ...
                            radius: 8),
                        child: text(social_lbl_delete_account,
                            textColor: social_white, isCentered: true),
                      )
                    ],
                  ),
                ),
