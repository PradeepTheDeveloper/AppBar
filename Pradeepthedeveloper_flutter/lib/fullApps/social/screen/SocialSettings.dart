...
import 'package:pradeep_the_developer/fullApps/social/screen/SocialProfile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: <Widget>[
            mToolbar(context, social_lbl_settings, social_ic_logout,
                onTap: () {}),
            Expanded(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            SocialOption(
                                ...
                                social_lbl_notification_info, onTap: () {
