...
import 'package:pradeep_the_developer/fullApps/social/screen/SocialHomeCalls.dart';
import 'package:pradeep_the_developer/fullApps/social/screen/SocialStatus.dart';
          ...
          floatingActionButton: selectedPos == 2
              ? Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Image.asset(social_fab_edit,
                          width: width * 0.2, height: width * 0.2),
                      Image.asset(social_fab_msg,
                          width: width * 0.2, height: width * 0.2),
                    ],
                  ),
                )
