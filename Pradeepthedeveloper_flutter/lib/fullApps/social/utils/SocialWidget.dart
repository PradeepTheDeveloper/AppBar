...
Widget SocialOption(
    BuildContext context, var color, var icon, var value, var subValue,
    {Function? onTap}) {
      ...
      children: <Widget>[
        Container(
          decoration: boxDecoration(
              showShadow: false, radius: spacing_middle, bgColor: color),
          width: width * 0.13,
          height: width * 0.13,
...
Widget mToolbar(BuildContext context, var title, var icon,
