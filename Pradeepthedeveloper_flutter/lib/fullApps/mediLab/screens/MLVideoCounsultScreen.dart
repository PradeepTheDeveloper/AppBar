...
import 'package:pradeep_the_developer/fullApps/mediLab/components/MLOnCallComponent.dart';
          ...
          Container(
            decoration: boxDecorationWithRoundedCorners(
              ...
              decorationImage: DecorationImage(
                  image: AssetImage(ml_ic_video_consult!), fit: BoxFit.cover),
            ),
              ...
              children: [
                Column(
                  children: [
                    MaterialButton(
                      child:
                          Image.asset(ml_ic_end_call!, width: 50, height: 50),
                      onPressed: () {
                        setState(
                          () {
                            currentWidget++;
                ...
                Column(
                  children: [
                    MaterialButton(
                      child: Image.asset(ml_ic_receive_call!,
                          width: 50, height: 50),
                      onPressed: () {
                        setState(
                          () {
