...
import 'package:pradeep_the_developer/fullApps/mediLab/components/MLCheckOutComponent.dart';
import 'package:pradeep_the_developer/fullApps/mediLab/components/MLShoppingCartComponent.dart';
                            ...
                            Row(
                              children: [
                                Text('Address Shipping', style: boldTextStyle())
                                    .expand(),
                                Text('Change',
                                    style: boldTextStyle(color: mlColorBlue)),
                              ],
                            ),
                            8.height,
                            Row(
