...
import 'package:pradeep_the_developer/fullApps/mediLab/components/MLCategoryComponent.dart';
import 'package:pradeep_the_developer/fullApps/mediLab/components/MLCategoryProductComponent.dart';
                  ...
                  children: [
                    Text('Online Pharmacy ',
                        style: secondaryTextStyle(
                            size: 12, color: white.withOpacity(0.4))),
                    (widget.index == 0)
                        ? Text(
                            '> Prescription Drug',
                            style: secondaryTextStyle(
