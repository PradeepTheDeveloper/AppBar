...
import 'package:pradeep_the_developer/fullApps/mediLab/screens/MLOnlinePharmacyDetailScreen.dart';
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(mlView_all!,
                  style: secondaryTextStyle(color: mlColorBlue, size: 16)),
              4.width,
          ...
          HorizontalList(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Column(
                  children: [
                    commonCachedNetworkImage((listTwo[index].image).validate(),
