...
class MLMedicineInformationComponent extends StatefulWidget {
  ...
  @override
  MLMedicineInformationComponentState createState() =>
      MLMedicineInformationComponentState();
}

class MLMedicineInformationComponentState
    extends State<MLMedicineInformationComponent> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Image.asset(ml_ic_mediTwo!, height: 75, width: 75, fit: BoxFit.cover)
            ...
            itemBuilder: (BuildContext context, int index) {
              return Container(
                ...
                decoration: boxDecorationWithRoundedCorners(
                    backgroundColor: mlColorBlue, borderRadius: radius(12.0)),
                child: Text(
                  (time[index]).validate(),
