...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/screens/JCBBookRideScreen.dart';
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                16.height,
                Text('Please select a valid destination location on the map',
                    style: secondaryTextStyle(color: context.iconColor)),
                16.height,
                AppButton(
                  width: context.width() - 32,
                  child: Text('Set destination'.toUpperCase(),
