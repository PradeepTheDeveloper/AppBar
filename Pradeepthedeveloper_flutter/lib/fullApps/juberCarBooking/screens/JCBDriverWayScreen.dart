...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/screens/JCBRatingScreen.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              8.height,
              Text('\$25.50',
                  style: boldTextStyle(color: jcbPrimaryColor, size: 40)),
              8.height,
              Text('inc. tax',
                  style: secondaryTextStyle(color: jcbSecBorderColor)),
              16.height,
              Divider(),
              16.height,
              Row(
                  ...
                  Column(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Pick-up'.toUpperCase(),
                              style: secondaryTextStyle(
                                  color: jcbSecBorderColor, size: 10)),
                          Text('199 Brown Estate Apt.866',
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('destination #1'.toUpperCase(),
                              style: secondaryTextStyle(
                                  color: jcbSecBorderColor, size: 10)),
                          Text('199 Brown Estate Apt.866',
                              style: boldTextStyle(size: 14)),
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('destination #2'.toUpperCase(),
                              style: secondaryTextStyle(
                                  color: jcbSecBorderColor, size: 10)),
                          Text('199 Brown Estate Apt.866',
                              style: boldTextStyle(size: 14)),
