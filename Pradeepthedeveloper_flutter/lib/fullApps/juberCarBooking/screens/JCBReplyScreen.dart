      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text('ST3571 - Toyoto Vios',
                style: secondaryTextStyle(color: jcbGreyColor, size: 10)),
          ],
        ),
        centerTitle: true,
        actions: [
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text('Hello, are you nearby?',
                  ...
                  Align(
                    ...
                    child: Container(
                      padding: EdgeInsets.all(16),
                      decoration: BoxDecoration(
                          color: jcbGreyColor.withAlpha(30),
                          borderRadius: radius(jcbBottomSheetRadius)),
                      child: Text('I\'ll be there in few minutes',
                          style: boldTextStyle()),
                    ),
                  ),
                  16.height,
                  Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: jcbPrimaryColor,
                          borderRadius: radius(jcbBottomSheetRadius)),
                      child: Text('OK, I am in front of bus stop',
                          style: boldTextStyle(color: Colors.white)),
                    ),
                  ),
                  16.height,
