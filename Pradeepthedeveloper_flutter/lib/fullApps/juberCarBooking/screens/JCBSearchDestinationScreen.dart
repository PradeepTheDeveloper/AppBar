...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/components/JCBDestinationWidget.dart';
...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/screens/JCBFavouriteScreen.dart';
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                return JCBDestinationWidget(destination: destinationList[index])
                    .onTap(
                  () {
                    JCBChooseDestinationScreen(
                            destination: destinationList[index].name)
                        .launch(context);
                  },
                  splashColor: Colors.transparent,
                  highlightColor: Colors.transparent,
