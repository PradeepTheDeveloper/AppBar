...
import 'package:pradeep_the_developer/fullApps/juberCarBooking/components/JCBPaymentCard.dart';
import 'package:pradeep_the_developer/fullApps/juberCarBooking/models/JCBCommonModel.dart';
import 'package:pradeep_the_developer/fullApps/juberCarBooking/screens/JCBAddPaymentCardScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Text('Done', style: boldTextStyle(color: jcbPrimaryColor))
              .paddingAll(16)
              .onTap(() {
            finish(context);
            finish(context);
        ...
        child: Column(
          ...
          children: [
            ...
            AppButton(
              ...
              child: Text('add payment method'.toUpperCase(),
