...
class NBAudioNewsDetailsScreen extends StatefulWidget {
  ...
  @override
  NBAudioNewsDetailsScreenState createState() =>
      NBAudioNewsDetailsScreenState();
}
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            16.height,
            commonCacheImageWidget(widget.audioDetails!.image, 200,
                    width: context.width(), fit: BoxFit.cover)
                .cornerRadiusWithClipRRect(16),
            16.height,
            Text('${widget.audioDetails!.title}',
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: IconButton(
                      icon: Icon(Icons.pause), onPressed: () {}, color: white),
                ),
            ...
            8.height,
            Text('${widget.audioDetails!.details}',
