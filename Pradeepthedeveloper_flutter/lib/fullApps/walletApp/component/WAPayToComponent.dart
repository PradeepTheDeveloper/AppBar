...
import 'package:pradeep_the_developer/fullApps/walletApp/component/WAPaymentCompeteDialog.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/component/WASendViaComponent.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/model/WalletAppModel.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/utils/WAColors.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/utils/WADataGenerator.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/utils/WAWidgets.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/utils/widgets/slider.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          16.height,
          Text("Subscriber's Name", style: boldTextStyle(size: 18))
              .paddingLeft(16),
          16.height,
          AppTextField(
            autoFocus: false,
          ...
          Text("Subscriber's Phone Number", style: boldTextStyle(size: 18))
              .paddingLeft(16),
          16.height,
          AppTextField(
            autoFocus: false,
            decoration: waInputDecoration(
                hint: "Enter your phone No. here",
                bgColor: context.cardColor,
                borderColor: Colors.grey),
