...
import 'package:pradeep_the_developer/fullApps/walletApp/screen/WABillPayScreen.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/screen/WACreditCardScreen.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/screen/WASendMoneyViaLoopScreen.dart';
import 'package:pradeep_the_developer/fullApps/walletApp/screen/WAVoucherScreen.dart';
...
List<WABillPayModel> waSelectBillList() {
  ...
  list.add(WABillPayModel(
      ...
      image: '$BaseUrl/images/walletApp/wa_bank_of_america.png'));
  list.add(WABillPayModel(
      title: 'Yes Bank', image: '$BaseUrl/images/walletApp/wa_yes_bank.png'));
  return list;
}
