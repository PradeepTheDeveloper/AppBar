...
import 'package:pradeep_the_developer/fullApps/evSpot/screens/add_check_in_screen.dart';
import 'package:pradeep_the_developer/fullApps/evSpot/screens/home_screen.dart';
...
class _EVStationInfoScreenState extends State<EVStationInfoScreen> {
  final connectionTypeImg = [
    conn_type_img_first,
    conn_type_img_second,
    conn_type_img_first,
    conn_type_img_second
  ];
          ...
          children: [
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Image.asset(
                    widget.modelObj!.image != null
                        ? widget.modelObj!.image!
                        : " ",
                    height: 280,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            '${widget.modelObj!.stTitle != null ? widget.modelObj!.stTitle : " "}',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                widget.modelObj!.wishList =
                                    !widget.modelObj!.wishList!;
                                setState(() {});
                              },
                              child: widget.modelObj!.wishList!
                                  ? Icon(Icons.favorite,
                                      color: Colors.red, size: 22)
                                  : Icon(Icons.favorite_outline,
                                      size: 22, color: ev_primary_color),
                            ),
                          ],
                        ),
                        SizedBox(height: 30),
                            ...
                            SizedBox(
                              ...
                              child: ListView(
                                ...
                                children: List.generate(
                                    widget.modelObj!.amenitiesIconList!.length,
                                    (index) {
                                  return Container(
                                    margin:
                        ...
                        child: TextButton.icon(
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AddCheckInScreen()));
                          },
                          icon: Icon(Icons.check_circle_rounded,
                              color: ev_primary_color, size: 20),
