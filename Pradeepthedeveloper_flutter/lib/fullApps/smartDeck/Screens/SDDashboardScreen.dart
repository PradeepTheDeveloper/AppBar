...
import 'package:pradeep_the_developer/fullApps/smartDeck/ModelClass/LessonsModelClass.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/ModelClass/LiveVideoModel.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/ModelClass/SDExamCardModel.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/SDUtils/SDColors.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/SDUtils/SDStyle.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/Screens/SDAllLessonsScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/Screens/SDExamScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/Screens/SDLessonsChapterDetailsScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/Screens/SDNotificationScreen.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/Screens/SDSearchScreen.dart';
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                      ...
                      Stack(
                        children: <Widget>[
                          Container(
                            ...
                            padding:
                                EdgeInsets.only(left: 10, top: 5, right: 15),
                            child: InkWell(
                              onTap: () {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(
                          child:
                              Text('Lessons', style: boldTextStyle(size: 16))),
                      InkWell(
                        onTap: () {
                        ...
                        child: Text('SEE ALL',
                            style:
                                boldTextStyle(color: sdPrimaryColor, size: 14)),
                      ),
                    ],
                  ),
                ),
                ...
                Container(
                  margin: EdgeInsets.only(left: 16, right: 16),
                  child: Text('Senior High School - 12th Grade',
                      style: secondaryTextStyle(size: 14)),
                ),
                SizedBox(height: 5),
                Container(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                CircleAvatar(
                                    radius: 30,
                                    child: Image.asset(lessons[index].image!,
                                        height: 30, width: 30)),
                                Container(
                                  ...
                                  FittedBox(
                                    child: Container(
                                      ...
                                      decoration: boxDecorations(
                                          bgColor: sdSecondaryColorRed,
                                          radius: 4),
                                      padding:
                                          EdgeInsets.fromLTRB(10, 6, 10, 6),
                                      child: Center(
                                        child: Text(liveVideo[index].status!,
                                            style: secondaryTextStyle(
