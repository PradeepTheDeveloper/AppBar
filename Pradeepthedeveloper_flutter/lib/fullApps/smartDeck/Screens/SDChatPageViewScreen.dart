  ...
  void initState() {
        ...
        child: FittedBox(
          child: Container(
            ...
            decoration: boxDecorations(
                bgColor:
                    appStore.isDarkModeOn ? scaffoldDarkColor : sdViewColor),
    ...
    childList.add(Align(
      ...
      child: SendedMessageWidget(
          content: 'Hello ${widget.name}', time: '01:36 PM'),
    ));
    childList.add(Align(
      alignment: Alignment(1, 0),
      child: SendedMessageWidget(
          content: 'How are you? What are you doing?', time: '01:36 PM'),
    ));
    childList.add(Align(
      alignment: Alignment(-1, 0),
      child: ReceivedMessageWidget(
          content: 'Hello, Mark.I am fine. How are you?', time: '01:40 PM'),
    ));
    childList.add(
      Align(
        alignment: Alignment(1, 0),
        child: SendedMessageWidget(
            content:
                'I am good. Can you do something for me? I need your help.',
            time: '01:40 PM'),
      ),
    );
  }
                        ...
                        Container(
                          ...
                          child: PopupMenuButton(
                            ...
                            itemBuilder: (BuildContext context) => [
                              ...
                              PopupMenuItem(
                                  value: 3, child: Text("Mute notification")),
                              PopupMenuItem(value: 4, child: Text("Report")),
                              PopupMenuItem(
                                  value: 5, child: Text("Clear chat")),
                              PopupMenuItem(
                                  value: 6, child: Text("Block user")),
                            ],
                          ),
                        )
                      ],
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Container(
                            padding: EdgeInsets.only(top: 5),
                            margin:
                                EdgeInsets.only(bottom: 10, left: 15, right: 5),
