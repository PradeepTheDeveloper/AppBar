...
import 'package:pradeep_the_developer/fullApps/smartDeck/ModelClass/SDChatsModel.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/SDUtils/SDColors.dart';
import 'package:pradeep_the_developer/fullApps/smartDeck/Screens/SDChatPageViewScreen.dart';
                            ...
                            children: <Widget>[
                              Expanded(
                                child: ListTile(
                                  ...
                                  title: Text(personalChats[index].name!,
                                      style: boldTextStyle()),
                                  subtitle: Text(personalChats[index].message!,
                                      maxLines: 1,
