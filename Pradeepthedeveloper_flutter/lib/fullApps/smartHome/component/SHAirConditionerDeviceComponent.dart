...
class SHAirConditionerDeviceComponent extends StatefulWidget {
  ...
  @override
  _SHAirConditionerDeviceComponentState createState() =>
      _SHAirConditionerDeviceComponentState();
}

class _SHAirConditionerDeviceComponentState
    extends State<SHAirConditionerDeviceComponent> {
  List<String> deviceTemprature = [
    '16',
    '17',
    '18',
    '19',
          ...
          children: [
            Row(
              ...
              children: [
                ...
                deviceModeButton(
                  child:
                      Icon(Icons.ac_unit, color: isacUnitIcon ? black : white),
                  onTap: () {
