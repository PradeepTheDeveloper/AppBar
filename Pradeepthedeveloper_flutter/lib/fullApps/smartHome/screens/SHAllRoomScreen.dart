          ...
          return Stack(
            ...
            children: [
              commonSHCachedNetworkImage(
                ...
                () {
                  SHRoomScreen(
                          title: homeData.name, list: homeData.shDeviceModel!)
                      .launch(context);
                },
              ),
              Container(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          "${getLength(homeList[index].shDeviceModel!)}" +
                              "/" +
                              "${homeData.shDeviceModel!.length}",
                    ...
                    HorizontalList(
                      ...
                      itemBuilder: (_, index) {
                        SHDeviceModel deviceData =
                            homeData.shDeviceModel![index];
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color:
                                deviceData.mIsCheck! ? context.cardColor : null,
                          ),
                          child: Image.asset(
