...
List<BHCategoryModel> getCategory() {
  ...
  categoryList
      .add(BHCategoryModel(img: BHHairColor, categoryName: 'Hair Color'));
  categoryList.add(BHCategoryModel(img: BHSkinCare, categoryName: 'Skin Care'));
  categoryList
      .add(BHCategoryModel(img: BHHairColor, categoryName: 'Hair Color'));
...
List<BHIncludeServiceModel> getIncludeServicesList() {
  ...
  servicesList.add(BHIncludeServiceModel(
      ...
      price: 70));
  servicesList.add(BHIncludeServiceModel(
      serviceImg: BHdDashedBoardImage5,
      serviceName: 'Skin Care',
      time: '30 Min',
      price: 150));
  servicesList.add(BHIncludeServiceModel(
      serviceImg: BHDashedBoardImage4,
      serviceName: 'hair Style',
      time: '45 Min',
      price: 50));
  servicesList.add(BHIncludeServiceModel(
  ...
  servicesList.add(BHIncludeServiceModel(
      ...
      price: 100));
  servicesList.add(BHIncludeServiceModel(
      serviceImg: BHDashedBoardImage6,
      serviceName: 'Change Hair Color',
      time: '50 Min',
      price: 100));
  servicesList.add(BHIncludeServiceModel(
      serviceImg: BHDashedBoardImage7,
      serviceName: 'Change Hair Color',
      time: '50 Min',
      price: 100));
  return servicesList;
...
List<BHHairStyleModel> getHairStyleList() {
  ...
  hairStyleList
      .add(BHHairStyleModel(img: BHDashedBoardImage4, name: 'Carlos Day'));
  hairStyleList
...
List<BHMakeUpModel> getMakeupList() {
  ...
  makeupList
      .add(BHMakeUpModel(img: BHDashedBoardImage3, name: 'willies carpen'));
  makeupList.add(BHMakeUpModel(img: BHDashedBoardImage4, name: 'Carlos Day'));
  makeupList
      .add(BHMakeUpModel(img: BHdDashedBoardImage5, name: 'Dale Horward'));
  makeupList
      .add(BHMakeUpModel(img: BHDashedBoardImage1, name: 'willies carpen'));
  return makeupList;
}
