...
class BHAccountInformationScreen extends StatefulWidget {
  ...
  @override
  BHAccountInformationScreenState createState() =>
      BHAccountInformationScreenState();
}

class BHAccountInformationScreenState
    extends State<BHAccountInformationScreen> {
              ...
              Container(
                ...
                child: Stack(
                  ...
                  children: [
                    Center(
                        child: CircleAvatar(
                            backgroundImage: AssetImage(BHDashedBoardImage3),
                            radius: 50)),
                    Padding(
                      padding: EdgeInsets.only(left: 80, top: 60),
                      child: IconButton(
                          icon: Image.asset(BHAddIcon, height: 21, width: 21),
                          onPressed: () {}),
                    )
                  ],
                ),
