...
import 'package:pradeep_the_developer/fullApps/hairSalon/model/BHModel.dart';
import 'package:pradeep_the_developer/fullApps/hairSalon/utils/BHColors.dart';
import 'package:pradeep_the_developer/fullApps/hairSalon/utils/BHConstants.dart';
import 'package:pradeep_the_developer/fullApps/hairSalon/utils/BHDataProvider.dart';
import 'package:pradeep_the_developer/fullApps/hairSalon/utils/BHImages.dart';
import 'package:pradeep_the_developer/main.dart';
import 'package:pradeep_the_developer/main/utils/AppWidget.dart';
import 'package:pradeep_the_developer/main/utils/flutter_rating_bar.dart';
      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        SvgPicture.asset(categoryList[index].img!,
                            height: 40, width: 40),
                        8.height,
            ...
            // 8.height,
            Text(BHTxtPackageOffers, style: boldTextStyle())
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: commonCacheImageWidget(
                                offerList[index].img, 100,
                                width: 250, fit: BoxFit.cover),
                          ),
                          Padding(
                            padding: EdgeInsets.all(8),
                            child: Text(offerList[index].offerName!,
                                style: boldTextStyle()),
                          ),
                          Container(
                            padding:
                            ...
                            child: Row(
                              ...
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Text(offerList[index].offerDate!,
                                    style: secondaryTextStyle(),
                                    textAlign: TextAlign.left),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                                    Text('\$${offerList[index].offerOldPrice}',
                                        style: secondaryTextStyle()),
                                    8.width,
                                    Text('\$${offerList[index].offerNewPrice}',
                                        style: TextStyle(
            ...
            Text(BHTxtPopularServices, style: boldTextStyle())
                .paddingSymmetric(horizontal: 16),
            ListView.builder(
                      ...
                      Column(
                        children: [
                          Align(
                            ...
                            child: Text(servicesList[index].serviceName!,
                                style: boldTextStyle()),
                          ),
                          8.height,
                          Row(
                            children: [
                              Text(servicesList[index].time!,
                                  style: secondaryTextStyle()),
                              8.width,
                              Text('\$${servicesList[index].price}',
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                                backgroundImage:
                                    AssetImage(reviewList[index].img!),
                                radius: 30),
                            8.width,
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                ...
                child: SliverAppBar(
                  ...
                  bottom: TabBar(
                    ...
                    tabs: [
                      ...
                      Tab(
                        child: Align(
                            alignment: Alignment.center,
                            child: Text(BHTabReview,
                                style: TextStyle(fontSize: 14))),
                      ),
                      Tab(
                        child: Align(
                            alignment: Alignment.center,
                            child: Text(BHTabSalonSpecialList,
                                style: TextStyle(fontSize: 14))),
                      ),
                    ],
                  ...
                  actions: [
                    IconButton(
                        ...
                        onPressed: () {}),
                    IconButton(
                        icon: Icon(Icons.message, color: whiteColor, size: 16),
                        onPressed: () {}),
                  ],
                ),
              ),
