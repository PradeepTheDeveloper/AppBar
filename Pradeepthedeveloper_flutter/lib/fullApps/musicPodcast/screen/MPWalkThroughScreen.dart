...
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPSignInAndSignUpScreen.dart';
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPTabBarSignInScreen.dart';
...
class MPWalkThroughScreenState extends State<MPWalkThroughScreen>
    with AfterLayoutMixin<MPWalkThroughScreen> {
  ...
  void afterFirstLayout(BuildContext context) {
    pages = [
      Column(
        ...
        children: [
          commonCacheImageWidget(mpImages_1, 200, width: 200, fit: BoxFit.cover)
              .cornerRadiusWithClipRRect(100),
          16.height,
          Text('Enjoy Music In Real Time',
      ...
      Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          commonCacheImageWidget(mpImages_2, 200, width: 200, fit: BoxFit.cover)
              .cornerRadiusWithClipRRect(100),
          16.height,
          Text('Create Your Own Music List',
              style: boldTextStyle(color: Colors.white)),
          8.height,
      ...
      Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          commonCacheImageWidget(mpImages_3, 200, width: 200, fit: BoxFit.cover)
              .cornerRadiusWithClipRRect(100),
          16.height,
          Text('Real Time Music News',
              style: boldTextStyle(color: Colors.white)),
          8.height,
          Text(
              ...
              child: AppButton(
                ...
                onTap: () {
                  pageController.nextPage(
                      duration: Duration(milliseconds: 500), curve: _kCurve);
