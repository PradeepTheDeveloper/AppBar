...
import 'package:pradeep_the_developer/fullApps/musicPodcast/screen/MPNewsDetailScreen.dart';
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        commonCacheImageWidget(data.img, 150,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(data.description!,
                              ...
                              overflow: TextOverflow.ellipsis,
                              style:
                                  secondaryTextStyle(color: mpAppTextColor1)),
                        ],
                      ).expand()
                    ],
                  ),
