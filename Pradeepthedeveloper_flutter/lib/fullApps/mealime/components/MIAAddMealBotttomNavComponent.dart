...
import 'package:pradeep_the_developer/fullApps/mealime/utils/MIADialogs.dart';
import 'package:pradeep_the_developer/main.dart';

class MIAAddMealBotttomNavComponent extends StatefulWidget {
  @override
  _MIAAddMealBotttomNavComponentState createState() =>
      _MIAAddMealBotttomNavComponentState();
}

class _MIAAddMealBotttomNavComponentState
    extends State<MIAAddMealBotttomNavComponent> {
  @override
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: miaCommonCachedNetworkImage(
                              miaStore.addedMeals[index].image,
                              height: 48,
                              width: 48,
                              fit: BoxFit.cover)
