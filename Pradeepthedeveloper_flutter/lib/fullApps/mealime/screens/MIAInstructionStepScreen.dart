...
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIAConfirmQuitScreen.dart';
...
class MIAInstructionStepScreen extends StatefulWidget {
  ...
  @override
  _MIAInstructionStepScreenState createState() =>
      _MIAInstructionStepScreenState();
}
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    color: miaContainerSecondaryColor, borderRadius: radius(8)),
