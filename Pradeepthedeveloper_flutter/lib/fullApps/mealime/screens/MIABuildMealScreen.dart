...
import 'package:pradeep_the_developer/fullApps/mealime/components/MIAAddMealBotttomNavComponent.dart';
import 'package:pradeep_the_developer/fullApps/mealime/components/MealContainerComponent.dart';
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIASplashScreen.dart';
import 'package:pradeep_the_developer/fullApps/mealime/utils/MIABottomSheets.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                miaCommonCachedNetworkImage('$BaseUrl/images/mealime/x.png',
                        height: 20, color: context.iconColor)
                    .onTap(() {
                  finish(context);
                }),
            ...
            16.height,
            Text('Build a meal plan', style: boldTextStyle(size: 26))
                .paddingSymmetric(horizontal: 16),
            20.height,
            MealContainerComponent(
                header: 'Most Popular', mealList: mealMostPopularList),
            30.height,
            MealContainerComponent(
                header: 'Recently Created', mealList: mealRecentlyCreatedList),
            30.height,
            Container(
                  ...
                  Column(
                    ...
                    children: [
                      Text('RECOMMENDED PLANS',
                          style: boldTextStyle(color: miaSecondaryTextColor)),
                      8.height,
                      Text('Perfect plans, customized for you.',
            ...
            30.height,
            MealContainerComponent(
                header: 'Top Rated', mealList: mealTopRatedList),
            30.height,
            MealContainerComponent(
                header: 'Quick & Easy', mealList: mealQuickEasyList),
            50.height,
          ],
        ),
      ),
