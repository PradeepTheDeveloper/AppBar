      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text('Access new recipes every month reserved for pro subscribers.',
                  ...
                  miaCommonCachedNetworkImage(
                          '$BaseUrl/images/mealime/best-seller.png',
                          color: white,
                          height: 250)
                      .center(),
                  16.height,
            ...
            Text('\$ 2.99 a month. Cancel anytime.', style: boldTextStyle())
                .paddingAll(16),
            AppButton(
