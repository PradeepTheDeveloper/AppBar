...
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIAUpgradeScreen.dart';
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            70.height,
            miaCommonCachedNetworkImage('$BaseUrl/images/mealime/faceOne.jpg',
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text('Upgrade to Pro',
                          style:
                              boldTextStyle(color: miaPrimaryColor, size: 24)),
                      8.height,
                      Text(
              ...
              children: settingList.map((e) {
                return Column(
                  ...
                  children: [
                    Row(
                      children: [
                        miaCommonCachedNetworkImage(e.image,
                            height: 30, color: context.iconColor),
                        30.width,
