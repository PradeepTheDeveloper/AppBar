...
import 'package:pradeep_the_developer/fullApps/mealime/screens/MIABuildMealScreen.dart';
...
PreferredSizeWidget miaFragmentAppBar(
    BuildContext context, String name, bool isMealFragment) {
  return AppBar(
    toolbarHeight: 100,
    title: Text(name, style: boldTextStyle(size: 24))
...
Widget miaCommonCachedNetworkImage(
  ...
  if (url!.validate().isEmpty) {
    ...
    return miaCommonCachedNetworkImage(url,
            height: height,
            width: width,
            fit: fit,
