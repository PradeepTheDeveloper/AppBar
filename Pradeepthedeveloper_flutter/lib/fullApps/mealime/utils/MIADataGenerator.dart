import 'package:pradeep_the_developer/fullApps/mealime/models/MIADashboardModel.dart';
import 'package:pradeep_the_developer/fullApps/mealime/models/MIAIngredientModel.dart';
...
List<MIASelectOptionsModel> getServingsList() {
  ...
  list.add(MIASelectOptionsModel(
      title: '2 servings',
  ...
  list.add(MIASelectOptionsModel(
      ...
      selected: false));
  list.add(MIASelectOptionsModel(
      title: '6 servings', subtitle: 'for a family of 5+', selected: false));
...
List<MIADashboardModel> getFragmentsList() {
  ...
  list.add(
      MIADashboardModel(image: 'images/mealime/knife.png', tab: 'Meal Plan'));
  list.add(MIADashboardModel(
      image: 'images/mealime/shopping-basket.png', tab: 'Groceries'));
  list.add(MIADashboardModel(
      image: 'images/mealime/romantic-novel.png', tab: 'Favourites'));
  list.add(
      MIADashboardModel(image: 'images/mealime/setting.png', tab: 'Settings'));
...
List<MIAMealModel> getMealList() {
  ...
  list.add(MIAMealModel(
      image: '$BaseUrl/images/mealime/plate_one.jpg',
      text: 'Brussels Sprouts, Mashed Potatoes & Sausage Bowl with sugar',
      added: false,
      pro: true));
  list.add(MIAMealModel(
      image: '$BaseUrl/images/mealime/plate_two.jpg',
      text:
          'Roasted Cauliflower & Black Bean Burrito Bowl with Cilantro Lights',
      added: false,
      pro: false));
  list.add(MIAMealModel(
      image: '$BaseUrl/images/mealime/plate_three.jpg',
      text: 'Creamy Cashew Zucchini Noodles with Vegan Sausage, Article',
      added: false,
      pro: false));
  list.add(MIAMealModel(
      image: '$BaseUrl/images/mealime/plate_four.jpg',
      text: 'Lebanese Lentils, Rice & fried Onions (Mujadara) with Chocolate',
      added: false,
      pro: true));
  list.add(MIAMealModel(
      image: '$BaseUrl/images/mealime/plate_five.jpg',
      text: 'Brussels Sprouts, Mashed Potatoes & Sausage Bowl with sugar',
      added: false,
      pro: false));
...
List<MIASelectOptionsModel> getIngredientsList() {
  ...
  list.add(MIASelectOptionsModel(
      title: 'chicken or vegetable broth', subtitle: '16 fl oz'));
  list.add(
      MIASelectOptionsModel(title: 'cilantro', subtitle: '1/2 small bunch'));
  list.add(MIASelectOptionsModel(
      title: 'coconut milk', subtitle: '1/2 (13.5 dl oz) can'));
  list.add(MIASelectOptionsModel(title: 'garlic', subtitle: '2 cloves'));
  list.add(
      MIASelectOptionsModel(title: 'ginger root', subtitle: '1(1 inch) piece'));
  list.add(
      MIASelectOptionsModel(title: 'grape tomatoes', subtitle: '1/2 pint'));
...
List<MIAInstructionsModel> getInstructions() {
  ...
  list.add(MIAInstructionsModel(
    title:
        'Using a strainer or colander, rinse the rice under cold, running water, then drain and transfer to small saucepan. Add both and bring the mixture to boil over high heat.',
    subtitles: [
...
List<MIASelectOptionsModel> getGroceryList() {
  ...
  list.add(
      MIASelectOptionsModel(title: 'lemon', subtitle: '1/2', selected: false));
  list.add(
      MIASelectOptionsModel(title: 'lime', subtitle: '1', selected: false));
  list.add(
      MIASelectOptionsModel(title: 'mango', subtitle: '1/2', selected: false));
  list.add(
      MIASelectOptionsModel(title: 'orange', subtitle: '1/2', selected: false));
  list.add(
      MIASelectOptionsModel(title: 'avocado', subtitle: '1', selected: false));
  list.add(MIASelectOptionsModel(
      title: 'english cucumber', subtitle: '1/2', selected: false));
  list.add(MIASelectOptionsModel(
      title: 'garlic', subtitle: '6 cloves', selected: false));
  list.add(MIASelectOptionsModel(
      title: 'ginger root', subtitle: '2 (1 inch) pieces', selected: false));
  list.add(MIASelectOptionsModel(
      title: 'grape tomatoes', subtitle: '1/2 pint', selected: false));
  list.add(
      MIASelectOptionsModel(title: 'tomato', subtitle: '1', selected: false));
...
List<MIASelectOptionsModel> getShopsList() {
  ...
  list.add(MIASelectOptionsModel(
      title: 'Asda',
      subtitle: '$BaseUrl/images/mealime/asda.png',
      selected: false));
  list.add(MIASelectOptionsModel(
      title: 'Ocado',
      subtitle: '$BaseUrl/images/mealime/ocado.png',
      selected: false));
  list.add(MIASelectOptionsModel(
      title: 'Tesco',
      subtitle: '$BaseUrl/images/mealime/tesco.png',
      selected: false));
...
List<MIADashboardModel> getSettingsList() {
  ...
  list.add(MIADashboardModel(
      image: '$BaseUrl/images/mealime/adjust.png', tab: 'Eating Preferences'));
  list.add(MIADashboardModel(
      image: '$BaseUrl/images/mealime/book.png', tab: 'Your recipes'));
  list.add(MIADashboardModel(
      image: '$BaseUrl/images/mealime/gift.png', tab: 'Share Mealime'));
  list.add(MIADashboardModel(
      image: '$BaseUrl/images/mealime/chef.png', tab: 'Meet Our Chefs'));
  list.add(MIADashboardModel(
      image: '$BaseUrl/images/mealime/bulb.png',
      tab: 'Help Make Mealime Better'));
