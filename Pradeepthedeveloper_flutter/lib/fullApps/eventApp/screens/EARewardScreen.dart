...
class _EARewardScreenState extends State<EARewardScreen> {
  ...
  String dec =
      "Share your Discount code with your friends get \$1.00 for every new user who introduce your code in their profile.";
  String des2 =
      "They will get the \$4.00 to spend in Evens. whet their First \$ in events. without  discount coupon. you will get \$4.0 up to a maximum \$35.00.";
          ...
          child: Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon:
                    Text('Apply', style: primaryTextStyle(color: primaryColor1))
                        .onTap(
                  () {
