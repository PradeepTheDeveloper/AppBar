...
import 'package:pradeep_the_developer/fullApps/eventApp/screens/EAConnectionScreen.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/screens/EAIndexScreen.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/screens/EARewardScreen.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/utils/EAColors.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/utils/EAImages.dart';
import 'package:pradeep_the_developer/fullApps/eventApp/utils/EAapp_widgets.dart';
...
class _EAProfileTopComponentState extends State<EAProfileTopComponent> {
  bool isExpand = false;
  String hashTag =
      "#art #festival #fashion #expo..#cultur #food&drink #sport #nightlife";
                        ...
                        child: Stack(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text("INBOX",
                                  style:
                                      primaryTextStyle(color: primaryColor1)),
                            ).onTap(() {
