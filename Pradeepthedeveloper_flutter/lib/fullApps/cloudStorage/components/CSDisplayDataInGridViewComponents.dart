...
class CSDisplayDataInGridViewComponents extends StatefulWidget {
  ...
  CSDisplayDataInGridViewComponents(
      {Key? key,
      this.listOfData,
      this.isSelect,
      this.isSelectAll,
  ...
  @override
  CSDisplayDataInGridViewComponentsState createState() =>
      CSDisplayDataInGridViewComponentsState();
}

class CSDisplayDataInGridViewComponentsState
    extends State<CSDisplayDataInGridViewComponents> {
                      ...
                      child: Checkbox(
                        ...
                        onChanged: (val) {
                          setState(() {
                            ...
                            widget.onChange!
                                .call(widget.selectedItem, widget.isSelectAll);
                          });
                        },
                      ),
                    )
