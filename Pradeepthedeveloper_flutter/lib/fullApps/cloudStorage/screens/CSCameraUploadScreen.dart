            ...
            child: Column(
              children: [
                buildListTileForSetting(
                  ...
                  subTitle:
                      "Photos will upload to the Camera Uploads folder in your personal $CSAppName",
                ...
                buildListTileForSetting(
                  title: "Upload video",
                  subTitle:
                      "Videos will upload to the Camera Uploads folder in your personal $CSAppName",
                ...
                buildListTileForSetting(
                  ...
                  subTitle:
                      "$CSAppName will upload when the battery level is greater than 30%",
                  isEnable: false,
                ),
                buildDivider(),
                buildListTileForSetting(
