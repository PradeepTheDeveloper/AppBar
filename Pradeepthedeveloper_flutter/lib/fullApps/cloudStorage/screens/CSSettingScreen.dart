...
import 'package:pradeep_the_developer/fullApps/cloudStorage/screens/CSCameraUploadScreen.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/screens/CSManageDevicesScreen.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/screens/CSPasscodeScreen.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/screens/CSStartingScreen.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/screens/CSUpgradeAccountScreen.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/screens/CSWalkthroughScreen2.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/utils/CSColors.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/utils/CSConstants.dart';
import 'package:pradeep_the_developer/fullApps/cloudStorage/utils/CSWidgets.dart';
          ...
          return [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                  title: Text("$CSAppName settings", style: boldTextStyle())),
            ),
          ];
        },
        body: Container(
            ...
            child: Column(
              children: [
                Column(
                  ...
                  children: [
                    Text("Your Account", style: boldTextStyle(size: 14))
                        .paddingOnly(top: 10, left: 16),
                    buildDivider(),
                    ListTile(
                      onTap: () {
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Details", style: boldTextStyle(size: 14))
                        .paddingOnly(top: 10, left: 16),
                    buildDivider(),
                    buildListTileForSetting(
                        title: "Email", subTitle: "skg1498@gmail.com"),
                    buildDivider(),
                    buildListTileForSetting(
                        title: "Space used", subTitle: "0.1% of 2.0 GB"),
                    buildDivider(),
                    buildListTileForSetting(
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Features", style: boldTextStyle(size: 14))
                        .paddingOnly(top: 10, left: 16),
                    buildDivider(),
                    buildListTileForSetting(
                    ...
                    buildListTileForSetting(
                        title: "Offline Files",
                        subTitle: "Currently using 0 Bytes"),
                    buildDivider(),
                    buildListTileForSetting(
                      title: "Use data for offline files",
                      subTitle:
                          "Offline files will only download when you're connected to Wi-Fi",
                      trailing: Switch(
                        value: offlineFiles,
                        onChanged: (val) async {
                          bool isOK = await (buildCommonDialog(
                            ...
                            content:
                                "Updating files using cellular data could incur data charges",
                          ));
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Cloudbox", style: boldTextStyle(size: 14))
                        .paddingOnly(top: 10, left: 16),
                    buildDivider(),
                    ...
                    buildListTileForSetting(
                      title: "Sync contacts",
                      subTitle:
                          "Then you can easily share with your contacts on Cloudbox",
                      trailing: Switch(
                        value: syncContacts,
                        onChanged: (val) {
                          setState(() {
                    ...
                    buildDivider(),
                    buildListTileForSetting(
                        title: "Invite friends to get free space"),
                    buildDivider(),
                    ...
                    FutureBuilder<String>(
                      ...
                      builder: (_, snap) {
                        ...
                        if (snap.hasData) {
                          return buildListTileForSetting(
                              title: "App version", subTitle: snap.data!);
                        }
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Privacy", style: boldTextStyle(size: 14))
                        .paddingOnly(top: 10, left: 16),
                    buildDivider(),
                ...
                buildListTileForSetting(
                  ...
                  onTap: () async {
                    bool isSignOut = await (buildCommonDialog(
                      ...
                      posBtn: "Sign out",
                      content:
                          "Are you sure you want to sign out from your $CSAppName account ?",
                    ));
                    if (isSignOut) {
