...
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSJobDetailComponent.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSRemoveJobComponent.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/model/JSPopularCompanyModel.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSHomeScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/utils/JSColors.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/utils/JSDataGenerator.dart';
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Icon(
                      widget.filteredResultsList.selectSkill.validate()
                          ? Icons.favorite
                      ...
                      widget.filteredResultsList.selectSkill =
                          !widget.filteredResultsList.selectSkill.validate();
                      setState(() {});
                    }),
                  ],
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(widget.filteredResultsList.companyName.validate(),
                        style: boldTextStyle()),
                    8.width,
                ...
                4.height,
                Text(widget.filteredResultsList.totalReview.validate(),
