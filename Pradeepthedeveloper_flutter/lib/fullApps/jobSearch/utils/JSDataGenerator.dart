...
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSJobCompanies.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSJobSearchScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSProfileScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSReviewAndSaveScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSSearchResultScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/screens/JSSettingScreen.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/utils/JSImage.dart';
...
List<JSPopularCompanyModel> getSkillData() {
  ...
  skillList
      .add(JSPopularCompanyModel(companyName: "Adobe", selectSkill: false));
  skillList
      .add(JSPopularCompanyModel(companyName: "Axure", selectSkill: false));
  skillList
      .add(JSPopularCompanyModel(companyName: "Azure", selectSkill: false));
  skillList.add(
      JSPopularCompanyModel(companyName: "Javascript", selectSkill: false));
  skillList
      .add(JSPopularCompanyModel(companyName: "Sketch", selectSkill: false));
  skillList.add(JSPopularCompanyModel(companyName: "UX", selectSkill: false));
  skillList.add(JSPopularCompanyModel(
      companyName: "User Experience", selectSkill: false));
  skillList
      .add(JSPopularCompanyModel(companyName: "Wireframe", selectSkill: false));
...
List<JSPopularCompanyModel> getFilteredResultsData() {
  ...
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "Today",
      companyName: "UX DESIGNER - REMOTE",
      selectSkill: false,
      totalReview: "dnvod25",
      companyImage: "\$350 - \$400 a year",
      isBlocked: false));
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "6 days ago",
      companyName: "UX/UI Designer",
      selectSkill: false,
      totalReview: "65jhbsd",
      companyImage: "\$500 - \$600 a year",
      isBlocked: false));
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "10 days ago ",
      companyName: "Senior UX Designer ",
      selectSkill: false,
      totalReview: "Red Cloud",
      companyImage: "\$100 - \$250 a year",
      isBlocked: false));
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "2 days ago ",
      companyName: "Junior UI/UX Designer",
      selectSkill: false,
      totalReview: "Bench Samuels",
      companyImage: "\$300 - \$350 a year",
      isBlocked: false));
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "4 days ago ",
      companyName: "Android Developer",
      selectSkill: false,
      totalReview: "Jack Smit",
      companyImage: "\$600 - \800 a year",
      isBlocked: false));
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "5 days ago ",
      companyName: "Flutter Developer",
      selectSkill: false,
      totalReview: "dnvod25",
      companyImage: "\$200 - \$250 a year",
      isBlocked: false));
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "11 days ago ",
      companyName: "Java Developer",
      selectSkill: false,
      totalReview: "Denni Jhon",
      companyImage: "\$350 - \$500 a year",
      isBlocked: false));
  filteredResultsList.add(JSPopularCompanyModel(
      totalDays: "6 days ago ",
      companyName: "Php Developer",
      selectSkill: false,
      totalReview: "Devid Bettely",
      companyImage: "\$350 - \$400 a year",
      isBlocked: false));
...
List<JSPopularCompanyModel> getSkillList() {
  List<JSPopularCompanyModel> skillList = [];
  skillList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Wireframe"));
  skillList.add(JSPopularCompanyModel(isBlocked: false, companyName: "Axure"));
  skillList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "JavaScript"));
...
List<JSPopularCompanyModel> getRemoveJobsList() {
  ...
  removeJobsList.add(JSPopularCompanyModel(
      isBlocked: false,
      companyName: "Company",
      totalDays: "Not interested in 'Imperial Ventures'"));
  removeJobsList.add(JSPopularCompanyModel(
      isBlocked: false,
      companyName: "Not a match",
      totalDays: "Doesn't match 'graphics designer'"));
  removeJobsList.add(JSPopularCompanyModel(
      isBlocked: false,
      companyName: "Wrong location",
      totalDays: "Doesn't match"));
  removeJobsList.add(JSPopularCompanyModel(
      isBlocked: false,
      companyName: "Repetitive",
      totalDays: "Already seen or applied to this job"));
  removeJobsList.add(JSPopularCompanyModel(
      isBlocked: false,
      companyName: "Pay or salary",
      totalDays: "Not listed or not accurate for 'graphics designer'"));
  removeJobsList.add(JSPopularCompanyModel(
      isBlocked: false, companyName: "Other", totalDays: ""));
...
List<JSPopularCompanyModel> getRemoteList() {
  ...
  remoteList
      .add(JSPopularCompanyModel(index: 1, companyName: "Remote jobs only"));
...
List<JSPopularCompanyModel> getDatePostedList() {
  ...
  datePostedList
      .add(JSPopularCompanyModel(index: 1, companyName: "Last 24 hours"));
  datePostedList
      .add(JSPopularCompanyModel(index: 2, companyName: "Last 3 days"));
  datePostedList
      .add(JSPopularCompanyModel(index: 3, companyName: "Last 14 days"));
...
List<JSPopularCompanyModel> getDesireJobTypeList() {
  ...
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Full Time"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Part-Time"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Permanent"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Fixed term"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Temporary"));

  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Freelance"));
  desireJobTypeList.add(
      JSPopularCompanyModel(isBlocked: false, companyName: "Temp to prem"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Zero hours"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Volunteer"));
  desireJobTypeList.add(
      JSPopularCompanyModel(isBlocked: false, companyName: "Apprenticeship"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Internship"));
  desireJobTypeList
      .add(JSPopularCompanyModel(isBlocked: false, companyName: "Graduate"));
