...
class JSReviewAndSaVeComponent extends StatefulWidget {
  ...
  @override
  _JSReviewAndSaVeComponentState createState() =>
      _JSReviewAndSaVeComponentState();
}
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              24.height,
              Text(widget.reviewDraftList!.companyImage.validate(),
                  style: boldTextStyle(size: 22)),
              8.height,
              Text(widget.reviewDraftList!.totalDays.validate(),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(widget.reviewDraftList!.dateAnswere.validate(),
                      style: boldTextStyle()),
                  Row(
                    children: [
                      IconButton(
              ...
              Text(widget.reviewDraftList!.jobLocation.validate(),
                  style: primaryTextStyle()),
              8.height,
              Text(widget.reviewDraftList!.totalReview.validate(),
                  style: secondaryTextStyle()),
              8.height,
              Text(widget.reviewDraftList!.jobDescription.validate(),
                  style: primaryTextStyle()),
              24.height,
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              Divider(height: 0, color: gray.withOpacity(0.2)),
              8.height,
              Text(widget.reviewDraftList!.deegryName.validate(),
                  style: boldTextStyle()),
              8.height,
              Text(widget.reviewDraftList!.deegryCompleteYear.validate(),
                  style: secondaryTextStyle()),
              8.height,
              Text(widget.reviewDraftList!.deegryDescription.validate(),
                  style: primaryTextStyle()),
              24.height,
            ],
          ),
