...
class JSCompleteProfileFiveScreen extends StatefulWidget {
  ...
  @override
  _JSCompleteProfileFiveScreenState createState() =>
      _JSCompleteProfileFiveScreenState();
}

class _JSCompleteProfileFiveScreenState
    extends State<JSCompleteProfileFiveScreen> {
                      ...
                      children: desireJobTypeList
                          .map(
                            (desireJobTypeList) => CheckboxListTile(
                              title: Text(
                                  desireJobTypeList.companyName.validate(),
                                  style: boldTextStyle()),
