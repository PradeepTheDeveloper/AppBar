            ...
            children: [
              Row(
                children: [
                  ...
                  Text("reviews matching the search",
              ...
              Row(
                children: [
                  Text(widget.popularCompanyList!.companyRatting.toString(),
                      style: boldTextStyle()),
                  16.width,
                  RatingBar(
                    initialRating:
              ...
              8.height,
              Text("assistant branch manager (Current Employee)- East",
                  style:
                      secondaryTextStyle(decoration: TextDecoration.underline)),
              8.height,
              Text("London, Greater London 26 June 2021",
                  style:
                      secondaryTextStyle(decoration: TextDecoration.underline)),
              16.height,
              Container(
              ...
              16.height,
              Text(
                  "Responsible for chash handling- cashing up tills, counting safe and etc",
                  style: secondaryTextStyle()),
              16.height,
            ],
          ).paddingAll(16)
