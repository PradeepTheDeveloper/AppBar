...
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSDatePostedComponent.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSRemoteFilterComponent.dart';
import 'package:pradeep_the_developer/fullApps/jobSearch/components/JSSortByComponent.dart';
            ...
            children: [
              ...
              SingleChildScrollView(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Remote", style: boldTextStyle(size: 18))
                        .paddingOnly(left: 16),
                    16.height,
                    JSRemoteFilterComponent(),
                    Divider(color: gray.withOpacity(0.4)),
                    24.height,
                    Text("sort by", style: boldTextStyle(size: 18))
                        .paddingOnly(left: 16),
                    16.height,
                    JSSortByComponent(),
                    Divider(color: gray.withOpacity(0.4)),
