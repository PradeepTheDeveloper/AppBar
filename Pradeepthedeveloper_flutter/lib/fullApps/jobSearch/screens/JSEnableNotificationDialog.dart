...
class JSEnableNotificationDialog extends StatefulWidget {
  ...
  @override
  _JSEnableNotificationDialogState createState() =>
      _JSEnableNotificationDialogState();
}

class _JSEnableNotificationDialogState
    extends State<JSEnableNotificationDialog> {
  @override
  void initState() {
    super.initState();
    init();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          UL(
            children: [
              Text("Keep you up to date with the latest jobs.",
                  style: primaryTextStyle()),
              Text("Update you about job you've applied to.",
                  style: primaryTextStyle()),
              Text(
