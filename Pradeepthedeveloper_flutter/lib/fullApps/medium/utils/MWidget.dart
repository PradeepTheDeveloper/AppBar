...
import 'package:pradeep_the_developer/fullApps/medium/modal/MModel.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MAudioArticlesScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MBecomeAMemberScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MDashBoardScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MInterestsScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MNewStoryScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MPostDetailsScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MProfileScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MReadingListScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MSettingScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MStatsScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/screens/MStoriesScreen.dart';
import 'package:pradeep_the_developer/fullApps/medium/utils/MColors.dart';
import 'package:pradeep_the_developer/fullApps/medium/utils/MImages.dart';
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(
                  backgroundImage: NetworkImage(mCatSoftware), radius: 45),
              8.height,
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Audio', style: secondaryTextStyle(size: 16)).onTap(() {
                MAudioArticlesScreen(appBarTitle: "Audio Articles")
                    .launch(context);
              }),
              16.height,
              Text('Reading List', style: secondaryTextStyle(size: 16))
                  .onTap(() {
              ...
              Text('Become a member',
                      style: secondaryTextStyle(size: 16, color: mLimeColor))
                  .onTap(() {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  8.width,
                  commonCacheImageWidget(data.img, 80,
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(data.subtitle.validate(),
                              style: secondaryTextStyle(), maxLines: 2)
                          .visible(data.subtitle.validate().isNotEmpty),
                      8.height,
                      Text(data.authName.validate(),
                          style: secondaryTextStyle()),
                      8.height,
                      Row(
                        children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("${list![index].time} - 1 min read",
...
class CommonListDataForProfile extends StatefulWidget {
  ...
  @override
  _CommonListDataForProfileState createState() =>
      _CommonListDataForProfileState();
}
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text("${widget.list![index].time} - 1 min read",
                        style: primaryTextStyle(size: 14, color: grey)),
                    trailing: IconButton(
                        icon: Icon(
                            widget.list![index].isFav.validate()
                                ? Icons.bookmark
                                : Icons.bookmark_border,
                            color: white),
                        onPressed: () {
                          widget.list![index].isFav =
                              !widget.list![index].isFav;
                          setState(() {});
                        }),
                  ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: boxDecoration(
                        color: data.isFollow ? Colors.transparent : mLimeColor,
                        bgColor:
                            data.isFollow ? mLimeColor : Colors.transparent,
                        radius: 5),
                    child: Text(data.isFollow ? 'Following' : 'Follow',
                        style: primaryTextStyle(color: white)),
                  ).onTap(() {
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: boxDecoration(
                      color: data.isFollow ? Colors.transparent : mLimeColor,
                      bgColor: data.isFollow ? mLimeColor : Colors.transparent,
                      radius: 5),
                  child: Text(data.isFollow ? 'Following' : 'Follow',
                      style: primaryTextStyle(color: white)),
                ).onTap(() {
