          ...
          body: TabBarView(
            children: [
              getListOfDraftStories().length != 0
                  ...
                  : Text("You haven't published any draft stories yet.",
                          style: primaryTextStyle(size: 18, color: grey),
                          textAlign: TextAlign.center)
                      .paddingAll(16)
                      .center(),
              getListOfPublicStories().length != 0
                  ? CommonListForStories(list: getListOfPublicStories())
                  : Text("You haven't published any public stories yet.",
                          style: primaryTextStyle(size: 18, color: grey),
                          textAlign: TextAlign.center)
                      .paddingAll(16)
                      .center(),
              getListOfUnlistedStories().length != 0
                  ...
                  : Text("You haven't published any unlisted stories yet.",
                          style: primaryTextStyle(size: 18, color: grey),
                          textAlign: TextAlign.center)
                      .paddingAll(16)
                      .center(),
