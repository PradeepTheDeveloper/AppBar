        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text('Dark Mode', style: primaryTextStyle(color: white))
                    .expand(),
                Text('System Default',
              ...
              children: [
                ...
                Icon(
                    isDisableImgLoad
                        ...
                        : Icons.check_box,
                    color: isDisableImgLoad ? white : mLimeColor),
              ],
            ).onTap(() {
              ...
              children: [
                ...
                Icon(
                    !isDataUsage
                        ? Icons.check_box_outline_blank
                        : Icons.check_box,
                    color: !isDataUsage ? white : mLimeColor),
              ],
            ).onTap(() {
            ...
            Divider(color: grey, height: 0.5),
            16.height,
            Text('Sign out', style: primaryTextStyle(color: white))
                .expand()
                .onTap(() {
              showDialog(
                context: context,
