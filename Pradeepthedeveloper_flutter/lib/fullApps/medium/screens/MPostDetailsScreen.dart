...
class MPostDetailsScreenState extends State<MPostDetailsScreen>
  ...
  _loadHtmlFromAssets() async {
    String fileText =
        await rootBundle.loadString("assets/medium/mediumhtmlpage.html");
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                IconButton(
                    icon: Icon(MaterialCommunityIcons.hand_okay),
                    onPressed: () {},
                    color: Colors.grey),
                IconButton(
                    icon: Icon(MaterialCommunityIcons.bookmark_outline),
                    onPressed: () {},
                    color: Colors.grey),
                IconButton(
                    icon: Icon(MaterialCommunityIcons.share_variant),
                    onPressed: () {},
                    color: Colors.grey),
              ],
            ),
            IconButton(
                icon: Icon(FontAwesome.sort_alpha_asc),
                onPressed: () {},
                color: Colors.grey),
          ],
        ),
          ...
          child: WebView(
            ...
            onPageFinished: (_) async {
              if (_webViewController != null) {
                contentHeight = double.tryParse(await _webViewController!
                    .evaluateJavascript(
