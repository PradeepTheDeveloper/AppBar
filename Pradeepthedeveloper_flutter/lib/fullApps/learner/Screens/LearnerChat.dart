...
import 'package:pradeep_the_developer/fullApps/learner/Screens/LearnerChatting.dart';
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TabBar(
                        ...
                        tabs: [
                          Text(learner_lbl_All, style: boldTextStyle(size: 18))
                              .paddingOnly(left: 16, bottom: 8, right: 8),
                          Text(learner_lbl_Instrctors,
                                  style: boldTextStyle(size: 18))
                              .paddingOnly(left: 8, bottom: 8, right: 8),
                          Text(learner_lbl_Friends,
                                  style: boldTextStyle(size: 18))
                              .paddingOnly(left: 8, bottom: 8, right: 8),
                          Text(learner_lbl_Bots, style: boldTextStyle(size: 18))
                              .paddingOnly(left: 8, bottom: 8, right: 8),
                        ],
                      ),
                    ],
