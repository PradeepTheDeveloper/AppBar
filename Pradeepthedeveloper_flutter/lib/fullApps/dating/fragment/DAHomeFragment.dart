...
import 'package:pradeep_the_developer/fullApps/dating/components/DiscoverBottomSheetWidget.dart';
import 'package:pradeep_the_developer/fullApps/dating/model/DatingAppModel.dart';
import 'package:pradeep_the_developer/fullApps/dating/screen/DAZoomingScreen.dart';
import 'package:pradeep_the_developer/fullApps/dating/utils/DADataGenerator.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        ...
        showBack: false,
        actions: [
          Icon(Icons.sort, color: appStore.isDarkModeOn ? white : black)
                    ...
                    Row(
                      children: [
                        Text('${list[index].name!.validate()},',
                            style: boldTextStyle(color: lightYellow, size: 20)),
                        8.width,
                        Text(list[index].age.toString().validate(),
                            style: boldTextStyle(color: lightYellow, size: 18)),
                      ],
                    ),
