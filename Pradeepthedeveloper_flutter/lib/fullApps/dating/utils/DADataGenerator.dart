...
import 'package:pradeep_the_developer/fullApps/dating/model/DatingAppModel.dart';
import 'package:pradeep_the_developer/fullApps/dating/screen/DAChangePasswordScreen.dart';
import 'package:pradeep_the_developer/fullApps/dating/screen/DALocationScreen.dart';
import 'package:pradeep_the_developer/fullApps/dating/screen/DANotificationScreen.dart';
import 'package:pradeep_the_developer/fullApps/dating/utils/DAConstants.dart';
...
List<DatingAppModel> getInboxData() {
  ...
  list.add(DatingAppModel(
      name: 'Arlene McCoy',
      subTitle: 'Student',
      image: 'images/dating/Image.1.jpg'));
  list.add(DatingAppModel(
      name: 'Jerome Bell',
      subTitle: 'Student',
      image: 'images/dating/Image.2.jpg'));
  list.add(DatingAppModel(
      name: 'Wade Warren',
      subTitle: 'Student',
      image: 'images/dating/Image.14.jpg'));
  list.add(DatingAppModel(
      name: 'Darlene',
      subTitle: 'Student',
      image: 'images/dating/Image.3.jpg'));
  list.add(DatingAppModel(
      name: 'Leslie Alexander',
      subTitle: 'Student',
      image: 'images/dating/Image.4.jpg'));
  list.add(DatingAppModel(
      name: 'Jacob Jones',
      subTitle: 'Student',
      image: 'images/dating/Image.5.jpg'));
  list.add(DatingAppModel(
      name: 'Wade Warren',
      subTitle: 'Student',
      image: 'images/dating/Image.6.jpg'));
  list.add(DatingAppModel(
      name: 'Cameron',
      subTitle: 'Wade Warren',
      image: 'images/dating/Image.7.jpg'));
  list.add(DatingAppModel(
      name: 'Eleanor Pena',
      subTitle: 'Wade Warren',
      image: 'images/dating/Image.8.jpg'));
  list.add(DatingAppModel(
      name: 'Jacob Jones',
      subTitle: 'Student',
      image: 'images/dating/Image.9.jpg'));
  list.add(DatingAppModel(
      name: 'Leslie Alexander',
      subTitle: 'Student',
      image: 'images/dating/Image.10.jpg'));
  list.add(DatingAppModel(
      name: 'Darlene',
      subTitle: 'Student',
      image: 'images/dating/Image.11.jpg'));
  list.add(DatingAppModel(
      name: 'Wade Warren',
      subTitle: 'Student',
      image: 'images/dating/Image.12.jpg'));
  list.add(DatingAppModel(
      name: 'Darlene',
      subTitle: 'Student',
      image: 'images/dating/Image.13.jpg'));
