...
import 'package:pradeep_the_developer/fullApps/coinPro/screen/CPWalkThroughScreen.dart';
...
class CPSplashScreenState extends State<CPSplashScreen> {
  ...
  Future<void> init() async {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => CPWalkThroughScreen()));
  }
