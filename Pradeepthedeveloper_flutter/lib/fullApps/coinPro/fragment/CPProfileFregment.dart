...
import 'package:pradeep_the_developer/fullApps/coinPro/screen/CPEditProfileScreen.dart';
                    ...
                    return InkWell(
                      ...
                      onTap: () async {
                        if (index == 0) {
                          ...
                          CPNotificationFragment(isNotification: true)
                              .launch(context);
                        } else if (index == 2) {
                          String url =
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                ...
                                child: Text(data.currencyUnit!,
                                    style: boldTextStyle()),
                              ),
                            ),
                            Icon(Icons.arrow_forward_ios,
                                color: CPPrimaryColor, size: 16),
                          ],
                        ),
                      ),
                    );
