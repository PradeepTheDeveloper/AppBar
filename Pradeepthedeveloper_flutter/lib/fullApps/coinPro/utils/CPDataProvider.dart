...
import 'package:pradeep_the_developer/fullApps/coinPro/utils/CPImages.dart';
...
List<CPDataModel> getCPWithDrawDataModel() {
  ...
  withDrawList.add(CPDataModel(
      cardName:
          "1. Please fill in the filed how much is the amount to the withdrawn"));
  withDrawList.add(CPDataModel(
      cardName: "2. select the account that will be the withdrawal target"));
  withDrawList.add(CPDataModel(cardName: "3. Click continue"));
  withDrawList.add(CPDataModel(
      cardName:
          "4. Check the information. if already correct, process and your transaction completed."));
...
List<CPDataModel> getMyWalletDataModel() {
  ...
  myWalletList.add(CPDataModel(
      bgColor: CPPrimaryColor,
      image: cp_dollar,
      currencyName: "US Dollar",
      currencyUnit: "USD",
      totalAmount: "\$98.565",
      cardName: "BNB 0.447515",
      percentage: "+1.82%"));
  myWalletList.add(CPDataModel(
      bgColor: CPSecondaryColor,
      image: cp_binance,
      currencyName: "Binance Coin",
      currencyUnit: "BNB/USD",
      totalAmount: "\$45.589",
      cardName: "ETH 0.87945",
      percentage: "+2.70%"));
  myWalletList.add(CPDataModel(
      bgColor: CPPrimaryColor,
      image: cp_ethereum,
      ...
      totalAmount: "\$60.235",
      cardName: "BNB 0.16622",
      percentage: "+6.82%"));
  myWalletList.add(CPDataModel(
      bgColor: CPSecondaryColor,
      image: cp_uniSwap,
      currencyName: "Uniswap",
      currencyUnit: "UNI/USD",
      totalAmount: "\$40.789",
      cardName: "UNI 0.748921",
      percentage: "-1.86%"));
  myWalletList.add(CPDataModel(
      bgColor: CPPrimaryColor,
      image: cp_dollar,
...
List<CPDataModel> getTradeCryptoNameDataModel() {
  ...
  tradeCryptoNameList.add(CPDataModel(
      bgColor: CPPrimaryColor,
      image: cp_dollar,
      currencyName: "US Dollar",
      currencyUnit: "USD",
...
List<CPDataModel> getProfileDataModel() {
  ...
  profileList
      .add(CPDataModel(icon: Icons.person, currencyUnit: "Edit Profile"));
  profileList.add(
      CPDataModel(icon: Icons.notifications, currencyUnit: "Notification"));
  profileList
      .add(CPDataModel(icon: Icons.lock, currencyUnit: "Privacy & Policy"));
