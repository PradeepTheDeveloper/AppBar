  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: title(grocery_lbl_Verify_Number, grocery_colorPrimary,
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  Flexible(
                    child: text("4 digit code send to",
                  ...
                  Flexible(
                      child: text("+94 7187876789",
                              textColor: grocery_textGreenColor,
                              fontSize: textSizeLargeMedium,
                              fontFamily: fontRegular)
                          .paddingOnly(
