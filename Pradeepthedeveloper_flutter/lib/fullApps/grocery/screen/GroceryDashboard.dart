                ...
                Row(
                  ...
                  children: [
                    AppButton(
                      ...
                      child: Text("$grocery_lbl_save_cart",
                          style: boldTextStyle(
                    ...
                    AppButton(
                      ...
                      child: Text(grocery_lbl_checkout,
                    ...
                    Row(
                      ...
                      children: [
                        AppButton(
                          ...
                          child: Text("$grocery_lbl_no".toUpperCase(),
                              style: boldTextStyle()),
                          color: context.cardColor,
                          onTap: () {
                            finish(context);
                        ...
                        AppButton(
                          padding:
                              EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                          child: Text(grocery_lbl_remove.toUpperCase(),
                              style: boldTextStyle()),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child:
                      text(model.name, textColor: grocery_textColorSecondary),
                ),
                Row(
