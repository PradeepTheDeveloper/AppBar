...
import 'package:pradeep_the_developer/fullApps/grocery/model/grocery_addPayment_model.dart';
import 'package:pradeep_the_developer/fullApps/grocery/utils/GeoceryStrings.dart';
import 'package:pradeep_the_developer/fullApps/grocery/utils/GroceryColors.dart';
import 'package:pradeep_the_developer/fullApps/grocery/utils/GroceryConstant.dart';
import 'package:pradeep_the_developer/fullApps/grocery/utils/GroceryImages.dart';
...
class GroceryAddPaymentScreen extends StatefulWidget {
  ...
  @override
  _GroceryAddPaymentScreenState createState() =>
      _GroceryAddPaymentScreenState();
}
  ...
  Widget build(BuildContext context) {
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(listAddPayment[index].cardName,
                      style: boldTextStyle(size: 18)),
                  8.height,
                  Icon(Icons.delete_outline, color: grocery_textColorSecondary)
                      .onTap(
                    () {
              ...
              Row(
                children: [
                  text(listAddPayment[index].expMonth + " / ",
                      fontSize: textSizeMedium, fontFamily: fontMedium),
                  text(listAddPayment[index].expYear,
                      fontSize: textSizeMedium, fontFamily: fontMedium),
                ],
              ),
              8.height,
              Row(
                children: [
                  Expanded(
                    child: Text(listAddPayment[index].bankName,
                        style: secondaryTextStyle()),
                  ),
                  commonCacheImageWidget(
                    listAddPayment[index].cardType == 'visa'
                        ? grocery_ic_visa
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading:
            Icon(Icons.arrow_back, size: 30, color: grocery_color_white).onTap(
          () {
            finish(context);
          },
        ),
        title: text(grocery_paymentMethod,
            fontSize: textSizeNormal, textColor: grocery_color_white),
      ),
