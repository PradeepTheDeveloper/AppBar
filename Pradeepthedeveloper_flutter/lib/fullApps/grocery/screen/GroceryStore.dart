...
import 'package:pradeep_the_developer/fullApps/grocery/utils/snapping_sheet.dart';
...
class _GroceryStoreState extends State<GroceryStore>
  ...
  void initState() {
    ...
    arrowIconAnimation = Tween(begin: 0.0, end: 0.5).animate(CurvedAnimation(
                  ...
                  WidgetSpan(
                    child: Padding(
                      ...
                      child: Icon(Icons.keyboard_arrow_right,
                          color: grocery_textColorSecondary, size: 16),
                    ),
                  ),
                ],
              ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: commonCacheImageWidget(model.img, 86,
                  fit: BoxFit.fill, width: 86),
            ),
            4.height,
            Padding(
