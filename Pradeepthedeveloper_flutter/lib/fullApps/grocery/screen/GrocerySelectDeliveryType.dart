...
class GrocerySelectDeliveryType extends StatefulWidget {
  ...
  @override
  _GrocerySelectDeliveryTypeState createState() =>
      _GrocerySelectDeliveryTypeState();
}
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Text(grocery_lbl_Home_Delivery,
                              style: boldTextStyle()),
              ...
              Row(
                children: <Widget>[
                  Container(
                    ...
                    width: 50,
                    decoration: boxDecoration(
                        radius: 25.0, bgColor: grocery_orangeColor),
                    child: Image.asset(Grocery_ic_Home,
                            height: 10, width: 10, color: grocery_color_white)
                        .paddingAll(12),
                  ),
