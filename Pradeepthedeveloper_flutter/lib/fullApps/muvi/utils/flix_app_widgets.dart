...
import 'package:pradeep_the_developer/fullApps/muvi/screens/flix_movie_detail_screen.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_percent_indicator.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        text(
          ...
          maxLine: 2,
          textColor:
              widget.colorThird ? muvi_textColorThird : muvi_textColorSecondary,
        ),
        text(
...
AppBar appBarLayout(context, text, {darkBackground = true}) {
  return AppBar(
    ...
    backgroundColor:
        darkBackground ? muvi_navigationBackground : Colors.transparent,
  );
}
...
Widget button(BuildContext context, buttonText, VoidCallback callback) {
  return MaterialButton(
    ...
    child: text(buttonText,
        fontSize: ts_normal, fontFamily: font_medium, textColor: Colors.black),
      ...
      children: <Widget>[
        Container(
          ...
          child: Icon(Icons.notifications_none,
              color: muvi_textColorPrimary, size: 24),
        ),
        Align(
          ...
          child: Container(
            ...
            child: text(cartCount.toString(),
                fontSize: 12.0, textColor: muvi_white),
          ).visible(cartCount != 0),
        )
      ],
    ),
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                MovieDetailScreen(title: "Action")),
                      );
                    },
  ...
  Widget build(BuildContext context) {
    return Container(
      child: GridView.builder(
        ...
        physics: BouncingScrollPhysics(),
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 2, childAspectRatio: 9 / 15),
        scrollDirection: Axis.vertical,
        controller: ScrollController(keepScrollOffset: false),
        itemBuilder: (context, index) {
          Movie bookDetail = list[index];
    ...
    decoration: InputDecoration(
      ...
      suffixIcon: isPassword && isPasswordVisible
          ? GestureDetector(
              ...
              child: Icon(suffixIcon, color: muvi_colorPrimary, size: 20))
