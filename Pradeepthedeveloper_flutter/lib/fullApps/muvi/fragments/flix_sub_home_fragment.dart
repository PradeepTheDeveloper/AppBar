...
import 'package:pradeep_the_developer/fullApps/muvi/models/flix_response.dart';
import 'package:pradeep_the_developer/fullApps/muvi/screens/flix_movie_detail_screen_2.dart';
import 'package:pradeep_the_developer/fullApps/muvi/screens/flix_series_detail_screen.dart';
import 'package:pradeep_the_developer/fullApps/muvi/screens/flix_view_all_movies_screen.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_app_widgets.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_data_generator.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_slider_widget.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/resources/flix_colors.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/resources/flix_size.dart';
...
class HomeCategoryFragmentState extends State<HomeCategoryFragment> {
  ...
  Widget build(BuildContext context) {
    ...
    var popularMovieList = mMovieList.isNotEmpty
        ? ItemHorizontalList(mMovieList, isHorizontal: false)
        : Container();
    var trendingMovieList = mTrendingMuviList.isNotEmpty
        ? ItemHorizontalList(mTrendingMuviList, isHorizontal: false)
        : Container();
    var newCinemaList = mCinemaMovieList.isNotEmpty
        ? ItemHorizontalList(mCinemaMovieList, isHorizontal: true)
        : Container();
    var continueWatchingList = mcontinueList.isNotEmpty
        ? ItemProgressHorizontalList(mcontinueList)
        : Container();
    return Scaffold(
