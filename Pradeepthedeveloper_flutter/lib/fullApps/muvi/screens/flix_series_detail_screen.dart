...
import 'package:pradeep_the_developer/fullApps/muvi/screens/flix_view_series_episodes_screen.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_app_widgets.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_constants.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_data_generator.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/flix_duration_formatter.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/resources/flix_colors.dart';
import 'package:pradeep_the_developer/fullApps/muvi/utils/resources/flix_images.dart';
      ...
      children: [
        IconButton(
                icon: Icon(Icons.thumb_up,
                    size: 24, color: muvi_textColorPrimary),
                onPressed: () {})
            .expand(),
        IconButton(
        ...
        AnimatedSwitcher(
          ...
          child: controller!.value.isPlaying
              ...
              : Container(
                  ...
                  child:
                      Icon(Icons.play_arrow, color: Colors.white, size: 100.0)
                          .center(),
                ),
        ),
        GestureDetector(
