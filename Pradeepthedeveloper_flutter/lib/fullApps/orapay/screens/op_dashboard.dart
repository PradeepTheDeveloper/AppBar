...
import 'package:pradeep_the_developer/fullApps/orapay/screens/op_myCards.dart';
import 'package:pradeep_the_developer/fullApps/orapay/screens/op_transfer_screen.dart';
      ...
      child: Scaffold(
        appBar: _currentIndex == 0
            ? getAppBar1(
                title,
                actions: [
                  Image.asset("images/orapay/op_profile.png",
                          width: 30, height: 30)
        ...
        bottomNavigationBar: Stack(
          ...
          children: [
            ...
            Image.asset('images/orapay/opsplash.png', width: 36, height: 36)
                .onTap(
              () {
