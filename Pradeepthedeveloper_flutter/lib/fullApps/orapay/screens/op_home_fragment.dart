...
import 'package:pradeep_the_developer/fullApps/orapay/screens/op_transaction_screen.dart';
                        ...
                        Column(
                          ...
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Image.asset('images/orapay/opchip.png',
                                    height: 40, width: 40),
                                Text(data.cardTitle!,
                                    style: boldTextStyle(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      ...
                      underline: SizedBox(),
                      items:
                          <String>['Daily', 'Weekly', 'Monthly', 'Yearly'].map(
                        (String value) {
