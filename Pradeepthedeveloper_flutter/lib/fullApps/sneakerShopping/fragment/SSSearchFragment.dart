...
import 'package:pradeep_the_developer/fullApps/sneakerShopping/screen/SSProductScreen.dart';
            ...
            ListView.builder(
              ...
              itemBuilder: (_, index) {
                return Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      SSProductScreen(img: list[index].img.validate())
                          .launch(context);
                    },
                    child: Stack(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Container(
                                  height: 1, width: 50, color: Colors.white),
                              SizedBox(height: 8),
