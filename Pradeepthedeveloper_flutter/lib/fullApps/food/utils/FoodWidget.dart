...
import 'package:pradeep_the_developer/fullApps/food/screen/FoodAddAddress.dart';
      ...
      text: TextSpan(
        children: [
          ...
          TextSpan(
              ...
              style:
                  TextStyle(fontSize: 16, color: appStore.textSecondaryColor)),
        ],
      ),
    ),
  );
            ...
            child: RichText(
              ...
              text: TextSpan(
                children: [
                  TextSpan(
                      text: value,
                      style: primaryTextStyle(size: 16, color: food_white)),
                  WidgetSpan(
                    child: Padding(
