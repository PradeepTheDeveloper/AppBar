import 'package:pradeep_the_developer/fullApps/food/model/FoodModel.dart';
...
List<DashboardCollections> addCollectionData() {
  ...
  collectionData.add(
      DashboardCollections("Gym Lover", food_ic_item4, "Starts from @₹99"));
  collectionData.add(
      DashboardCollections("Live Music", food_ic_item11, "Starts from @₹99"));
  collectionData
      .add(DashboardCollections("Friends", food_ic_item6, "Starts from @₹99"));
  collectionData.add(
      DashboardCollections("Gym Lover", food_ic_item4, "Starts from @₹99"));
...
List<ViewRestaurants> addViewRestaurantsData() {
  ...
  viewData.add(ViewRestaurants(
      ...
      "7 kms",
      1,
      "your first order & application above 199"));
  viewData.add(ViewRestaurants(
...
List<Coupons> addCouponsData() {
  ...
  couponsData.add(Coupons(
      "Get 40% caseback using HDFC card",
      "Use code TVBH8932 upto Rs.150 on your first order and Rs. 50 to your second order.",
      "TVBH8932"));
  couponsData.add(Coupons(
      "Get 20% caseback using Google wallet",
      "Use code AB46323 upto 25% on your first order and Rs. 50 to your second order.",
      "AB46323"));
  couponsData.add(Coupons(
      "Get 40% caseback using HDFC card",
      "Use code BGHYJE34 upto Rs.150 on your first order and Rs. 50 to your second order.",
      "BGHYJE34"));
  return couponsData;
}
