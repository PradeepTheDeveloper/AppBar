...
import 'package:pradeep_the_developer/fullApps/food/utils/FoodImages.dart';
...
class FoodWalkThroughState extends State<FoodWalkThrough> {
  ...
  var subTitles = [
    "you can use this code \"Pradeepthedeveloper\" for free delivery",
    "The taste of authenticity in every bite ",
          ...
          children: <Widget>[
            Arc(
              ...
              child: Container(
                  ...
                  width: MediaQuery.of(context).size.width,
                  color:
                      appStore.isDarkModeOn ? black : food_colorPrimary_light),
            ),
            SafeArea(
              child: Container(
                width: MediaQuery.of(context).size.width,
