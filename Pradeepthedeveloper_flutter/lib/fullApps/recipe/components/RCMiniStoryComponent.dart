...
import 'package:pradeep_the_developer/fullApps/recipe/screens/RCTodayStoryScreen.dart';
              ...
              children: [
                ClipPath(
                  ...
                  child: rcCommonCachedNetworkImage(
                          widget.element.foodImg.validate(),
                          fit: BoxFit.cover,
                          height: 150,
                          width: context.width() / 2 - 32)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ClipPath(
            clipper: BackgroundClipperThree(),
            child: rcCommonCachedNetworkImage(widget.element.foodImg.validate(),
                    fit: BoxFit.cover,
                    height: 150,
                    width: context.width() / 2 - 32)
                .cornerRadiusWithClipRRect(30),
