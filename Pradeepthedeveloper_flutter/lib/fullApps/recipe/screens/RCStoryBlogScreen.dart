...
import 'package:pradeep_the_developer/fullApps/recipe/components/RCCommentComponent.dart';
import 'package:pradeep_the_developer/fullApps/recipe/components/RCMiniStoryComponent.dart';
...
import 'package:pradeep_the_developer/fullApps/recipe/screens/RCCommentScreen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            16.height,
            rcCommonCachedNetworkImage(widget.element.foodImg.validate(),
            ...
            Row(
              children: [
                rcCommonCachedNetworkImage(
                        '$BaseUrl/images/recipe/strawberryCupcake.jpg',
                        height: 150,
                        width: 150,
                        fit: BoxFit.cover)
            ...
            RCCommentComponent(
                    ...
                    showLikes: false,
                    liked: false,
                    path: '$BaseUrl/images/recipe/faceOne.jpg')
                .onTap(() {
              RCCommentScreen().launch(context);
            },
                    splashColor: Colors.transparent,
            ...
            RCCommentComponent(
              ...
              RCCommentScreen().launch(context);
                    ...
                    highlightColor: Colors.transparent),
            30.height,
            Text('More delicious things for you',
                style: boldTextStyle(
                    fontFamily: GoogleFonts.playfairDisplay().fontFamily,
                    size: 20)),
            16.height,
