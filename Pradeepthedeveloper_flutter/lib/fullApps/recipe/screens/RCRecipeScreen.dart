...
import 'package:pradeep_the_developer/fullApps/recipe/components/RCBackComponent.dart';
import 'package:pradeep_the_developer/fullApps/recipe/components/RCCircularWrapComponent.dart';
import 'package:pradeep_the_developer/fullApps/recipe/components/RCReviewComponent.dart';
import 'package:pradeep_the_developer/fullApps/recipe/components/RCVideoListComponent.dart';
import 'package:pradeep_the_developer/fullApps/recipe/models/RCCollectionModel.dart';
import 'package:pradeep_the_developer/fullApps/recipe/models/RCHomeStoryModel.dart';
import 'package:pradeep_the_developer/fullApps/recipe/models/RCSearchModel.dart';
import 'package:pradeep_the_developer/fullApps/recipe/models/RCVideoModel.dart';
import 'package:pradeep_the_developer/fullApps/recipe/screens/RCReviewScreen.dart';
import 'package:pradeep_the_developer/fullApps/recipe/utils/RCBottomSheet.dart';
import 'package:pradeep_the_developer/fullApps/recipe/utils/RCColors.dart';
import 'package:pradeep_the_developer/fullApps/recipe/utils/RCCommon.dart';
...
class _RCRecipeScreenState extends State<RCRecipeScreen> {
  ...
  void initState() {
    ingredientList.add(RCSearchModel(
        name: '9 oz',
        image: '$BaseUrl/images/recipe/walkThroughImages/imageFive.png'));
    ingredientList.add(RCSearchModel(
        name: '7 oz',
        image: '$BaseUrl/images/recipe/walkThroughImages/imageFour.png'));
    ingredientList.add(RCSearchModel(
        name: '2 cups',
        image: '$BaseUrl/images/recipe/walkThroughImages/imageThree.png'));
    ingredientList.add(RCSearchModel(
        name: '2 clovest',
        image: '$BaseUrl/images/recipe/walkThroughImages/imageFive.png'));
    ingredientList.add(RCSearchModel(
            ...
            Row(
              ...
              children: [
                rcCommonCachedNetworkImage(
                    '$BaseUrl/images/recipe/walkThroughImages/imageThree.png',
                    height: 120),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
