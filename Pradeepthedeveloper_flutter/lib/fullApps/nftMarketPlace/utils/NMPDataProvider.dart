...
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/utils/NMPConstants.dart';
...
List<OSDataModel> getCategories() {
  ...
  list.add(OSDataModel(
      title: 'Art',
      image: image1,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_art.png'));
  list.add(OSDataModel(
      title: 'Music',
      image: image2,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_music.png'));
  list.add(OSDataModel(
      title: 'Domain Names',
      image: image3,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_domainname.png'));
  list.add(OSDataModel(
      title: 'Virtual Worlds',
      image: image4,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_virtualworld.png'));
  list.add(OSDataModel(
      title: 'Trading Card',
      image: image5,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_tradingcard.png'));
  list.add(OSDataModel(
      title: 'Collectibles',
      image: image7,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_collectibles.png'));
  list.add(OSDataModel(
      title: 'Sports',
      image: image8,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_sports.png'));
  list.add(OSDataModel(
      title: 'Utility',
      image: image9,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_utility.png'));
...
List<OSDataModel> getTrendingCollection() {
  ...
  list.add(OSDataModel(
      title: 'The lil rens',
      subtitle: 'lil-deployer',
      image: image7,
      profileImage: image2));
  list.add(OSDataModel(
      title: 'Communi3', subtitle: '', image: image10, profileImage: image1));
  list.add(OSDataModel(
      title: 'Silks Grnesis Avatars',
      subtitle: 'gameofsilks',
      image: image4,
      profileImage: image5));
  list.add(OSDataModel(
      title: 'Dr. Grordborts: Rayguns',
      subtitle: 'FLUFxWETA',
      image: image5,
      profileImage: image6));
  list.add(OSDataModel(
      title: 'Cets on Creck',
      subtitle: 'Cets on Creck',
      image: image6,
      profileImage: image7));
  list.add(OSDataModel(
      title: 'Famous Fox Federation',
      subtitle: 'Famous Fox Federation',
      image: image3,
      profileImage: image5));
...
List<OSDataModel> getRecentRocketsDetails() {
  ...
  list.add(OSDataModel(
      ...
      image: image10));
  list.add(
      OSDataModel(title: 'BEANZ Official', subtitle: "320.45%", image: image9));
  list.add(OSDataModel(
      title: 'Something Token', subtitle: "210.23%", image: image8));
  list.add(OSDataModel(
      title: 'Art Blocks Curated', subtitle: "123.52%", image: image7));
...
List<OSDataModel> getHotItems() {
  ...
  list.add(OSDataModel(
      title: 'Rarible',
      subtitle: 'Bored Ape Yacht Club #520 [Legendary Edition]',
      price: 0.1,
      like: 0,
      image: image9,
      isSelected: false));
  list.add(OSDataModel(
      title: 'Rarible',
      subtitle: 'Bored Ape Yacht Club #840 [Legendary Edition] ',
      price: 0.2,
      like: 0,
      image: image3,
      isSelected: false));
...
List<OSDataModel> getNewTopSellers() {
  ...
  list.add(OSDataModel(
      title: 'The Winterton Token',
      subtitle: 'Winterton Token [Legendary Edition]',
      price: 0.1,
      like: 0,
      image: image3,
      isSelected: false));
  list.add(OSDataModel(
      title: 'Dooplicator',
      subtitle: 'Dooplicator #143',
      price: 0.2,
      like: 0,
      image: image9,
      isSelected: false));
  list.add(OSDataModel(
      title: 'Danny Kass Art',
      subtitle: 'Trippy Do Know Glitch [Legendary Edition]',
      price: 3.6,
      like: 0,
      image: image6,
      isSelected: false));
...
List<OSDataModel> getTapCategoriesDetails() {
  ...
  list.add(OSDataModel(
      title: 'OneOneNFT',
      subtitle: 'OneOnes #6546',
      price: 0.189,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/kitten_fighting.gif',
      isSelected: false));
  list.add(OSDataModel(
      title: 'OneOneNFT',
      subtitle: 'OneOnes #2469',
      price: 0.1682,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/cat-cats.gif',
      isSelected: false));
  list.add(OSDataModel(
      title: 'OneOneNFT',
      subtitle: 'OneOnes #830',
      price: 0.289,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/cute-cat.gif',
      isSelected: false));
  list.add(OSDataModel(
      title: 'OneOneNFT',
      subtitle: 'OneOnes #3657',
      price: 0.179,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/gifcat.gif',
      isSelected: false));
...
List<OSDataModel> getTapNotableDropsDetails() {
  ...
  list.add(OSDataModel(
      title: 'Metaship by MetaMetaverse Mint',
      subtitle: 'Mint Three (3) Metaship NFTs',
      price: 0.3,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/gif1.gif',
      isSelected: false));
  list.add(OSDataModel(
      title: 'Metaship by MetaMetaverse Mint',
      subtitle: 'Mint Three (5) Metaship NFTs',
      price: 0.5,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/gif2.gif',
      isSelected: false));
  list.add(OSDataModel(
      title: 'Metaship by MetaMetaverse Mint',
      subtitle: 'Mint Three (10) Metaship NFTs',
      price: 1.5,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/gif3.gif',
      isSelected: false));
  list.add(OSDataModel(
      title: 'Metaship by MetaMetaverse Mint',
      subtitle: 'Mint Three (25) Metaship NFTs',
      price: 3.5,
      like: 0,
      image: '$osImageBaseUrl/os_gifs/gif4.gif',
      isSelected: false));
...
List<OSDataModel> getMoreFromCollection() {
  ...
  list.add(OSDataModel(
      title: 'Chumbi Valley Founders Collection',
      subtitle: 'Mythic Pod Remnants',
      price: 3.4,
      like: 0,
      image: image1,
      isSelected: false));
...
List<OSDataModel> getBlog() {
  ...
  list.add(OSDataModel(
      title: 'Learn',
      image: image1,
      subtitle: " How to Fund MetaMask with ETH",
      color: Colors.purple));
  list.add(OSDataModel(
      title: 'Announcement',
      image: image2,
      subtitle: "NFT Market Place Acquires Gem to Invest in 'Pro' Experience",
      color: Colors.blue));
  list.add(OSDataModel(
      title: 'Guest post',
      image: image7,
      subtitle: "Checkout Solana - now in beta on NFT Market Place",
      color: Colors.blue));
  list.add(OSDataModel(
      title: 'Guide',
      image: image4,
      subtitle: "Intro to Crypto Wallets",
      color: Colors.purple));
  list.add(OSDataModel(
      title: 'Learn',
      image: image5,
      subtitle: "How to Easily Setup a MetaMask Wallet",
      color: Colors.blue));
...
List<OSDataModel> getHelpCenter() {
  ...
  list.add(OSDataModel(
      ...
      subtitle: "Create an account,set up your wallet, and more",
      color: Colors.teal));
  list.add(OSDataModel(
      title: 'Buy',
      subtitle: "Purchase your forst NFT, understand gas fees and what's free",
      color: Colors.pink));
  list.add(OSDataModel(
      title: 'Sell',
      subtitle: "List your NFTs for sell with a set price, as an auction",
      color: Colors.purple));
  list.add(OSDataModel(
      title: 'Create',
      subtitle:
          "Create your first NFT and collection to start selling and sharing",
      color: Colors.lightBlueAccent));
  list.add(OSDataModel(
      title: 'FAQs',
      subtitle:
          "Learn answer to frequently asked questions on NFT Market Place",
      color: Colors.redAccent));
  list.add(OSDataModel(
      title: 'User Safety',
      subtitle: "Learn More about antifraud and user safely processes",
      color: Colors.green));
  list.add(OSDataModel(
      title: 'Partners',
      subtitle:
          "Learn hoe to partner with NFT Market Place to showcase yout drops",
      color: Colors.teal));
  list.add(OSDataModel(
      title: 'Developers',
      subtitle: "Learn more how to develop and build with NFT Market Place",
      color: Colors.orange));
  list.add(OSDataModel(
      title: 'Reporting',
      subtitle:
          "Get insights about your helpdesk performance, and identify the biggest clogs in your support process",
      color: Colors.pinkAccent));
  list.add(OSDataModel(
      title: 'Collaboration',
      subtitle:
          "Work together, with the right person to help you resolve your support tickets faster and more efficiently",
      color: Colors.purple));
...
List<OSDataModel> getfollowUs() {
  ...
  list.add(OSDataModel(
      title: 'Twitter',
      image: '$osImageBaseUrl/icons/os_ic_twitter.png',
      color: Colors.blueAccent));
  list.add(OSDataModel(
      title: 'Instagram',
      image: '$osImageBaseUrl/icons/os_ic_instagram.png',
      color: Colors.pink));
  list.add(OSDataModel(
      title: 'Discord',
      image: '$osImageBaseUrl/icons/os_ic_discord.png',
      color: Colors.purple));
  list.add(OSDataModel(
      title: 'Reddit',
      image: '$osImageBaseUrl/icons/os_ic_reddit.png',
      color: Colors.deepOrange));
  list.add(OSDataModel(
      title: 'Youtube',
      image: '$osImageBaseUrl/icons/os_ic_youtube.png',
      color: Colors.red));
...
List<OSDataModel> getChains() {
  ...
  list.add(OSDataModel(
      title: 'All chains',
      categoryIcon: '$osImageBaseUrl/icons/os_ic_ethereum.png'));
  list.add(OSDataModel(
      title: 'Ethereum',
      categoryIcon: '$osImageBaseUrl/icons/os_ic_token.png'));
  list.add(OSDataModel(
      title: 'Polygon',
      categoryIcon: '$osImageBaseUrl/icons/os_ic_polygon.png'));
  list.add(OSDataModel(
      title: 'Klaytn', categoryIcon: '$osImageBaseUrl/icons/os_ic_klaytn.png'));
  list.add(OSDataModel(
      title: 'Solana', categoryIcon: '$osImageBaseUrl/icons/os_ic_solana.png'));
...
List<OSDataModel> getRanking() {
  ...
  list.add(OSDataModel(
      srno: 2,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_new.png',
      title: 'Mutant Ape Yacht Club',
      price: 29525.45));
  list.add(OSDataModel(
      srno: 3,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_klaytn.png',
  ...
  list.add(OSDataModel(
      srno: 5,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_link.png',
      title: 'Moonbirds',
      price: 152635.00));
  list.add(OSDataModel(
      srno: 6,
      categoryIcon: '$osImageBaseUrl/icons/os_ic_solana.png',
      title: 'Akutars',
      price: 365355.25));
  list.add(OSDataModel(
      srno: 7,
