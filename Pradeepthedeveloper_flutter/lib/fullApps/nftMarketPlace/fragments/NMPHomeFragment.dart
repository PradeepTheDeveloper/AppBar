...
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/components/NMPSellerItemComponent.dart';
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/fragments/NMPRankingsFragment.dart';
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/screens/NMPCategoriesDetailsScreen.dart';
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/screens/NMPNotableDropsDetailsScreen.dart';
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/screens/NMPTrendingCollectionsDetailsScreen.dart';
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/utils/NMPConstants.dart';
import 'package:pradeep_the_developer/fullApps/nftMarketPlace/utils/NMPDataProvider.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            commonCachedNetworkImage('$osImageBaseUrl/os_appIcon.png',
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              NMPCategoriesDetailsScreen(categories[index]),
                        ),
                      );
                    },
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => NMPNotableDropsDetailsScreen(
                                  notableDropsDetails[index])));
                    },
                    splashColor: Colors.transparent,
                    highlightColor: Colors.transparent,
                    child: SizedBox(
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) =>
                                  NMPTrendingCollectionsDetailsScreen(
                                      trendingCollection[index])));
                    },
                    splashColor: Colors.transparent,
                    highlightColor: Colors.transparent,
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(trendingCollection[index].title!,
                              overflow: TextOverflow.ellipsis,
                              maxLines: 1,
                              style: TextStyle(fontSize: 16)),
                          SizedBox(height: 4),
                          Text(trendingCollection[index].subtitle!,
                              overflow: TextOverflow.ellipsis,
                              maxLines: 1,
                              style:
