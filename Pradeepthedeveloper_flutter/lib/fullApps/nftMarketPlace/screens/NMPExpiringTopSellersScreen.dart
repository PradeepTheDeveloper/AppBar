...
class NMPExpiringTopSellersScreen extends StatefulWidget {
  ...
  @override
  State<NMPExpiringTopSellersScreen> createState() =>
      _NMPExpiringTopSellersScreenState();
}

class _NMPExpiringTopSellersScreenState
    extends State<NMPExpiringTopSellersScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(widget.dataModel.subtitle!,
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text('  Ends on june 21, 2024 at 10:40 am',
                                style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.grey)),
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              children: [
                                commonCachedNetworkImage(
                                    '$osImageBaseUrl/icons/os_ic_token.png',
                                    width: 25,
                                    height: 25,
                                    color: Theme.of(context).iconTheme.color),
                                Text('0.252',
                      ...
                      return ExpansionPanel(
                        ...
                        body: Container(
                          ...
                          child: ListTile(
                              ...
                              trailing: commonCachedNetworkImage(
                                  data.categoryIcon!,
                                  width: 30,
                                  height: 30,
                                  color: Theme.of(context).iconTheme.color),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          width: 182,
                          height: 50,
                          child: Text(moreFromCollection[index].subtitle!,
                              overflow: TextOverflow.ellipsis,
                              maxLines: 2,
                              style: TextStyle(
                            ...
                            children: [
                              ...
                              IconButton(
                                icon: Row(
                                  children: [
                                    Icon(
                                        moreFromCollection[index].isSelected
                                            ? Icons.favorite
                                ...
                                onPressed: () {
                                  ...
                                  if (!moreFromCollection[index].isSelected) {
                                    s = 'Liked';
                                    moreFromCollection[index].like =
                                        moreFromCollection[index].like! + 1;
                                  } else {
                                    s = 'UnLike';
                                    moreFromCollection[index].like =
                                        moreFromCollection[index].like! - 1;
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            commonCachedNetworkImage(
                                                '$osImageBaseUrl/icons/os_ic_wolf.png',
                                                height: 24,
                                                width: 24),
                                            SizedBox(width: 8),
                                            Text(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            commonCachedNetworkImage(
                                                '$osImageBaseUrl/icons/os_ic_trustwallet.png',
                                                height: 24,
                                                width: 24,
                                                color: Colors.blue),
                                            SizedBox(width: 8),
