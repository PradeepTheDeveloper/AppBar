...
import 'package:pradeep_the_developer/fullApps/qibus/screen/QIBusPickDrop.dart';
import 'package:pradeep_the_developer/fullApps/qibus/utils/QiBusColors.dart';
import 'package:pradeep_the_developer/fullApps/qibus/utils/QiBusConstant.dart';
import 'package:pradeep_the_developer/fullApps/qibus/utils/QiBusDataGenerator.dart';
import 'package:pradeep_the_developer/fullApps/qibus/utils/QiBusImages.dart';
import 'package:pradeep_the_developer/fullApps/qibus/utils/QiBusStrings.dart';
import 'package:pradeep_the_developer/fullApps/qibus/utils/QiBusWidget.dart';
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    width: 0, color: qIBus_colorPrimary)),
                            width: 20,
                            height: 20,
                          ),
                          Container(
...
class QIBusSeatSelection extends StatefulWidget {
  ...
  @override
  QIBusSeatSelectionState createState() =>
      new QIBusSeatSelectionState(model, index);
}
      ...
      children: <Widget>[
        Container(
          padding: EdgeInsets.fromLTRB(
              spacing_large, spacing_standard, spacing_large, spacing_standard),
          child: Column(
            children: <Widget>[
              Row(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  text(QIBus_text_total_price,
                      fontFamily: fontMedium, textColor: qIBus_colorPrimary),
                  text("\$445",
                      fontFamily: fontMedium, textColor: qIBus_colorPrimary),
                ],
              )
