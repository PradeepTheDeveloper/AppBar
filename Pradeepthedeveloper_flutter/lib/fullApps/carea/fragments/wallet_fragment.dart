...
import 'package:pradeep_the_developer/fullApps/carea/commons/widgets.dart';
import 'package:pradeep_the_developer/fullApps/carea/model/calling_model.dart';
import 'package:pradeep_the_developer/fullApps/carea/screens/all_transaction_list.dart';
import 'package:pradeep_the_developer/fullApps/carea/screens/wallet_price_screen.dart';
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Image.asset("images/carea/ic_visa.png",
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Image.asset(listOfCarImage[index],
                        height: 40,
                        width: 40,
                    ...
                    Column(
                      children: [
                        Text(data.countNumber.validate(),
                            style: boldTextStyle()),
                        4.height,
                        Row(
                          children: [
                            Text(data.arriveTime.validate(),
                                style: secondaryTextStyle()),
                            4.width,
                            Container(
