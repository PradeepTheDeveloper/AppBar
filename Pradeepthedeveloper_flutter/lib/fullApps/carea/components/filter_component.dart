      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              builder: (context) => SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: List.generate(
                    ...
                    (index) => InkWell(
                      onTap: () {
                        carBrandData[index].selectCarCategory =
            ...
            Padding(
                padding: EdgeInsets.only(left: 8),
                child: Text('Car Condition', style: boldTextStyle())),
            SizedBox(height: 16),
                ...
                children: List.generate(
                  ...
                  (index) => Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          carConditionData[index].selectCarCategory =
                              !carConditionData[index]
                                  .selectCarCategory
                                  .validate();
                          setState(() {});
                        },
            ...
            Padding(
                padding: EdgeInsets.only(left: 8),
                child: Text('Price Range', style: boldTextStyle())),
            SizedBox(height: 8),
            Observer(
              builder: (context) => Slider(
                ...
                divisions: 10,
                thumbColor:
                    appStore.isDarkModeOn ? Colors.white : primaryBlackColor,
                max: 20000000,
                min: 80000,
            ...
            Padding(
                padding: EdgeInsets.only(left: 8),
                child: Text('Sort By', style: boldTextStyle())),
            SizedBox(height: 16),
            SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
            ...
            Padding(
                padding: EdgeInsets.only(left: 8),
                child: Text('Ratting', style: boldTextStyle())),
            SizedBox(height: 16),
            SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
                ...
                children: List.generate(
                  ...
                  (index) => Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          carRattingData[index].selectCarCategory =
                              !carRattingData[index]
                                  .selectCarCategory
                                  .validate();
                          setState(() {});
                        },
