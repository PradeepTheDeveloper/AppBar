...
import 'package:pradeep_the_developer/fullApps/shopHop/models/ShAttribute.dart';
import 'package:pradeep_the_developer/fullApps/shopHop/models/ShProduct.dart';
...
import 'package:pradeep_the_developer/fullApps/shopHop/utils/ShWidget.dart';
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                            children:
                                colorWidget(mProductModel[index].attributes!)),
                        SizedBox(height: 4),
                        Expanded(
                          child: Align(
                              ...
                              children: <Widget>[
                                RatingBar(
                                  initialRating: double.parse(
                                      mProductModel[index].average_rating!),
          ...
          return Padding(
            ...
            child: ChoiceChip(
              label: text(categoryList![index].name,
                  textColor: categoryList[index].isSelected!
                      ? Colors.red
                      : blackColor),
        ...
        itemBuilder: (_, index) {
          return Padding(
            ...
            child: InkWell(
              onTap: () {
                setState(() {
                  colorsList![index].isSelected
                      ? colorsList[index].isSelected = false
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: getColorFromHex(colorsList![index].name!)),
    ...
    final productSizeListView = ListView.builder(
        ...
        itemBuilder: (_, index) {
          return Padding(
            padding: const EdgeInsets.all(8.0),
            child: ChoiceChip(
              label: text(sizesList![index].name,
                  textColor: categoryList![index].isSelected!
                      ? Colors.red
                      : blackColor),
              ...
              onSelected: (selected) {
                setState(() {
                  sizesList[index].isSelected
                      ? sizesList[index].isSelected = false
                      : sizesList[index].isSelected = true;
                });
              },
              elevation: 2,
              backgroundColor: Colors.white10,
    ...
    final productBrandsListView = ListView.builder(
        ...
        itemBuilder: (_, index) {
          return Padding(
            padding: const EdgeInsets.all(8.0),
            child: ChoiceChip(
              label: text(brandsList![index].name,
                  textColor:
                      brandsList[index].isSelected ? Colors.red : blackColor),
              selected: brandsList[index].isSelected,
              onSelected: (selected) {
                setState(() {
                  brandsList[index].isSelected
