...
import 'package:pradeep_the_developer/fullApps/beautyMaster/models/BMAppointmentModel.dart';
import 'package:pradeep_the_developer/fullApps/beautyMaster/models/BMCommentModel.dart';
...
import 'package:pradeep_the_developer/fullApps/beautyMaster/models/BMMessageModel.dart';
import 'package:pradeep_the_developer/fullApps/beautyMaster/models/BMServiceListModel.dart';
import 'package:pradeep_the_developer/fullApps/beautyMaster/models/BMShoppingModel.dart';
...
List<BMDashboardModel> getDashboardList() {
  ...
  list.add(BMDashboardModel(
      selectedIcon: 'images/beauty_master/home.png',
      unSelectedIcon: 'images/beauty_master/house.png'));
  list.add(BMDashboardModel(
      selectedIcon: 'images/beauty_master/magnifier.png',
      unSelectedIcon: 'images/beauty_master/search.png'));
  list.add(BMDashboardModel(
      selectedIcon: 'images/beauty_master/calendar_selected.png',
      unSelectedIcon: 'images/beauty_master/calendar.png'));
  list.add(BMDashboardModel(
      selectedIcon: 'images/beauty_master/chat_selected.png',
      unSelectedIcon: 'images/beauty_master/chat.png'));
  list.add(BMDashboardModel(
      selectedIcon: 'images/beauty_master/more_selected.png',
      unSelectedIcon: 'images/beauty_master/more.png'));
...
List<BMMasterModel> getMyMastersList() {
  ...
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/model_three.jpg',
      name: 'Hannah Benson'));
...
List<BMMasterModel> getTopServicesHomeList() {
  ...
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/salon.png', name: 'Hair Salon'));
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/nail-polish.png',
      name: 'Nail Salon'));
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/makeup.png', name: 'Beauty Salon'));
  list.add(BMMasterModel(
      image: '$BaseUrl/images/beauty_master/makeup_kit.png',
      name: 'Beauty Salon'));
