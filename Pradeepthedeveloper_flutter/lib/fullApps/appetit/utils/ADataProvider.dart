...
final List<AWalkThroughModel> modal = [
  AWalkThroughModel(
    ...
    subtitle:
        'Learn and Share your recipes with getting amazing rewards published by amazon ',
...
List<LanguageDataModel> languageList() {
  return [
    LanguageDataModel(
        ...
        flag: '$BaseUrl/images/flag/ic_us.png'),
    LanguageDataModel(
        id: 2,
        name: 'Hindi',
        languageCode: 'hi',
        fullLanguageCode: 'hi-IN',
        flag: '$BaseUrl/images/flag/ic_hi.png'),
    LanguageDataModel(
        id: 3,
        name: 'Arabic',
        languageCode: 'ar',
        fullLanguageCode: 'ar-AR',
        flag: '$BaseUrl/images/flag/ic_ar.png'),
    LanguageDataModel(
        id: 4,
        name: 'French',
        languageCode: 'fr',
        fullLanguageCode: 'fr-FR',
        flag: '$BaseUrl/images/flag/ic_fr.png'),
  ];
}
