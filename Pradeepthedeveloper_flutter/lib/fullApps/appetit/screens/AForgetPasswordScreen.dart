import 'package:pradeep_the_developer/fullApps/appetit/screens/AVerificationScreen.dart';
  ...
  void verifyOTP() {
    ...
    if (res) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('OTP verifed successfully')));
    } else {
      print('Incorrect OTP');
    }
  }
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text(
                      'Enter your email for retrieve your data by creating new password'),
                  Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AVerificationScreen())),
                    child: Row(
