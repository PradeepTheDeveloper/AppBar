...
import 'package:pradeep_the_developer/fullApps/laundryService/model/LSServiceModel.dart';
import 'package:pradeep_the_developer/fullApps/laundryService/screens/ServiceDetail/LSServiceDetailScreen.dart';
...
class LSSOfferPackageComponent extends StatefulWidget {
  ...
  @override
  LSSOfferPackageComponentState createState() =>
      LSSOfferPackageComponentState();
}
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Text(data.subTitle.validate(),
                      style: primaryTextStyle(color: LSColorPrimary, size: 18)),
                  8.height,
                  AppButton(
                    padding:
