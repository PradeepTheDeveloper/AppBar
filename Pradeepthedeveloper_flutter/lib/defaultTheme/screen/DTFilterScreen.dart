...
import 'package:pradeep_the_developer/defaultTheme/model/DTFilter.dart';
import 'package:pradeep_the_developer/defaultTheme/model/DTFilterOption.dart';
      ...
      child: Row(
        children: <Widget>[
          Container(
            ...
            child: Icon(Icons.done, color: appStore.iconColor, size: 12)
