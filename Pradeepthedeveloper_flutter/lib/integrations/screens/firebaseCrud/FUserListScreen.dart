...
import 'package:pradeep_the_developer/integrations/screens/firebaseCrud/FAddUserScreen.dart';
import 'package:pradeep_the_developer/integrations/screens/firebaseCrud/FirebaseUserService.dart';
import 'package:pradeep_the_developer/integrations/screens/firebaseCrud/model/FBusermodel.dart';
...
class _FUserListScreenState extends State<FUserListScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: appBarWidget('Firebase User List',
            color: appStore.appBarColor, elevation: 0),
              ...
              if (snap.data!.isEmpty) {
                return Container(
                  child: Column(
                    ...
                    children: [
                      Image.asset("images/integrations/img/no_data_found.png",
                ...
                itemBuilder: (_, int index) {
                  ...
                  return SettingItemWidget(
                    ...
                    trailing: Container(
                      ...
                      child: Text(data.age.validate().toString(),
