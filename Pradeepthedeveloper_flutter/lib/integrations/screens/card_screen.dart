          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: textPrimary(lipsum.createWord(numWords: 4),
                    color: textPrimaryColor, size: 20),
              ),
              SizedBox(height: 10),
              Padding(
                padding: EdgeInsets.only(left: 16, right: 16),
                child: Text(lipsum.createParagraph(numSentences: 3),
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: text(lipsum.createWord(numWords: 4),
                    fontSize: 18, textColor: textPrimaryColor, maxLine: 2),
              ),
              Divider(),
              Padding(
