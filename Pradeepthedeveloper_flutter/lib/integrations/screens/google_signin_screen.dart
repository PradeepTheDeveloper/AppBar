        ...
        child: Row(
          ...
          children: <Widget>[
            appStore.googleUserPhotoUrl.isEmptyOrNull
                ? Image.asset('images/app/placeholder.jpg',
                        height: 100, width: 100, fit: BoxFit.cover)
                    .cornerRadiusWithClipRRect(100)
                : Image.network(appStore.googleUserPhotoUrl,
                        height: 100, width: 100, fit: BoxFit.cover)
                    .cornerRadiusWithClipRRect(100),
            16.width,
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  text('${appStore.googleUserName}',
                      fontSize: textSizeLargeMedium,
                      fontFamily: fontSemibold,
                      textColor: appStore.textPrimaryColor),
                  Text('${appStore.googleUserEmail}',
