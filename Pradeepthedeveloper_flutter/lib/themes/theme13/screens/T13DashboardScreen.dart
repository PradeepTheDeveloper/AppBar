...
import 'package:pradeep_the_developer/themes/theme13/model/T13Model.dart';
...
import 'package:pradeep_the_developer/themes/theme13/utils/T13DataGenerator.dart';
  ...
  Widget build(BuildContext context) {
    ...
    var mTab = Container(
      ...
      decoration: boxDecoration(
          radius: 45, bgColor: t13_menu_background, showShadow: false),
          ...
          Flexible(
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: text(t13_lbl_buy,
                      isCentered: true,
                      textColor: selectedPos == 1
                          ? t13_colorPrimary
                          : t13_textColorPrimary),
                ),
              ),
            ),
            flex: 1,
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Container(
                  ...
                  child: Stack(
                    alignment: Alignment.bottomLeft,
                    children: <Widget>[
                      commonCacheImageWidget(t13_ic_dashboard, expandHeight,
      ...
      bottomNavigationBar: Stack(
        ...
        children: <Widget>[
          Container(
            ...
            height: 70,
            decoration:
                boxDecoration(color: appStore.appBarColor!, showShadow: true),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Flexible(
                    child: tabItem(1, t13_ic_search, t13_lbl_search), flex: 1),
                Flexible(
                    child: tabItem(2, t13_ic_bookmark, t13_lbl_bookmark),
                    flex: 1),
                Flexible(child: tabItem(3, t13_ic_user, t13_lbl_user), flex: 1),
                Flexible(
                    child: tabItem(4, t13_ic_settings, t13_lbl_setting),
                    flex: 1),
              ],
            ),
          ),
...
class Featured extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 200,
      decoration: boxDecoration(
          bgColor: appStore.appBarColor, showShadow: true, radius: 10),
      ...
      child: Column(
        children: <Widget>[
          ClipRRect(
            ...
            child: commonCacheImageWidget(model.image, 160,
                width: width, fit: BoxFit.cover),
          ),
          Padding(
