      ...
      child: Row(
        ...
        children: <Widget>[
          ClipRRect(
            ...
            child: commonCacheImageWidget(t13_ic_profile1, width * 0.28,
                fit: BoxFit.cover, width: width * 0.28),
          ),
          SizedBox(width: 10),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
              ...
              FittedBox(
                child: Container(
                  ...
                  child: Container(
                    ...
                    child: text(t13_lbl_for_sale,
                        textColor: t13_white, fontSize: 12.0),
                  ),
                ),
              )
            ],
    ...
    var mUserInformation = Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              text(t13_lbl_followers.toUpperCase(),
          ...
          Column(
            children: <Widget>[
              text(t13_lbl_properties.toUpperCase(),
                  textColor: t13_textColorSecondary),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 16),
                Container(
                  child: text(t13_lbl_properties.toUpperCase(),
                      textColor: appStore.textPrimaryColor,
        ...
        children: <Widget>[
          ClipRRect(
            ...
            child: Stack(
              ...
              children: <Widget>[
                commonCacheImageWidget(model.image, 180,
