...
import 'package:pradeep_the_developer/main/utils/auto_size_text/auto_size_text.dart';
...
BubbleBottomBarItem tab(String iconData, String tabName) {
  return BubbleBottomBarItem(
      ...
      activeIcon: SvgPicture.asset(iconData,
          height: 20, width: 20, color: t5ColorPrimary),
      title: AutoSizeText(tabName,
          style: TextStyle(
