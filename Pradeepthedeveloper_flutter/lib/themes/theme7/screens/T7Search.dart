...
import 'package:pradeep_the_developer/themes/theme7/models/T7Models.dart';
import 'package:pradeep_the_developer/themes/theme7/utils/T7Colors.dart';
import 'package:pradeep_the_developer/themes/theme7/utils/T7Constant.dart';
import 'package:pradeep_the_developer/themes/theme7/utils/T7DataGenerator.dart';
import 'package:pradeep_the_developer/themes/theme7/utils/T7Images.dart';
import 'package:pradeep_the_developer/themes/theme7/utils/T7Strings.dart';
              ...
              appBar: PreferredSize(
                ...
                child: Container(
                  ...
                  decoration: boxDecoration(
                      showShadow: true, bgColor: appStore.appBarColor),
                  child: SafeArea(
                    child: Column(
                      children: <Widget>[
                        Container(
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                      text: t7_search_nearby_destination,
                      style: TextStyle(
            ...
            ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    padding: EdgeInsets.only(top: 10, bottom: 10),
                    child: Container(
                        child: text(mListings[index].name,
