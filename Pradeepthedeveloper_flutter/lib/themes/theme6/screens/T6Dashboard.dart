...
import 'package:pradeep_the_developer/themes/theme6/models/T6Models.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/T6CalendarStrip.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/T6Colors.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/T6Constant.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/T6DataGenerator.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/T6Images.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/T6Strings.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/T6Widget.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/Widget/T6Bar.dart';
import 'package:pradeep_the_developer/themes/theme6/utils/Widget/T6SliderWidget.dart';
...
class T6DashboardState extends State<T6Dashboard> {
  ...
  dateTileBuilder(
    ...
    TextStyle normalStyle =
        TextStyle(fontSize: 16, color: t6textColorSecondary);
    TextStyle selectedStyle =
        TextStyle(fontSize: 17, fontWeight: FontWeight.w800, color: t6white);
