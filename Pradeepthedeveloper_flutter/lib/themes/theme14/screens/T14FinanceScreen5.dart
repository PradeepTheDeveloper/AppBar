...
import 'package:pradeep_the_developer/main/utils/percent_indicator/circular_percent_indicator.dart';
...
import 'package:pradeep_the_developer/themes/theme14/utils/T14DataGenerator.dart';
import 'package:pradeep_the_developer/themes/theme14/utils/T14Strings.dart';
import 'package:pradeep_the_developer/themes/theme14/utils/bezierChart/bezier_chart_config.dart';
import 'package:pradeep_the_developer/themes/theme14/utils/bezierChart/bezier_chart_widget.dart';
import 'package:pradeep_the_developer/themes/theme14/utils/bezierChart/bezier_line.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(t14_txt_earning,
                    style: boldTextStyle(color: t14_colorBlue, size: 16)),
                Text(t14_txt_show_all,
                    style: primaryTextStyle(color: gray, size: 14)),
              ],
            ),
          ),
        ],
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                icon: Icon(Feather.download, size: 22), onPressed: () {}),
          ],
        ),
        backgroundColor: t14_finance5_BgColor,
                  ...
                  children: List.generate(selectDay.length, (index) {
                    ...
                    return Container(
                      ...
                      decoration: boxDecorationWithRoundedCorners(
                        ...
                        backgroundColor:
                            i == index ? white : t14_finance5_BgColor,
                      ),
                      child: Text(
                        i == index ? data.title! : data.title![0],
                        textAlign: TextAlign.center,
                        style: boldTextStyle(
                            color: i == index ? black : t14_colorBlue,
                            size: 14),
                      ),
                    ).onTap(() {
                      i = index;
                      ...
                      child: Row(
                        children: [
                          CircularPercentIndicator(
                            ...
                            center:
                                Icon(data.icon, size: 20.0, color: Colors.blue),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              4.height,
                              Text(data.totalTransaction!,
                                  style: boldTextStyle(
                                      size: 12,
                                      color: t14_SuccessTxtColor
                                          .withOpacity(0.5))),
                            ],
                          ).expand(),
                          Column(
