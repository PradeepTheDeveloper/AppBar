...
class _T14SubscriptionScreen7State extends State<T14SubscriptionScreen7> {
  List<ChoosePlanModel> subscription4DiscountList =
      getSubscription7DiscountList();
  int? i;
        ...
        body: Stack(
          children: [
            ...
            Align(
                    ...
                    child: Image.asset(t14_KingIcon,
                        height: 20, width: 20, color: t14_colorWhite))
                .paddingOnly(top: 70),
            Container(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      8.width,
                      Text(t14_txt_stayMonth,
                          style: secondaryTextStyle(
                              size: 14, color: t14_OppsColor1)),
                    ],
                  ),
                  16.height,
                  Row(
