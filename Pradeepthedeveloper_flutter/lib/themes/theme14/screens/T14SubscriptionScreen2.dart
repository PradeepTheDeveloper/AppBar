      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [t14_SignInBgColor1, t14_SignInBgColor2]),
        ),
        child: Column(
          ...
          children: [
            Column(
              ...
              children: [
                Text(t14_txt_Subscription2_Title,
                    style: boldTextStyle(size: 20, color: t14_colorBlue)),
                16.height,
                Text(t14_txt_Subscription2_SubTitle,
                    style: secondaryTextStyle(size: 16, color: t14_colorBlue)),
                32.height,
                Row(
                  children: [
                    Text(t14_txt_price1,
                        style: boldTextStyle(size: 80, color: t14_colorBlue)),
                    4.width,
                    Row(
                      ...
                      children: [
                        Text(t14_txt_price2,
                            style:
                                boldTextStyle(size: 35, color: t14_colorBlue)),
                        Icon(Feather.dollar_sign,
                            size: 26, color: t14_colorBlue),
                      ],
                    ),
                  ],
                ),
                ...
                UL(
                  ...
                  padding: 16,
                  children: [
                    Text(t14_txt_Subscription2_Sentiment,
                        style: boldTextStyle(color: t14_colorBlue, size: 16)),
                    Text(t14_txt_Subscription2_update,
                        style: boldTextStyle(color: t14_colorBlue, size: 16)),
                    Text(t14_txt_Subscription2_analyze,
                        style: boldTextStyle(color: t14_colorBlue, size: 16)),
                  ],
                ),
              ],
