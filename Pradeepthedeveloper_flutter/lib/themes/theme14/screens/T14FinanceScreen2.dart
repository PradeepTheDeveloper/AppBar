    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:
              Text(t14_txt_VisaCard.validate(), style: boldTextStyle(size: 16)),
          centerTitle: true,
          actions: [
            IconButton(icon: Icon(Icons.search, size: 20), onPressed: () {}),
            IconButton(
                icon: Icon(Icons.star_border, size: 20), onPressed: () {}),
          ],
        ),
        body: Stack(
          children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:
                              Icon(Icons.add, size: 22, color: t14_colorBlue),
                        ),
                        ListView.builder(
                    ...
                    child: Column(
                      children: [
                        Row(children: [
                          ...
                          IconButton(
                              icon:
                                  Icon(Entypo.dots_three_horizontal, size: 18),
                              onPressed: () {})
                        ]),
                        ListView.builder(
