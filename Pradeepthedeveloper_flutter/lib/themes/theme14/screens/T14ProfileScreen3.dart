          ...
          children: [
            Row(
              children: [
                ...
                Container(
                  padding:
                      EdgeInsets.only(left: 10, right: 8, bottom: 4, top: 4),
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.all(Radius.circular(16)),
                      color: t14_profileT2BgColor),
                  child: Row(
                    children: [
                      Text('Followed',
                          style:
                              boldTextStyle(size: 14, color: t14_colorSkyBlue)),
                      4.width,
            ...
            StaggeredGridView.countBuilder(
              ...
              itemBuilder: (BuildContext context, int index) => ClipRRect(
                ...
                child: commonCachedNetworkImage(topTravelList[index].img!,
                    fit: BoxFit.cover),
              ),
            ),
          ],
