...
class _CourseInProgressDataState extends State<CourseInProgressData>
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('Start ${widget.data.date}', style: primaryTextStyle())
                  .expand(),
          ...
          Text('${widget.data.name}',
              style: boldTextStyle(color: widget.data.textColor)),
          16.height,
          Text('Learn ${widget.data.name} from our expert trainer',
              style: boldTextStyle()),
          16.height,
          Text('Finally a comprehensive guide to using sketch for designing',
          ...
          Row(
            ...
            children: [
              ...
              Text('${widget.data.progress!.toInt()}%',
                  style: secondaryTextStyle()),
            ],
          ),
        ],
