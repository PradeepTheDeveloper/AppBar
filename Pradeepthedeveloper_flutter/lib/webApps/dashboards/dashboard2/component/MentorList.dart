      ...
      child: Row(
        ...
        children: [
          ...
          Text('${widget.data.name}',
                  textAlign: TextAlign.start, style: boldTextStyle())
              .expand(flex: 3),
          Text('${widget.data.categoryName}',
                  textAlign: TextAlign.start, style: secondaryTextStyle())
              .expand(flex: 3),
          Text('${widget.data.courseCount} courses',
                  textAlign: TextAlign.start, style: secondaryTextStyle())
              .expand(flex: 2),
          Text('${widget.data.followers} followers',
                  textAlign: TextAlign.start, style: secondaryTextStyle())
              .expand(flex: 2),
          Container(
            padding: const EdgeInsets.symmetric(vertical: 2),
            decoration: boxDecorationWithRoundedCorners(
                backgroundColor: const Color(0xFFF9B313)),
            child: TextButton(
              onPressed: () {
              ...
              child: Text(
                  widget.data.following == true ? 'Following' : 'Follow',
                  style: boldTextStyle()),
            ),
          ).expand(flex: 2),
          8.width,
          Container(
            decoration: boxDecorationWithRoundedCorners(
                backgroundColor: const Color(0xFFF6F6DE)),
