...
import 'package:pradeep_the_developer/webApps/dashboards/dashboard1/component/ChartComponenentWidget.dart';
...
class StorageFilesDataComponent extends StatefulWidget {
  ...
  @override
  _StorageFilesDataComponentState createState() =>
      _StorageFilesDataComponentState();
}
                ...
                return HoverWidget(
                  builder: (BuildContext context, bool isHovering) {
                    return SettingItemWidget(
                      ...
                      leading: SvgPicture.asset(data.img.validate(),
                          color: data.color,
                          fit: BoxFit.cover,
                          height: 20,
                          width: 20),
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            ...
                            color: isHovering
                                ? Colors.white54
                                : WDPrimaryColor.withOpacity(0.15)),
