...
import 'package:pradeep_the_developer/webApps/dashboards/dashboard3/models/DrawerModel.dart';
...
List<DrawerModel> menuDrawerList() {
  List<DrawerModel> _drawerList = [
    ...
    DrawerModel(
        name: 'Products', icon: Ionicons.file_tray_stacked, onTap: () {}),
    DrawerModel(
        name: 'Transaction',
        icon: MaterialCommunityIcons.swap_horizontal_circle,
        onTap: () {}),
    DrawerModel(
        name: 'Overview',
        icon: MaterialCommunityIcons.chart_areaspline,
        onTap: () {}),
...
List<OrderModel> getOrderTypeList() {
  List<OrderModel> typeList = [
    OrderModel(
        icon: Fontisto.pie_chart_1,
        name: 'New Orders',
        quantity: 50,
        change: 0.0,
        color: Color(0xFF5066CD)),
    OrderModel(
        icon: Feather.shopping_cart,
        name: 'Online Orders',
        quantity: 50,
        change: 0.0,
        color: Color(0xFF2AC54E)),
    OrderModel(
        icon: Feather.shopping_cart,
        name: 'Offline Orders',
        quantity: 100,
        change: 0.0,
        color: Color(0xFFE9582A)),
    OrderModel(
        icon: Icons.people,
        name: 'Total Users',
        quantity: 100,
        change: 0.0,
        color: Color(0xFFE0C947)),
  ];
  return typeList;
}
...
List<OrderModel> getTotalList() {
  List<OrderModel> totalList = [
    ...
    OrderModel(
        ...
        change: 10),
    OrderModel(
        icon: FontAwesome.money, name: 'Total Revenue', price: 736, change: 3),
  ];
  return totalList;
}
