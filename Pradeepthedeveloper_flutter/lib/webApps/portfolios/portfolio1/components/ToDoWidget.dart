...
import 'package:pradeep_the_developer/webApps/portfolios/utils/DataGenerator.dart';
              ...
              children: [
                Container(
                  ...
                  decoration: boxDecoration(
                    radius: 10,
                    color: selectedTab == 'All Project'
                        ? Colors.transparent
                        : appStore.textPrimaryColor!,
                    bgColor: selectedTab == 'All Project'
                        ? Colors.green
                ...
                Container(
                  ...
                  decoration: boxDecoration(
                    radius: 10,
                    color: selectedTab == 'Illustration'
                        ? Colors.transparent
                        : appStore.textPrimaryColor!,
                    bgColor: selectedTab == 'Illustration'
                        ? Colors.green
                        : appStore.scaffoldBackground,
                  ),
                  margin: EdgeInsets.all(8),
                ...
                Container(
                  ...
                  decoration: boxDecoration(
                    radius: 10,
                    color: selectedTab == 'Photography'
                        ? Colors.transparent
                        : appStore.textPrimaryColor!,
                    bgColor: selectedTab == 'Photography'
                        ? Colors.green
                        : appStore.scaffoldBackground,
                  ),
                  margin: EdgeInsets.all(8),
                ...
                Container(
                  ...
                  decoration: boxDecoration(
                    radius: 10,
                    color: selectedTab == 'Website'
                        ? Colors.transparent
                        : appStore.textPrimaryColor!,
                    bgColor: selectedTab == 'Website'
                        ? Colors.green
                        : appStore.scaffoldBackground,
                  ),
                  margin: EdgeInsets.all(8),
            ...
            Wrap(
              ...
              children: imgList.map((e) {
                return Container(
                  ...
                  margin: EdgeInsets.all(8),
                  child: commonCachedNetworkImage(e.img!,
                          fit: BoxFit.cover,
