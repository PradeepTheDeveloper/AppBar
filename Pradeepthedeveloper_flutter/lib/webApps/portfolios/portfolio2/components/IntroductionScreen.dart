...
import 'package:pradeep_the_developer/webApps/portfolios/portfolio2/components/SnowWidget.dart';
                ...
                child: Column(
                  ...
                  children: [
                    Text('Hello, I’m John Doe',
                        style: boldTextStyle(
                            size: 34, color: Colors.white, letterSpacing: 1.2)),
                    16.height,
                    Text(
                      ...
                      style: primaryTextStyle(
                          size: 16, color: Colors.white, letterSpacing: 1.3),
                    ),
                    30.height,
                    Row(
                      children: [
